...
* [WinUI 3 預覽 3](https://docs.microsoft.com/windows/apps/winui/winui3/)
* [WinUI 2.5 版本](https://docs.microsoft.com/windows/apps/winui/winui2/release-notes/winui-2.5)
* [Segoe MDL2 Assets 圖示文章](https://docs.microsoft.com/windows/uwp/design/style/segoe-ui-symbol-font)

* [使用 C#/WinRT 的敏捷式物件](https://docs.microsoft.com/windows/uwp/csharp-winrt/agile-objects)
...
* [Azure 通訊服務](https://docs.microsoft.com/azure/communication-services/overview)
* [Azure 應用程式組態 Python 快速入門](https://docs.microsoft.com/azure/azure-app-configuration/quickstart-python)


### <a name="updated-documentation"></a>已更新的文件

* [DirectML 內容](https://docs.microsoft.com/windows/win32/direct3d12/dml-version-history)
...
<li><a href="https://docs.microsoft.com/windows/uwp/composition/composition-native-interop">組合原生交互操作</a></li>
<li><a href="https://docs.microsoft.com/windows/uwp/cpp-and-winrt-apis/std-cpp-data-types">標準 C++ 資料類型與 C++/WinRT</a></li>
<li><a href="https://docs.microsoft.com/windows/uwp/csharp-winrt/agile-objects">使用 C#/WinRT 的敏捷式物件</a></li>
<li><a href="https://docs.microsoft.com/windows/uwp/csharp-winrt/index">C#/WinRT</a></li>
<li><a href="https://docs.microsoft.com/windows/uwp/debug-test-perf/device-portal-desktop">Windows 桌面的裝置入口網站</a></li>
...
<li><a href="https://docs.microsoft.com/windows/uwp/design/layout/grid-tutorial">使用 Grid 與 StackPanel 建立簡單的應用程式。</a></li>
<li><a href="https://docs.microsoft.com/windows/uwp/design/shell/tiles-and-notifications/toast-schema">快顯通知內容結構描述</a></li>
<li><a href="https://docs.microsoft.com/windows/uwp/design/style/segoe-ui-symbol-font">Segoe MDL2 Assets 圖示</a></li>
<li><a href="https://docs.microsoft.com/windows/uwp/devices-sensors/host-card-emulation">建立 NFC 智慧卡應用程式</a></li>
<li><a href="https://docs.microsoft.com/windows/uwp/devices-sensors/use-the-compass">使用指南針</a></li>
...
<li><a href="https://docs.microsoft.com/windows/uwp/get-started/create-a-basic-windows-10-app-in-cpp">使用 C++/CX 建立 Hello World 應用程式 (Windows 10)</a></li>
<li><a href="https://docs.microsoft.com/windows/uwp/get-started/create-uwp-apps">使用通用 Windows 平台建立應用程式</a></li>
<li><a href="https://docs.microsoft.com/windows/uwp/get-started/universal-application-platform-guide">何謂通用 Windows 平台 (UWP) 應用程式？</a></li>
...
<li><a href="https://docs.microsoft.com/windows/uwp/launch-resume/web-to-app-linking">使用 App URI 處理常式啟用網站的應用程式</a></li>
<li><a href="https://docs.microsoft.com/windows/uwp/monetize/run-app-experiments-with-a-b-testing">使用 A/B 測試執行應用程式實驗</a></li>
...
<ul>
<li><a href="https://docs.microsoft.com/windows/desktop/TermServ/win32-tslicensekeypack">Win32_TSLicenseKeyPack 類別</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/direct3d12/direct3d-directml-constants">DirectML 常數</a></li>
...
<li><a href="https://docs.microsoft.com/windows/desktop/direct3d12/directml/nf-directml-dmlcreatedevice1">DMLCreateDevice1 函式</a></li>
...
<li><a href="https://docs.microsoft.com/windows/desktop/direct3dhlsl/dx-graphics-hlsl-variable-syntax">語法變數</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/dlgbox/color-dialog-box">色彩對話方塊</a></li>
...
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/database-parameters">資料庫參數</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/esenterrorexception-class">EsentErrorException 類別</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/esentioexception-class">EsentIOException 類別</a></li>
...
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/esentquotaexception-class">EsentQuotaException 類別</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/esentresourceexception-class">EsentResourceException 類別</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/index-parameters">索引參數</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jet-columnbase-structure">JET_COLUMNBASE 結構</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jet-columncreate-structure">JET_COLUMNCREATE 結構</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jet-columndef-structure">JET_COLUMNDEF 結構</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jet-columnlist-structure">JET_COLUMNLIST 結構</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jet-dbinfomisc-structure">JET_DBINFOMISC 結構</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jet-dbinfomisc2-structure">JET_DBINFOMISC2 結構</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jet-dbinfomisc3-structure">JET_DBINFOMISC3 結構</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jet-dbinfomisc4-structure">JET_DBINFOMISC4 結構</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jet-dbinfoupgrade-structure">JET_DBINFOUPGRADE 結構</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jet-enumcolumn-structure">JET_ENUMCOLUMN 結構</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jet-indexcreate-structure">JET_INDEXCREATE 結構</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jet-indexcreate2-structure">JET_INDEXCREATE2 結構</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jet-indexlist-structure">JET_INDEXLIST 結構</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jet-objectinfo-structure">JET_OBJECTINFO 結構</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jet-objectlist-structure">JET_OBJECTLIST 結構</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jet-retrievecolumn-structure">JET_RETRIEVECOLUMN 結構</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jet-sesid">JET_SESID</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jet-tablecreate-structure">JET_TABLECREATE 結構</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jet-tablecreate2-structure">JET_TABLECREATE2 結構</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jet-tablecreate3-structure">JET_TABLECREATE3 結構</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jet-tableid">JET_TABLEID</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jetaddcolumn-function">JetAddColumn 函式</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jetattachdatabase-function">JetAttachDatabase 函式</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jetattachdatabase2-function">JetAttachDatabase2 函式</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jetbackup-function">JetBackup 函式</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jetbackupinstance-function">JetBackupInstance 函式</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jetbeginsession-function">JetBeginSession 函式</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jetbegintransaction-function">JetBeginTransaction 函式</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jetbegintransaction2-function">JetBeginTransaction2 函式</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jetbegintransaction3-function">JetBeginTransaction3 函式</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jetcommittransaction-function">JetCommitTransaction 函式</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jetcreatedatabase-function">JetCreateDatabase 函式</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jetcreatedatabase2-function">JetCreateDatabase2 函式</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jetcreateindex-function">JetCreateIndex 函式</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jetcreateindex2-function">JetCreateIndex2 函式</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jetcreateindex3-function">JetCreateIndex3 函式</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jetcreateindex4w-function">JetCreateIndex4W 函式</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jetcreateinstance-function">JetCreateInstance 函式</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jetcreateinstance2-function">JetCreateInstance2 函式</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jetcreatetable-function">JetCreateTable 函式</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jetdelete-function">JetDelete 函式</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jetdetachdatabase-function">JetDetachDatabase 函式</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jetdetachdatabase2-function">JetDetachDatabase2 函式</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jetdupcursor-function">JetDupCursor 函式</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jetendexternalbackup-function">JetEndExternalBackup 函式</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jetenumeratecolumns-function">JetEnumerateColumns 函式</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jetescrowupdate-function">JetEscrowUpdate 函式</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jetexternalrestore2-function">JetExternalRestore2 函式</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jetgetattachinfo-function">JetGetAttachInfo 函式</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jetgetcolumninfo-function">JetGetColumnInfo 函式</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jetgetdatabaseinfo-function">JetGetDatabaseInfo 函式</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jetgetindexinfo-function">JetGetIndexInfo 函式</a></li>
...
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jetgetrecordposition-function">JetGetRecordPosition 函式</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jetgettableindexinfo-function">JetGetTableIndexInfo 函式</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jetgettableinfo-function">JetGetTableInfo 函式</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jetinit-function">JetInit 函式</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jetinit2-function">JetInit2 函式</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jetinit3-function">JetInit3 函式</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jetintersectindexes-function">JetIntersectIndexes 函式</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jetmakekey-function">JetMakeKey 函式</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jetmove-function">JetMove 函式</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jetopendatabase-function">JetOpenDatabase 函式</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jetopenfile-function">JetOpenFile 函式</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jetopenfileinstance-function">JetOpenFileInstance 函式</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jetopentable-function">JetOpenTable 函式</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jetopentemptable-function">JetOpenTempTable 函式</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jetopentemptable2-function">JetOpenTempTable2 函式</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jetopentemptable3-function">JetOpenTempTable3 函式</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jetossnapshotfreeze-function">JetOSSnapshotFreeze 函式</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jetossnapshotprepare-function">JetOSSnapshotPrepare 函式</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jetreadfileinstance-function">JetReadFileInstance 函式</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jetregistercallback-function">JetRegisterCallback 函式</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jetrestore-function">JetRestore 函式</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jetrestore2-function">JetRestore2 函式</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jetrestoreinstance-function">JetRestoreInstance 函式</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jetretrievecolumn-function">JetRetrieveColumn 函式</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jetretrievecolumns-function">JetRetrieveColumns 函式</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jetretrievekey-function">JetRetrieveKey 函式</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jetsetcolumn-function">JetSetColumn 函式</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jetsetcolumns-function">JetSetColumns 函式</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jetsetcurrentindex-function">JetSetCurrentIndex 函式</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jetsetcurrentindex2-function">JetSetCurrentIndex2 函式</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jetsetcurrentindex3-function">JetSetCurrentIndex3 函式</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jetsetcurrentindex4-function">JetSetCurrentIndex4 函式</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jetsetindexrange-function">JetSetIndexRange 函式</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jetsetls-function">JetSetLS 函式</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jetstopservice-function">JetStopService 函式</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jetterm-function">JetTerm 函式</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jetterm2-function">JetTerm2 函式</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jetupdate-function">JetUpdate 函式</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/jetupdate2-function">JetUpdate2 函式</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/transaction-log-parameters">交易記錄檔參數</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/extensible-storage-engine/transactions">交易 (Windows 事件)</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/security">安全性和身分識別</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/shell/handlers">建立 Shell 擴充功能處理常式</a></li>
...
<li><a href="https://docs.microsoft.com/windows/desktop/shell/nn-shobjidl-istorageprovidercopyhook">IStorageProviderCopyHook 介面</a></li>
...
<li><a href="https://docs.microsoft.com/windows/win32/api/fwpmu/nf-fwpmu-fwpmfilteradd0">FwpmFilterAdd0 函式 (fwpmu.h) </a></li>
