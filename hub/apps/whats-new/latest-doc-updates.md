...
ms.locfileid: "89429129"
---
# <a name="latest-updates-to-the-windows-developer-docs"></a>Windows 開發人員文件的最新更新

Windows 開發人員文件會定期更新，並提供新的和改進的資訊及內容。 以下是 2020 年 9 月 3 日的變更摘要。
...
本月我們將數千個絕對連結轉譯成相對連結，以便提升瀏覽速度並改善離線叢書的體驗。 如果您發現中斷的連結，請繼續讓我們知道！ 您可以從大部分的頁面提供意見反應，或透過我們控制的 **WindowsDocs** 在 Twitter 上聯繫我們。

本月重點包括：

* 更新有 4 個部分的教學課程系列，以使用 WinUI [UI](https://docs.microsoft.com/windows/uwp/design/basics/xaml-basics-ui) 和[資料繫結](https://docs.microsoft.com/windows/uwp/data-binding/xaml-basics-data-binding)、[範例程式碼](https://github.com/microsoft/Windows-appsample-photo-lab/tree/master/xaml-basics-starting-points)。 

* [Windows 終端機 1.2](https://docs.microsoft.com/windows/terminal/) 和預覽版 1.3 文件更新。

* 新的[設定您的開發環境](https://docs.microsoft.com/windows/dev-environment/overview)頁面。

* 一些新的 [AI 和機器學習](https://docs.microsoft.com/windows/win32/direct3d12/gpu-faq)常見問題更新。

* 關於 [C++/WinRT 與 C++/CX 之間的非同步和相互操作](https://docs.microsoft.com/windows/uwp/cpp-and-winrt-apis/interop-winrt-cx-async)的新 WinRT/C++ 主題。
...
<ul>
<li><a href="https://docs.microsoft.com/windows/desktop/AD/security-properties">使用者安全性屬性</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/AD/user-object-user-interface-mapping">使用者物件使用者介面對應</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/CIMWin32Prov/operating-system-classes">作業系統類別</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/CIMWin32Prov/win32-cachememory">Win32_CacheMemory 類別</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/CIMWin32Prov/win32-cdromdrive">Win32_CDROMDrive 類別</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/CIMWin32Prov/win32-computersystem">Win32_ComputerSystem 類別</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/CIMWin32Prov/win32-diskdrive">Win32_DiskDrive 類別</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/CIMWin32Prov/win32-networkadapterconfiguration">Win32_NetworkAdapterConfiguration 類別</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/CIMWin32Prov/win32-operatingsystem">Win32_OperatingSystem 類別</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/CIMWin32Prov/win32-potsmodem">Win32_POTSModem 類別</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/CIMWin32Prov/win32-printer">Win32_Printer 類別</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/CIMWin32Prov/win32-process">Win32_Process 類別</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/CIMWin32Prov/win32-videocontroller">Win32_VideoController 類別</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/DMWmiBridgeProv/mdm-policy-config01-internetexplorer02">MDM_Policy_Config01_InternetExplorer02 類別</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/DMWmiBridgeProv/mdm-policy-config01-privacy02">MDM_Policy_Config01_Privacy02 類別</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/DMWmiBridgeProv/mdm-policy-config01-update02">MDM_Policy_Config01_Update02 類別</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/DMWmiBridgeProv/mdm-policy-result01-internetexplorer02">MDM_Policy_Result01_InternetExplorer02 類別</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/DMWmiBridgeProv/mdm-policy-result01-privacy02">MDM_Policy_Result01_Privacy02 類別</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/DMWmiBridgeProv/mdm-policy-result01-update02">MDM_Policy_Result01_Update02 類別</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/DMWmiBridgeProv/mdm-policy-user-config01-internetexplorer02">MDM_Policy_User_Config01_InternetExplorer02 類別</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/DMWmiBridgeProv/mdm-policy-user-result01-internetexplorer02">MDM_Policy_User_Result01_InternetExplorer02 類別</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/Debug/pe-format">PE 格式</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/DevIO/registering-for-device-notification">註冊裝置通知</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/Direct2D/custom-effects">自訂效果</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/Direct2D/interfaces">Direct2D 介面</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/DirectWrite/custom-font-sets-win10">自訂字型集</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/DirectWrite/interfaces">DirectWrite 介面</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/FileIO/file-management-control-codes">檔案管理控制碼</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/FileIO/volume-management-control-codes">磁碟區管理控制碼</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/HyperV_v2/msvm-diskdrive">Msvm_DiskDrive 類別</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/HyperV_v2/msvm-diskettedrive">Msvm_DisketteDrive 類別</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/HyperV_v2/msvm-dvddrive">Msvm_DVDDrive 類別</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/HyperV_v2/msvm-emulatedethernetport">Msvm_EmulatedEthernetPort 類別</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/HyperV_v2/msvm-ethernetswitchport">Msvm_EthernetSwitchPort 類別</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/HyperV_v2/msvm-externalethernetport">Msvm_ExternalEthernetPort 類別</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/HyperV_v2/msvm-externalfcport">Msvm_ExternalFcPort 類別</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/HyperV_v2/msvm-fcswitchport">Msvm_FcSwitchPort 類別</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/HyperV_v2/msvm-internalethernetport">Msvm_InternalEthernetPort 類別</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/HyperV_v2/msvm-logicaldisk">Msvm_LogicalDisk 類別</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/HyperV_v2/msvm-memory">Msvm_Memory 類別</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/HyperV_v2/msvm-processor">Msvm_Processor 類別</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/HyperV_v2/msvm-s3displaycontroller">Msvm_S3DisplayController 類別</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/HyperV_v2/msvm-serialcontroller">Msvm_SerialController 類別</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/HyperV_v2/msvm-synthetic3ddisplaycontroller">Msvm_Synthetic3DDisplayController 類別</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/HyperV_v2/msvm-syntheticdisplaycontroller">Msvm_SyntheticDisplayController 類別</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/HyperV_v2/msvm-syntheticethernetport">Msvm_SyntheticEthernetPort 類別</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/HyperV_v2/msvm-syntheticfcport">Msvm_SyntheticFcPort 類別</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/HyperV_v2/msvm-videohead">Msvm_VideoHead 類別</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/HyperV_v2/msvm-wifiport">Msvm_WiFiPort 類別</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/Multimedia/midi-reference">MIDI 參考</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/Multimedia/multimedia-functions">多媒體功能</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/Multimedia/waveform-audio-reference">波形音訊參考</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/PerfCtrs/about-performance-counters">關於效能計數器</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/PerfCtrs/adding-counter-names-and-descriptions-to-the-registry">將計數器名稱和描述新增至登錄</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/PerfCtrs/calculating-counter-values">計算計數器值</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/PerfCtrs/ctrpp">CTRPP</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/PerfCtrs/pdh-error-codes">效能資料協助程式錯誤碼</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/PerfCtrs/performance-counters-functions">效能計數器函式</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/PerfCtrs/performance-counters-schema">效能計數器結構描述</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/PerfCtrs/performance-counters-structures">效能計數器結構</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/PerfCtrs/using-the-perflib-functions-to-consume-counter-data">使用 PerfLib 函式來取用計數器資料</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/ProcThread/process-and-thread-functions">處理序和執行緒函式</a></li>

<li><a href="https://docs.microsoft.com/windows/desktop/SecAuthN/authentication-functions">驗證函式</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/SecAuthN/authentication-structures">驗證結構</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/SecAuthN/initializesecuritycontext--general">InitializeSecurityContext (General) 函式 (Sspi.h)</a></li>
...
<li><a href="https://docs.microsoft.com/windows/desktop/SecAuthZ/authorization-functions">授權函式 (授權)</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/SecCrypto/cryptography-functions">密碼編譯函式</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/SecCrypto/cryptography-structures">密碼編譯結構</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/SrvNodes/wmi-mi-omi-providers">WMI/MI/OMI 提供者</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/Sync/synchronization-functions">同步處理函式</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/SysInfo/acquiring-high-resolution-time-stamps">取得高解析度時間戳記</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/Tapi/tspi-line-device-functions">TSPI 線路裝置函式</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/TermServ/win32-terminalservice">Win32_TerminalService 類別</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/VDS/what-s-new-in-vds-in-windows-server-2008-r2-and-windows-7">Windows Server 2008 R2 和 Windows 7 中 VDS 的新功能</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/WinRT/functions">函式</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/WinRT/interfaces">介面</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/WinSock/what-s-new-for-windows-sockets-2">Windows 通訊端的新功能</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/WmiSdk/cimclas">CIM 類別 (WMI)</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/WmiSdk/win32-serverfeature">Win32_ServerFeature 類別</a></li>
...
<li><a href="https://docs.microsoft.com/windows/desktop/apiindex/windows-8-api-sets">Windows 8 API 集合</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/apiindex/windows-81-api-sets">Windows 8.1 API 集合</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/apiindex/windows-api-list">Windows API 索引</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/apiindex/winrt-apis-for-desktop-apps">適用於傳統型應用程式的 Windows 執行階段 8.x API</a></li>
...
<li><a href="https://docs.microsoft.com/windows/desktop/direct3d12/recording-command-lists-and-bundles">建立和記錄命令清單和組合</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/direct3d9/accurately-profiling-direct3d-api-calls">正確分析 Direct3D API 呼叫 (Direct3D 9)</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/direct3darticles/surface-sharing-between-windows-graphics-apis">Windows 圖形 API 之間共用的介面</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/dlgbox/dlgbox-programming-considerations">對話方塊程式設計考量</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/dxmath/ovw-xnamath-reference-functions-load">DirectXMath 程式庫向量載入函式</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/dxmath/ovw-xnamath-reference-functions-storage">DirectXMath 程式庫向量儲存函式</a></li>
...
<li><a href="https://docs.microsoft.com/windows/desktop/lwef/nse-folderview">實作資料夾檢視</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/medfound/metadata-properties-for-media-files">媒體檔案的中繼資料屬性</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/menurc/using-menus">使用功能表</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/printdocs/printing-and-print-spooler-functions">列印多工緩衝處理器 API 函式</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/properties/contact-bumper">連絡</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/properties/core-bumper">核心</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/properties/devices-bumper">裝置 (Windows 屬性系統)</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/properties/functions-propvarutil">PROPVARIANT 和 VARIANT 函式</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/properties/functions">函式 (Windows 屬性系統)</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/properties/gps-bumper">GPS</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/properties/photo-bumper">相片</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/shell/band-objects">建立自訂瀏覽器列、工具區和桌上區</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/shell/dataobject">命令介面資料物件</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/shell/datascenarios">處理命令介面資料傳輸案例</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/shell/shlwapi-wrappers">SHLWAPI 包裝函式</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/tablet/plug-in-data-and-the-realtimestylus-class">外掛程式資料和 RealTimeStylus 類別</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/winmsg/about-messages-and-message-queues">關於訊息和訊息佇列</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/winmsg/window-features">視窗功能</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/winmsg/window-functions">視窗函式</a></li>
<li><a href="https://docs.microsoft.com/windows/desktop/winmsg/windows">Windows (視窗和訊息)</a></li>
</ul>
...
<li><a href="https://docs.microsoft.com/windows/win32/api/clusapi/nf-clusapi-getcurrentclusternodeid">GetCurrentClusterNodeId macro (clusapi.h) </a></li>
<li><a href="https://docs.microsoft.com/windows/win32/api/commctrl/nf-commctrl-listview_getitemtext">ListView_GetItemText 巨集 (commctrl.h) </a></li>
...
<li><a href="https://docs.microsoft.com/windows/win32/api/commctrl/nf-commctrl-listview_setitemtext">ListView_SetItemText 巨集 (commctrl.h) </a></li>
...
<li><a href="https://docs.microsoft.com/windows/win32/api/compressapi/nf-compressapi-closecompressor">CloseCompressor 函式 (compressapi.h) </a></li>
<li><a href="https://docs.microsoft.com/windows/win32/api/compressapi/nf-compressapi-closedecompressor">CloseDecompressor 函式 (compressapi.h) </a></li>
<li><a href="https://docs.microsoft.com/windows/win32/api/compressapi/nf-compressapi-compress">壓縮函式 (compressapi.h) </a></li>
<li><a href="https://docs.microsoft.com/windows/win32/api/compressapi/nf-compressapi-createcompressor">CreateCompressor 函式 (compressapi.h) </a></li>
<li><a href="https://docs.microsoft.com/windows/win32/api/compressapi/nf-compressapi-createdecompressor">CreateDecompressor 函式 (compressapi.h) </a></li>
<li><a href="https://docs.microsoft.com/windows/win32/api/compressapi/nf-compressapi-decompress">解壓縮函式 (compressapi.h) </a></li>
<li><a href="https://docs.microsoft.com/windows/win32/api/compressapi/nf-compressapi-querycompressorinformation">QueryCompressorInformation 函式 (compressapi.h) </a></li>
<li><a href="https://docs.microsoft.com/windows/win32/api/compressapi/nf-compressapi-querydecompressorinformation">QueryDecompressorInformation 函式 (compressapi.h) </a></li>
<li><a href="https://docs.microsoft.com/windows/win32/api/compressapi/nf-compressapi-resetcompressor">ResetCompressor 函式 (compressapi.h) </a></li>
<li><a href="https://docs.microsoft.com/windows/win32/api/compressapi/nf-compressapi-resetdecompressor">ResetDecompressor 函式 (compressapi.h) </a></li>
<li><a href="https://docs.microsoft.com/windows/win32/api/compressapi/nf-compressapi-setcompressorinformation">SetCompressorInformation 函式 (compressapi.h) </a></li>
<li><a href="https://docs.microsoft.com/windows/win32/api/compressapi/nf-compressapi-setdecompressorinformation">SetDecompressorInformation 函式 (compressapi.h) </a></li>
...
<li><a href="https://docs.microsoft.com/windows/win32/api/dbghelp/nf-dbghelp-symgetlinefromaddrw64">SymGetLineFromAddrW64 函式 (dbghelp.h) </a></li>
<li><a href="https://docs.microsoft.com/windows/win32/api/dbghelp/nf-dbghelp-symgetlinefrominlinecontextw">SymGetLineFromInlineContextW 函式 (dbghelp.h) </a></li>
<li><a href="https://docs.microsoft.com/windows/win32/api/dbghelp/nf-dbghelp-symgetmoduleinfow64">SymGetModuleInfoW64 函式 (dbghelp.h) </a></li>
...
<li><a href="https://docs.microsoft.com/windows/win32/api/dwmapi/nf-dwmapi-dwmenableblurbehindwindow">DwmEnableBlurBehindWindow 函式 (dwmapi.h) </a></li>
...
<li><a href="https://docs.microsoft.com/windows/win32/api/evntprov/nf-evntprov-eventwrite">EventWrite 函式 (evntprov.h) </a></li>
...
<li><a href="https://docs.microsoft.com/windows/win32/api/memoryapi/nf-memoryapi-virtualalloc2">VirtualAlloc2 函式 (memoryapi.h) </a></li>
...
<li><a href="https://docs.microsoft.com/windows/win32/api/mscat/nf-mscat-cryptcatopen">CryptCATOpen 函式 (mscat.h) </a></li>
...
<li><a href="https://docs.microsoft.com/windows/win32/api/ntddkbd/index">Ntddkbd.h 標頭 </a></li>
...
<li><a href="https://docs.microsoft.com/windows/win32/api/ntdsapi/nf-ntdsapi-dsquerysitesbycostw">DsQuerySitesByCostW 函式 (ntdsapi.h) </a></li>
...
<li><a href="https://docs.microsoft.com/windows/win32/api/ole2/nf-ole2-olecreate">OleCreate 函式 (ole2.h) </a></li>
<li><a href="https://docs.microsoft.com/windows/win32/api/ole2/nf-ole2-olecreatefromfile">OleCreateFromFile 函式 (ole2.h) </a></li>
<li><a href="https://docs.microsoft.com/windows/win32/api/ole2/nf-ole2-oledraw">OleDraw 函式 (ole2.h) </a></li>
<li><a href="https://docs.microsoft.com/windows/win32/api/ole2/nf-ole2-oleloadfromstream">OleLoadFromStream 函式 (ole2.h) </a></li>
<li><a href="https://docs.microsoft.com/windows/win32/api/ole2/nf-ole2-olesavetostream">OleSaveToStream 函式 (ole2.h) </a></li>
<li><a href="https://docs.microsoft.com/windows/win32/api/oleauto/nf-oleauto-varr4cmpr8">VarR4CmpR8 函式 (oleauto.h) </a></li>
<li><a href="https://docs.microsoft.com/windows/win32/api/processenv/nf-processenv-getenvironmentvariablea">GetEnvironmentVariableA 函式 (processenv.h) </a></li>
<li><a href="https://docs.microsoft.com/windows/win32/api/processenv/nf-processenv-setenvironmentvariablew">SetEnvironmentVariableW 函式 (processenv.h) </a></li>
...
<li><a href="https://docs.microsoft.com/windows/win32/api/shlwapi/nf-shlwapi-shregcreateuskeyw">SHRegCreateUSKeyW 函式 (shlwapi.h) </a></li>
<li><a href="https://docs.microsoft.com/windows/win32/api/shlwapi/nf-shlwapi-shregsetusvaluew">SHRegSetUSValueW 函式 (shlwapi.h) </a></li>
<li><a href="https://docs.microsoft.com/windows/win32/api/shlwapi/nf-shlwapi-shregwriteusvaluew">SHRegWriteUSValueW 函式 (shlwapi.h) </a></li>
<li><a href="https://docs.microsoft.com/windows/win32/api/sspi/ne-sspi-secpkg_cred_class">SECPKG_CRED_CLASS (sspi.h) </a></li>
<li><a href="https://docs.microsoft.com/windows/win32/api/tapi/nf-tapi-tapigetlocationinfow">tapiGetLocationInfoW 函式 (tapi.h) </a></li>
<li><a href="https://docs.microsoft.com/windows/win32/api/tbs/ns-tbs-tbs_context_params2">TBS_CONTEXT_PARAMS2 (tbs.h) </a></li>
<li><a href="https://docs.microsoft.com/windows/win32/api/tlhelp32/nf-tlhelp32-module32firstw">Module32FirstW 函式 (tlhelp32.h) </a></li>
<li><a href="https://docs.microsoft.com/windows/win32/api/tlhelp32/nf-tlhelp32-module32nextw">Module32NextW 函式 (tlhelp32.h) </a></li>
<li><a href="https://docs.microsoft.com/windows/win32/api/tlhelp32/nf-tlhelp32-process32firstw">Process32FirstW 函式 (tlhelp32.h) </a></li>
<li><a href="https://docs.microsoft.com/windows/win32/api/tlhelp32/nf-tlhelp32-process32nextw">Process32NextW 函式 (tlhelp32.h) </a></li>
...
<li><a href="https://docs.microsoft.com/windows/win32/api/uxtheme/nf-uxtheme-drawthemeedge">DrawThemeEdge 函式 (uxtheme.h) </a></li>
<li><a href="https://docs.microsoft.com/windows/win32/api/uxtheme/nf-uxtheme-enablethemedialogtexture">EnableThemeDialogTexture 函式 (uxtheme.h) </a></li>
<li><a href="https://docs.microsoft.com/windows/win32/api/uxtheme/nf-uxtheme-enabletheming">EnableTheming 函式 (uxtheme.h) </a></li>
<li><a href="https://docs.microsoft.com/windows/win32/api/uxtheme/nf-uxtheme-setthemeappproperties">SetThemeAppProperties 函式 (uxtheme.h) </a></li>
<li><a href="https://docs.microsoft.com/windows/win32/api/virtdisk/nf-virtdisk-openvirtualdisk">OpenVirtualDisk 函式 (virtdisk.h) </a></li>
...
<li><a href="https://docs.microsoft.com/windows/win32/api/wincred/nf-wincred-credpackauthenticationbuffera">CredPackAuthenticationBufferA 函式 (wincred.h) </a></li>
<li><a href="https://docs.microsoft.com/windows/win32/api/wincred/nf-wincred-credpackauthenticationbufferw">CredPackAuthenticationBufferW 函式 (wincred.h) </a></li>
...
<li><a href="https://docs.microsoft.com/windows/win32/api/windns/nf-windns-dnsnamecompare_a">DnsNameCompare_A 函式 (windns.h) </a></li>
<li><a href="https://docs.microsoft.com/windows/win32/api/windns/nf-windns-dnsnamecompare_w">DnsNameCompare_W 函式 (windns.h) </a></li>
<li><a href="https://docs.microsoft.com/windows/win32/api/windns/nf-windns-dnsvalidatename_a">DnsValidateName_A 函式 (windns.h) </a></li>
<li><a href="https://docs.microsoft.com/windows/win32/api/windns/nf-windns-dnsvalidatename_utf8">DnsValidateName_UTF8 函式 (windns.h) </a></li>
<li><a href="https://docs.microsoft.com/windows/win32/api/windns/nf-windns-dnsvalidatename_w">DnsValidateName_W 函式 (windns.h) </a></li>
...
<li><a href="https://docs.microsoft.com/windows/win32/api/winnls/nf-winnls-resolvelocalename">ResolveLocaleName 函式 (winnls.h) </a></li>
<li><a href="https://docs.microsoft.com/windows/win32/api/winreg/nf-winreg-reggetvaluea">RegGetValueA 函式 (winreg.h) </a></li>
<li><a href="https://docs.microsoft.com/windows/win32/api/winreg/nf-winreg-reggetvaluew">RegGetValueW 函式 (winreg.h) </a></li>

<li><a href="https://docs.microsoft.com/windows/win32/api/winuser/nf-winuser-dlgdirlista">DlgDirListA 函式 (winuser.h) </a></li>
<li><a href="https://docs.microsoft.com/windows/win32/api/winuser/nf-winuser-messagebox">MessageBox 函式 (winuser.h) </a></li>
...
<li><a href="https://docs.microsoft.com/windows/win32/api/wsipv6ok/nf-wsipv6ok-gethostbyaddr">gethostbyaddr 巨集 (wsipv6ok.h) </a></li>
<li><a href="https://docs.microsoft.com/windows/win32/api/wsipv6ok/nf-wsipv6ok-wsaasyncgethostbyaddr">WSAAsyncGetHostByAddr 巨集 (wsipv6ok.h) </a></li>
<li><a href="https://docs.microsoft.com/windows/win32/api/wsipv6ok/nf-wsipv6ok-wsaasyncgethostbyname">WSAAsyncGetHostByName 巨集 (wsipv6ok.h) </a></li>
...
<li><a href="https://docs.microsoft.com/windows/win32/api/xaudio2/nf-xaudio2-xaudio2create">XAudio2Create 函式 (xaudio2.h) </a></li>
</ul>
