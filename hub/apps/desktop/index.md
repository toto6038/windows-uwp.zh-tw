        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>桌面應用程式現代化</h3>
                        <p>使用最新的 Windows 功能來增強現有的 WPF、Windows Forms 及 Win32 應用程式。</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        ...
                        <p></p>適用於 Windows 10 應用程式和遊戲的先進平台。</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Win32</h3>
                        <p></p>這是適用於原生 C/C++ Windows 應用程式的原創平台，需要直接存取 Windows 和硬體。 </p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                    <h3>WPF</h3>
                    <p>這是適用於受管理 Windows 應用程式的新創平台，具有 XAML UI 模型並可存取完整的 .NET Framework。</p>
                  </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                    <h3>Windows Forms</h3>
                    <p>快速開發的企業營運應用程式，具有輕量型 UI 模型並可存取完整的 .NET Framework。 </p>
                  </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                    <h3>.NET</h3>
                    <p>強大且全方位的開發平台，提供可讓 WPF 和 Windows Forms 應用程式執行的基礎結構。</p>
                  </div>
                </div>
            </div>
        </div>
            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        ...
                        <p><a href="https://docs.microsoft.com/microsoft-edge/progressive-web-apps">漸進式 Web 應用程式</a></p>
                        <p><a href="https://docs.microsoft.com/previous-versions/windows/">Windows 8.x 和舊版的文件封存</a></p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        ...
                        <p><a href="https://adaptivecards.io/">調適型卡片</a></p>
