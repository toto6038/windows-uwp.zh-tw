...
在本教學課程的這個部分中，您會將整個 Contoso 費用應用程式從 .NET Framework 4.7.2 遷移至[.Net Core 3](modernize-wpf-tutorial.md#net-core-3)。 在您開始本教學課程的這個部分之前，請確定您已在 Visual Studio 2019 中[開啟並建立 ContosoExpenses 範例](modernize-wpf-tutorial.md#get-the-contoso-expenses-sample-app)。
