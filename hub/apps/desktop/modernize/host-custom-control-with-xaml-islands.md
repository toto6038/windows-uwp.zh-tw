...
ms.locfileid: "69643762"
---
# <a name="host-a-custom-uwp-control-in-a-wpf-app-using-xaml-islands"></a>使用 XAML 群島在 WPF 應用程式中裝載自訂 UWP 控制項

本文示範如何使用 Windows 社區工具組中的[WindowsXamlHost](https://docs.microsoft.com/windows/communitytoolkit/controls/wpf-winforms/windowsxamlhost)控制項, 在以 .net Core 3 為目標的 WPF 應用程式中裝載自訂 UWP 控制項。 自訂控制項包含數個第一方 UWP 控制項, 並將其中一個 UWP 控制項中的屬性系結至 WPF 應用程式中的字串。
...
1. 如果您還沒有這麼做, 請安裝最新的[.Net Core 3 PREVIEW SDK](https://dotnet.microsoft.com/download/dotnet-core/3.0)可用預覽版本。
...
1. 將新的[Windows 應用程式封裝專案](https://docs.microsoft.com/windows/msix/desktop/desktop-to-uwp-packaging-dot-net)新增至您的方案。 當您建立專案時, 請選取 [ **Windows 10, 版本 1903 (10.0;)]。組建 18362)** , 適用于**目標版本**和**最低版本**。
