...
<div class="container">
    ...
    <ul class="pivots">
        <li>
            <a data-default="true" href="#developer">開發人員</a>
            <ul id="developer">
                <li>
                                ...
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>UWP app</h3>
                                            <p>
                                                <a href="https://developer.microsoft.com/windows/apps/getstarted">入門</a>
                                            </p>
                                            <p>
                                ...
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>桌面</h3>
                                            <p>
                                                <a href="https://developer.microsoft.com/windows/desktop/getstarted">入門</a>
                                            </p>
                                            <p>
                                ...
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>遊戲</h3>
                                            <p>
                                                <a href="https://developer.microsoft.com/windows/games/getstarted">入門</a>
                                            </p>
                                            <p>
                                                <a href="https://developer.microsoft.com/windows/games/design">UI 設計</a>
                                            </p>
                                            <p>
                                                <a href="https://developer.microsoft.com/windows/games/develop">開發</a>
                                            </p>
                                            <p>
                                                <a href="https://developer.microsoft.com/windows/games/publish">發佈</a>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>全像攝影</h3>
                                            <p>
                                                <a href="https://developer.microsoft.com/windows/holographic/getting_started">入門</a>
                                            </p>
                                            <p>
                                                <a href="https://developer.microsoft.com/windows/holographic/academy">學院</a>
                                            </p>
                                            <p>
                                                <a href="https://developer.microsoft.com/windows/holographic/documentation">文件</a>
                                            </p>
                                            <p>
                                                <a href="https://developer.microsoft.com/windows/holographic/community">社群</a>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <ul id="hardware-dev1" class="cardsC">
                        <li>
                            <div class="container intro">
                                <p>使用 Windows 10 建置創新且與眾不同的裝置</p>
                            </div>
                        </li>
                        <li>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>自訂</h3>
                                                <p>將設定、語言和驅動程式套用到 Windows 10 映像。</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>Windows 10 與 Windows 10 行動裝置版</h3>
                                                <p>了解如何規劃、部署、管理及保護 Windows 10 與 Windows 10 行動裝置版。</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>瀏覽器</h3>
                                                <p>了解如何部署及管理 Microsoft Edge 和 Internet Explorer 11。</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
