...
[!code-cs[頂點](./code/3dprinthowto/cs/Generate3MFMethods.cs#SnippetVertices)]
...
[從應用程式進行 3D 列印](https://msdn.microsoft.com/windows/uwp/devices-sensors/3d-print-from-app)
