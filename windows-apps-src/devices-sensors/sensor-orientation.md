...
| 橫向           | -Z | 0   | 朝向               |
| 直向            |  Y | 90  | (朝向 + 270) % 360 | 
| LandscapeFlipped    |  Z | 180 | (朝向 + 180) % 360 |
| PortraitFlipped     |  Y | 270 | (朝向 + 90) % 360  |
