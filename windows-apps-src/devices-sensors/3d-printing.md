...
ms.locfileid: "3823662"
---
# <a name="3d-printing"></a>3D 列印


本章節描述如何使用[Windows.Graphics.Printing3D 命名空間](https://msdn.microsoft.com/library/windows/apps/windows.graphics.printing3d.aspx)將 3D 列印功能新增到您的通用 Windows 應用程式。  
