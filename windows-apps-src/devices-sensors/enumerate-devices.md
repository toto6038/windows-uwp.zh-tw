...
若要下載示範 [**Windows.Devices.Enumeration**](https://msdn.microsoft.com/library/windows/apps/BR225459) API 更進階使用方式的範例，可按一下[這裡](https://go.microsoft.com/fwlink/?LinkID=620536)。
