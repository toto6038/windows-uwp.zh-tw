...
**提示**  如果您需要在應用程式內一個以上的頁面中支援列印，可以將這個列印程式碼放置於常用協助程式類別中，並讓您的應用程式頁面重複使用它。 如需如何執行這項操作的範例，請參閱 [UWP 列印範例](http://go.microsoft.com/fwlink/p/?LinkId=619984)中的 `PrintHelper` 類別。
