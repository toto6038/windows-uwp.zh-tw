---
Description: 使用對齊、邊界和邊框間距屬性，在頁面上排列元素的版面配置。
title: 對齊、邊界及配置的邊框間距
ms.date: 03/19/2018
ms.topic: article
...
- [**HorizontalAlignment**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.frameworkelement.horizontalalignment)和[**VerticalAlignment**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.frameworkelement.verticalalignment)指定專案在其父容器內的位置。
...
[**填補**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.frameworkelement.padding)控制元素的內部框線與其子內容或專案之間的空間量。 正數的邊框間距值會減少元素的內容區域。 

不同於邊界，邊框間距不是 FrameworkElement 的屬性。 有幾個類別，每一個皆定義其自身的邊框間距屬性：

-   [**控制項. 填補**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.control.padding)：繼承至所有[**控制項**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls)衍生類別。 不是所有控制項都有內容，因此對於那些控制項而言，沒有必要設定屬性。 如果控制項有邊框，將會在該邊框內套用邊框間距。
-   [**Border. 填補**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.border.padding)：定義[**BorderThickness**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.border.borderthickness)所建立之矩形線之間的間距/[**borderbrush 設定**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.border.borderbrush)和[**子**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.border.child)元素。
-   [**ItemsPresenter 填補**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.itemspresenter.padding)：提供專案控制項中專案的外觀，並將指定的填補放在每個專案周圍。
-   [**TextBlock. 填補**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.textblock.padding)和[**RichTextBlock。填補**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.richtextblock.padding)：展開文字元素文字周圍的周框方塊。 這些的文字元素沒有 **Background**，因此不容易看出。 基於這個原因，使用 [**邊界**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.documents.block.margin) 改在 [**區塊**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.documents.block)容器上設定。
...
* [**控制項. 填補**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.control.padding)
