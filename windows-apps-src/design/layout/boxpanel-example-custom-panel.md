...
> [!NOTE]
> 內部邏輯[ **StackPanel** ](https://msdn.microsoft.com/library/windows/apps/br209635)也有這種行為：**StackPanel**傳遞的無限的維度值才能[**量值**](https://msdn.microsoft.com/library/windows/apps/br208952)子系，表示為沒有方向維度中的子系的條件約束。 **StackPanel** 一般會動態調整本身的大小，以容納堆疊中在該維度不斷增加的所有子系。
