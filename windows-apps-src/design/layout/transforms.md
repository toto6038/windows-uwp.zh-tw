...
-   [**TranslateTransform**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Media.TranslateTransform)： 依設定的值平移 x y 空間中的項目[ **X** ](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.translatetransform.x)並[ **Y** ](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.translatetransform.y).
-   [**ScaleTransform**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Media.ScaleTransform)： 縮放中心點，以藉由設定值的轉換[ **CenterX**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.scaletransform.centerx)， [ **CenterY**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.scaletransform.centery)， [ **ScaleX** ](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.scaletransform.scalex)並[ **ScaleY**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.scaletransform.scaleyproperty)。
-   [**RotateTransform**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Media.RotateTransform): x y 空間中旋轉設定值[**角度**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.rotatetransform.angle)， [ **CenterX** ](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.rotatetransform.centerx)和[ **CenterY**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.rotatetransform.centery)。
-   [**SkewTransform**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Media.SkewTransform)： 扭曲或 x y 空間中所設定的值的傾斜[ **AngleX**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.skewtransform.anglex)， [ **AngleY**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.skewtransform.angley)，[ **CenterX** ](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.skewtransform.centerx)並[ **CenterY**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.scaletransform.centeryproperty)。
...
-   [**Brush.Transform**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.brush.transform)， [ **Brush.RelativeTransform**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.brush.relativetransform):這些影響如何[**筆刷**](/uwp/api/Windows.UI.Xaml.Media.Brush)會使用座標空間區域內，**筆刷**套用至設定視覺屬性，例如 foregrounds 和背景。 這些轉換與最常見的筆刷 (通常以 [**SolidColorBrush**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Media.SolidColorBrush) 設定純色) 無關，但是以 [**ImageBrush**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Media.ImageBrush) 或 [**LinearGradientBrush**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Media.LinearGradientBrush) 繪製區域時，可能偶爾會有用。
-   [**Geometry.Transform**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.geometry.transform):您可能會使用這個屬性來套用轉換至之前使用該幾何的幾何[ **Path.Data** ](https://docs.microsoft.com/uwp/api/windows.ui.xaml.shapes.path.data)屬性值。
...
如果您具有數學背景，或是熟悉也使用矩陣描述座標空間轉換的圖形程式設計技術，那麼轉換的數學描述可能對您很有用。 沒有[**轉換**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Media.Transform)-衍生的類別，可讓您表示其 3 × 3 矩陣方面，直接轉換：[**MatrixTransform**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Media.MatrixTransform)。 **MatrixTransform**已經[**矩陣**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.matrixtransform.matrix)屬性，其中包含具有六個屬性的結構：[**M11**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.matrix.m11)， [ **M12**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.matrix.m12)， [ **M21**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.matrix.m21)， [ **M22**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.matrix.m22)， [ **OffsetX** ](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.matrix.offsetx)並[ **OffsetY**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.matrix.offsety)。 每個 [**Matrix**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Media.Matrix) 屬性都使用一個 **Double** 值，並且對應至仿射轉換矩陣的六個相關值 (第 1 與第 2 欄)。
