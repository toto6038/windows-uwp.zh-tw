...
若要刪除容器，請呼叫 [**ApplicationDataContainer.DeleteContainer**](https://docs.microsoft.com/uwp/api/windows.storage.applicationdatacontainer.deletecontainer) 方法。 此範例會刪除我們稍早建立的本機 `exampleContainer` 設定。
