...
> **重要的 Api**:[超連結文字項目](https://msdn.microsoft.com/library/windows/apps/dn279356)，[按一下 HyperlinkButton 控制項](https://msdn.microsoft.com/library/windows/apps/br242739)
