...
*模式*是修改控制項或結合數個控制項以創造新項目的秘訣。 例如[主要/詳細資料](master-details.md)模式時，您可以使用[SplitView](split-view.md)控制項，瀏覽 app 的方式。 同樣地，您可以自訂來實作索引標籤模式[NavigationView](navigationview.md)控制項的範本。
