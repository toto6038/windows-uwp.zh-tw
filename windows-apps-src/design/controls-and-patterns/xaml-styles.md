...
-   隱含樣式，只為 [Style](https://docs.microsoft.com/uwp/api/windows.ui.xaml.style.targettype) 指定 [TargetType](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Style)。
-   明確樣式，為 [Style](https://docs.microsoft.com/uwp/api/windows.ui.xaml.style.targettype) 指定 [TargetType](../../xaml-platform/x-key-attribute.md) 和 [x:Key 屬性](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Style)，然後透過使用此明確索引鍵的 [{StaticResource} 標記延伸](https://docs.microsoft.com/uwp/api/windows.ui.xaml.frameworkelement.style)參考來設定目標控制項的 [Style](https://docs.microsoft.com/windows/uwp/xaml-platform/staticresource-markup-extension) 屬性。
...
Style Setter 可以用於 [Control](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.control.template) 的 [Template](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Controls.Control) 屬性，事實上，大多數的典型 XAML 樣式和應用程式 XAML 資源都是由此組成。 這部分內容將在[控制項範本](control-templates.md)主題中深入討論。
