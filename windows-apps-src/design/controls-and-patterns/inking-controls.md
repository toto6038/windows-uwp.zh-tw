---
description: 了解可在 Windows 應用程式中方便使用筆跡和筆墨相關功能的 InkCanvas 和 InkToolbar 控制項。
title: 手寫筆跡控制項
...
ms.locfileid: "91217261"
---
# <a name="inking-controls"></a>手寫筆跡控制項



有兩個不同的控制項可協助在 Windows 應用程式中提供筆跡：[InkCanvas](/uwp/api/windows.ui.xaml.controls.inkcanvas) \(英文\) 和 [InkToolbar](/uwp/api/windows.ui.xaml.controls.inktoolbar) \(英文\)。
...
> **重要 API**：[InkCanvas 類別](/uwp/api/windows.ui.xaml.controls.inkcanvas) \(英文\)、[InkToolbar 類別](/uwp/api/windows.ui.xaml.controls.inktoolbar) \(英文\)、[InkPresenter 類別](/uwp/api/windows.ui.input.inking.inkpresenter) \(英文\)、[Windows.UI.Input.Inking](/uwp/api/Windows.UI.Input.Inking) \(英文\)
...
> [!NOTE] 
> 如需針對 InkCanvas 上的筆劃轉譯進行更詳盡的自訂，請使用基礎 [InkPresenter](/uwp/api/windows.ui.input.inking.inkpresenter) \(英文\) 物件。
...
Microsoft Edge 針對**網頁筆記**使用 InkCanvas 與 InkToolbar。  
![InkCanvas 用來實現 Microsoft Edge 中的筆跡](images/ink-tools-edge.png)
...
> [!NOTE]
> 如需使用 InkPresenter 自訂 InkCanvas 的詳細說明，請參閱 [Windows 應用程式中的手寫筆互動與 Windows Ink](../input/pen-and-stylus-interactions.md)一文。
...
- [SimpleInk 範例](https://github.com/Microsoft/Windows-universal-samples/tree/master/Samples/SimpleInk) \(英文\) - 示範 InkCanvas 與 InkToolbar 控制項的自訂和擴充功能的 8 個案例。 每個案例都提供了常見手寫筆跡情況與控制項實作的基本指導方針。
- [ComplexInk 範例](https://github.com/Microsoft/Windows-universal-samples/tree/master/Samples/ComplexInk) \(英文\) - 示範更為進階的筆跡案例。
- [XAML 控制項庫範例](https://github.com/Microsoft/Xaml-Controls-Gallery) \(英文\) - 以互動式格式查看所有 XAML 控制項。

## <a name="related-articles"></a>相關文章

- [Windows 應用程式中的手寫筆互動與 Windows Ink](../input/pen-and-stylus-interactions.md)
- [將 Windows Ink 筆劃辨識為文字和圖案](../input/convert-ink-to-text.md) \(部分機器翻譯\)
- [儲存和擷取 Windows Ink 筆劃資料](../input/save-and-load-ink.md) \(部分機器翻譯\)
