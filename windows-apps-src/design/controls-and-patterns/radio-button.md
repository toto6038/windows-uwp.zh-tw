...
>- 您可以使用個別 **[RadioButton](/uwp/api/Windows.UI.Xaml.Controls.RadioButton)** 控制項的群組。 如果您的應用程式未使用 WinUI 2.3 或更新版本，則這是唯一的選項。
...
:::row:::
   ...
   :::column span="":::
      **_具有初始 Tab 焦點的清單_**
      ...
      ![具有初始 Tab 焦點和已選取項目的清單](images/radiobutton-selected-item-tab-focus.png)
   :::column-end:::
:::row-end:::
