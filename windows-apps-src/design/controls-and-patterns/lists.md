...
<td>
    <p>如果您已安裝 <strong style="font-weight: semi-bold">XAML 控制項庫</strong>應用程式，請查看 <a href="xamlcontrolsgallery:/item/ListView">ListView</a>、<a href="xamlcontrolsgallery:/item/GridView">GridView</a>、<a href="xamlcontrolsgallery:/item/ComboBox">ComboBox</a> 和 <a href="xamlcontrolsgallery:/item/ListBox">ListBox</a> 的運作情形。</p>
    <ul>
