...
若要支援這一點，可設定 [**InkPresenter**](https://msdn.microsoft.com/library/windows/apps/dn899081) 來讓特定的輸入保持未處理狀態。 這個未處理的輸入接著會傳入您的應用程式進行處理。
...
* [開始使用：UWP 應用程式中的支援筆跡](../../get-started/ink-walkthrough.md)
