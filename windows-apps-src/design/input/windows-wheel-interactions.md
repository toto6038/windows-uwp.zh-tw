...
ms.locfileid: "74258303"
---
# <a name="surface-dial-interactions"></a>Surface Dial 互動

使用 Surface Studio 進行介面撥號的 ![影像](images/windows-wheel/dial-pen-studio-600px.png)  
...
**如同所有的 Windows 輸入裝置，您可以自訂並量身打造介面撥號互動體驗，以符合您應用程式中的功能。**
...
使用 Surface Pen ![介面撥號](images/windows-wheel/dial-and-pen-400px.png)  
*使用 Surface Pen 的表面撥號*
...
使用 Windows Ink 工具列的 [手寫筆選取工具] ![介面撥號功能表](images/windows-wheel/surface-dial-menu-inktoolbar-pen.png)  
*具有 Windows Ink 工具列之畫筆選取工具的表面撥號功能表*

具有 Windows Ink 工具列的 [筆觸大小] 工具的 ![表面撥號功能表](images/windows-wheel/surface-dial-menu-inktoolbar-strokesize.png)  
*適用于 Windows Ink 工具列的 [筆觸大小] 工具的表面撥號功能表*

具有 Windows Ink 工具列之尺規工具的 ![表面撥號功能表](images/windows-wheel/surface-dial-menu-inktoolbar-ruler.png)  
*具有 Windows Ink 工具列之尺規工具的表面撥號功能表*
...
| *具有 Alpha 背景的圖示* | *以預設主題顯示在滾輪功能表上的圖示* | *具有高對比白色主題的滾輪功能表上顯示的圖示* |
...
1. 首先，我們在 XAML 中宣告我們的 UI (只有一個滑桿和切換按鈕)。
   ...
   範例應用程式 UI 的 ![影像](images/windows-wheel/surface-dial-snippet-customtool1.png)  
   *範例應用程式 UI*
...
使用「介面撥號自訂工具」啟動的範例應用程式 UI ![影像](images/windows-wheel/surface-dial-snippet-customtool2.png)  
*使用介面撥號自訂工具啟用的範例應用程式 UI*
...
**具有持續或高旋轉敏感度的工具應該停用 haptic 的意見反應**
...
**如果使用者無法輕鬆地從結果復原，請勿將動作或命令對應至此手勢**
...
1. 首先，我們在 XAML 中宣告我們的 UI (四個區段，每個區段都有一個滑桿和切換按鈕)。
   ...
   範例應用程式 UI 的 ![影像](images/windows-wheel/surface-dial-snippet-customtool3.png)  
   *範例應用程式 UI*
...
使用「介面撥號自訂工具」啟動的範例應用程式 UI ![影像](images/windows-wheel/surface-dial-snippet-customtool4.png)  
*使用介面撥號自訂工具啟用的範例應用程式 UI*
...
[教學課程：支援 UWP 應用程式中的介面撥號（和其他輪子裝置）](radialcontroller-walkthrough.md)
...
[開始使用教學課程：支援 UWP 應用程式中的介面撥號（和其他輪子裝置）](https://github.com/Microsoft/Windows-tutorials-inputs-and-devices/tree/master/GettingStarted-RadialController)
