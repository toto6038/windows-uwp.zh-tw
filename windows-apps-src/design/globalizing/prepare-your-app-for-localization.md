...
- **當地語系化工具**一些當地語系化工具可供剖析資源檔，並允許只可翻譯的字串轉譯程式編輯。 這個方法可以降低翻譯人員不小心編輯到 XML 標記的風險。 但是它的缺點是要學習使用新的工具及當地語系化程序。 如果是含有大量字串但少量語言的專案，則適合使用當地語系化工具。 若要深入了解，請參閱[如何使用多語應用程式工具組](https://msdn.microsoft.com/en-us/library/windows/apps/xaml/jj572370.aspx)。
