...
如需傳送推播通知的詳細資訊，請參閱[快速入門：傳送推播通知](https://docs.microsoft.com/previous-versions/windows/apps/hh868252(v=win.10))。
...
* [快速入門：建立和登錄原始通知背景工作](https://docs.microsoft.com/previous-versions/windows/apps/jj676800(v=win.10))
