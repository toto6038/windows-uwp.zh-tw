...
> 如果您還沒有 Visual Studio 2017，有數個版本可用，包括免費版本 (Visual Studio 2017 Community Edition)，其他版本則提供免費試用。 您可以在此下載：[https://developer.microsoft.com/windows/downloads](https://developer.microsoft.com/windows/downloads)
