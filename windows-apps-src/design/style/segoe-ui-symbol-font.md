...
您也可以使用靜態資源`SymbolThemeFontFamily` **Segoe MDL2 Assets**，存取而不需指定字型依名稱：
```xaml
...
* Windows 10： 上沒有任何您需要執行，字型隨附的 Windows。
* 在 Mac 上您需要下載並安裝字型：<a href="https://aka.ms/SegoeFonts">取得 Segoe UI 和 MDL2 圖示字型</a>
