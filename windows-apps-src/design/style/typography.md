...
<div class="uwpd-image-with-caption">
    ...
    <div>所有大小皆以有效像素為單位。 如需詳細資訊，請參閱 [UWP 應用程式設計簡介](../basics/design-and-ui-intro.md)。</div>
</div>
...
若要在字體坡形以外建立其他階層，請將次要文字設為 60% 的不透明度。 在[佈景主題調色盤](color.md#themes)中，您可以使用 BaseMedium。 主要文字一律應為 100% 的不透明或 BaseHigh。
