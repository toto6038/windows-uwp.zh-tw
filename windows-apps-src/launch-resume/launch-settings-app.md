...
description: 瞭解如何使用 ms 設定 URI 配置，從您的應用程式啟動 Windows 設定應用程式。
...
### <a name="xaml-hyperlink-control"></a>XAML 超連結控制項
...
### <a name="calling-launchuriasync"></a>呼叫 LaunchUriAsync
...
:::image type="content" source="images/privacyawarenesssettingsapp.png" alt-text="相機隱私權設定。":::

如需啟動 URI 的詳細資訊，請參閱[啟動 URI 的預設 app](launch-default-app.md)。

## <a name="ms-settings-uri-scheme-reference"></a>ms-settings: URI 配置參考

下列各節說明用來開啟 [設定] 應用程式之各種頁面的不同類別的 ms 設定 Uri：
...
* [首頁](#home-page)
* [混合實境](#mixed-reality)
* [網路和網際網路](#network-and-internet)
* [個人化](#personalization)
* [電話](#phone)
* [隱私權](#privacy)
* [Surface Hub](#surface-hub)
* [系統](#system)
* [時間與語言](#time-and-language)
* [更新與安全性](#update-and-security)
* [使用者帳戶](#user-accounts)



> [!NOTE]
> [設定] 頁面是否可依 Windows SKU 而有所不同。 Windows 10 桌面版上所有的設定頁面不一定皆在 Windows 10 行動裝置版上，反之亦然。 附註欄也會擷取必須符合頁面才可供使用的其他需求。
...
### <a name="network-and-internet"></a>網路和網際網路
