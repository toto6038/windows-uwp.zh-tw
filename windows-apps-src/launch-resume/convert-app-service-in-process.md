...
移除`EntryPoint`屬性從`<Application>`元素因為[OnBackgroundActivated()](https://msdn.microsoft.com/library/windows/apps/windows.ui.xaml.application.onbackgroundactivated.aspx)現在會叫用應用程式服務時將使用的進入點。
