...
ms.locfileid: "75684449"
---
# <a name="connected-apps-and-devices-project-rome"></a>已連線的應用程式與裝置 (Project Rome)

本節說明如何使用[Project 羅馬](https://developer.microsoft.com/windows/project-rome)，跨裝置和平臺連接應用程式。 若要瞭解如何在跨平臺案例中執行專案羅馬，請造訪[專案羅馬的主要檔頁面](https://docs.microsoft.com/windows/project-rome/)。
