...
<p>每個應用程式的應用程式管理] 區段中的<a href="https://msdn.microsoft.com/library/windows/apps/mt148561.aspx">應用程式身分識別</a>頁面上，可以在<a href="https://partner.microsoft.com/dashboard">合作夥伴中心</a>中找到這些值。</p>
</td>
<td>
市集識別碼 <p>(建議使用)</p>
</td>
