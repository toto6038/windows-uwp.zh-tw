...
如需詳細資訊，請參閱 [app 擴充](https://msdn.microsoft.com/library/windows/apps/hh464906)。
...
當使用者在 app 當機之後再次啟用，其啟用事件處理常式會收到 **NotRunning** 的 [**ApplicationExecutionState**](https://msdn.microsoft.com/library/windows/apps/br224694) 值，而且應該顯示其初始 UI 和資料。 當機之後，請不要依照之前針對 **Resuming** 和 **Suspended** 的方式使用 app 資料，因為該資料可能已經損毀，請參閱 [App 暫停和繼續執行的指導方針](https://msdn.microsoft.com/library/windows/apps/hh465088)。
