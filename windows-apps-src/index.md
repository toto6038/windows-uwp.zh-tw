...
author: mijacobs
layout: LandingPage
description: 通用 Windows 平台 (UWP) 可讓您建置適用於任何 Windows 裝置 (電腦、手機、Xbox One、HoloLens 等等) 的應用程式，並將它們發佈到 Store。
...
ms.locfileid: "66468339"
---
# <a name="universal-windows-platform-documentation"></a>通用 Windows 平台文件

通用 Windows 平台 (UWP) 可讓您建置適用於任何 Windows 10 裝置 (電腦、Xbox One、HoloLens 等等) 的應用程式，並將它們發佈到 Microsoft Store。
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>新功能</h3>
                        <p></p>了解最新版本 Windows 10 中的新 UWP API 和功能。</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                    <h3>設計</h3>
                    <p>了解如何透過使用 Fluent Design 系統，為應用程式設計使用者介面及進行編碼。</p>
                  </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>開發應用程式</h3>
                        <p></p>瀏覽我們的操作說明文章和程式碼，以了解建立 Windows 10 適用 UWP 應用程式。</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>開發遊戲</h3>
                        <p></p>了解如何建置 Xbox 和 Windows 10 適用的 UWP 遊戲</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                    <h3>發佈</h3>
                    <p>使用「合作夥伴中心」將您的應用程式與遊戲發佈到 Microsoft Store。</p>
                  </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>相關文件</h3>
                        <p><a href="/windows/msix">MSIX 封裝和部署</a></p>
