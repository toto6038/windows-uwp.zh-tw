...
| 功能 | 說明 |
|------------|-------------|
| **internetClient** | 提供公共場所 (例如機場和咖啡廳) 的網際網路與網路的對外存取。 大部分需要網際網路存取的 app 都應使用此功能。 |
