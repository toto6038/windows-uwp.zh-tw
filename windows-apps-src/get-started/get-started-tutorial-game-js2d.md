...
**注意：** Visual Studio 2019 不支援 Javascript UWP 應用程式開發。 您必須使用 Visual Studio 2017 來開發 Javascript UWP 應用程式。
...
如果您立即執行應用程式，您會看到雲朵已經開始飄移。 最後，我們有動作！
...
如果您再次執行應用程式時，您現在應該可以調整視窗大小，以取得較好的結果。
