...
ms.locfileid: "5975699"
---
# <a name="create-a-uwp-game-in-javascript"></a>使用 JavaScript 建立 UWP 遊戲

## <a name="a-simple-2d-uwp-game-for-the-microsoft-store-written-in-javascript-and-createjs"></a>以 JavaScript 和 CreateJS 撰寫的適用於 Microsoft Store 的簡單 2D UWP 遊戲
