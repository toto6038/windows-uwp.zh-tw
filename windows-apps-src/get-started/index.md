        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <ul>
                        <li><a href="//developer.microsoft.com/windows/downloads">下載工具與 SDK</a></li>
                        <li><a href="//docs.microsoft.com/windows/uwp/get-started/get-set-up">需要協助嗎？</a></li>
                    </ul>
                  </div>
                </div>
            </div>
            ...
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        ...
                        <ul>
                            <li><a href="//docs.microsoft.com/windows/uwp/get-started/create-uwp-apps">建立 Windows 應用程式</a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="cardPadding">
            <div class="card">
                ...
                <div class="cardText">
                    ...
                    <p><a href="//docs.microsoft.com/windows/uwp/design/controls-and-patterns/xaml-basics-style">自訂樣式</a></p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>開發人員工具</h3>
                        <p><a href="//docs.microsoft.com/windows/uwpcommunitytoolkit/">UWP 社群工具組</a></p>
                        <p><a href="//developer.microsoft.com/windows/downloads/virtual-machines">虛擬機器</a></p>
                        <p><a href="//docs.microsoft.com/windows/wsl/about">Windows 上 Ubunutu 的 Bash</a></p>
                        </div>
                    </div>
                </div>
            </div>
