...
> **注意**：UWP 範例需有 Visual Studio 2015 和 Windows SDK 才能開啟、建置以及執行。 如果您沒有安裝 Visual Studio，可以從[這裡](http://go.microsoft.com/fwlink/p/?LinkID=280676 "Windows 開發工具下載")取得支援建置 UWP 應用程式的免費 Visual Studio 2015 社群版本。  
>
