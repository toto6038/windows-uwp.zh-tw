...
如此看來，您應該想要撰寫應用程式並發佈到 Windows 市集︰該從何著手？ 如果您對 UWP 平台完全不了解，請嘗試觀看一些 <a href="https://channel9.msdn.com/">Channel 9</a> 影片，並參加 <a href="https://mva.microsoft.com">Microsoft Virtual Academy</a> 及 [LinkedIn Learning](https://www.linkedin.com/topic/windows-programming) 課程。 如果您已經熟悉 Windows 開發，則可以開始瀏覽下列主題，或直接 [下載一些範例](https://msdn.microsoft.com/windows/uwp/get-started/get-uwp-app-samples)。

有許多工具和架構可用來協助您撰寫應用程式，而且有許多支援跨平台開發。 例如，如果您想要撰寫 2D 遊戲，可能會想要看看 <a href="http://www.monogame.net">Monogame</a>或許 [JavaScript/HTML 架構](https://html5gameengine.com/) 的一部分。 如果是 3D 遊戲，則有 <a href="http://www.unity3d.com">Unity</a>，如果您所專注的是行動裝置，請記得還有 <a href="http://www.xamarin.com">Xamarin</a>。

如果您想要開始撰寫遊戲以外的程式，建議您仔細閱讀 UWP 主題來了解平台，然後研究如何透過使用和自訂 XAML 控制項來建立使用者介面。 您將使用 XAML 來設計應用程式 ([此處提供的教學課程](../layout/grid-tutorial.md)將帶領您逐步執行)，但是 XAML 的主要強大之處就在於使用*「資料繫結」*，這會將控制項與您應用程式想要顯示的資訊結合︰如果您是 Windows 平台新手，這會是一個需要了解的重要概念。 
...
<tr>
 <td width=60><img src="images/icon2.png" alt="Bullet point" width=64></td>
    ...
    <li><a href="https://msdn.microsoft.com/library/windows/apps/bg124285.aspx">API 參考資料</a></li>
     ...
     <li><a href="https://msdn.microsoft.com/windows/uwp/porting/index">將應用程式移植到 Windows10</a></li>
...
[docs.microsoft.com](http://docs.microsoft.com) 網站包含許多不同工具、架構及平台的大量文件。 當您瀏覽主題和範例時，最好要確定您閱讀的是 UWP 特定的內容。 您一開始可在 [Windows 開發人員中心](https://developer.microsoft.com/windows/apps)尋找 UWP 參考資料，然後再到[開發 UWP app](https://docs.microsoft.com/uwp/api/) 尋找所需的 API 參考資料。
閱讀適用於 UWP 的特定內容時，URL 路徑將會包含 **uwp**，而顯示在頁面最上方的路徑也是如此，就像這樣：

![尋找 UWP 文件](images/UWP-docs.png)

使用搜尋引擎時，附加「Windows 應用程式開發」至搜尋字串多半會將您引導至 UWP 內容。
...
<td align="left"><a href="https://www.xamarin.com">使用 C# 來撰寫適用於 iOS、Android 及 Windows10 的應用程式。</a></td>
</tr>
<tr class="even" style="background-color: #f2f2f2">
