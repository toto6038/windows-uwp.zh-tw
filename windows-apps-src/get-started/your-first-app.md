...
title: 建立您的第一個 App
description: 建立使用您慣用的程式設計語言的 Windows 10 的通用 Windows 平台 (UWP) 應用程式。
ms.date: 01/25/2017
ms.topic: article
...
* [建立"Hello，world"使用以 XAML 的應用程式C#](create-a-hello-world-app-xaml-universal.md)

如果您想要了解基本概念，或只是恢復您的學習記憶，請嘗試下列資料︰

* [C#適用於徹底初學者的基本概念](https://go.microsoft.com/fwlink/?linkid=850801)
...
* [XAML 和 UWP 中的資料繫結](xaml-basics-intro.md)
* [為 Microsoft Store，以撰寫遊戲的簡單 2D UWPC#和 MonoGame](get-started-tutorial-game-mg2d.md)


## <a name="visualc-component-extensions-ccx-and-xaml"></a>Visual c + + 元件擴充功能 (C + + /CX) 和 XAML

善用您 c + + 程式設計的專業知識來建置使用 Visual c + + 元件擴充功能的應用程式 (C + + /CX) 與 XAML。

* [建立"Hello，world"應用程式使用 XAML 與 C + + /CX](create-a-basic-windows-10-app-in-cpp.md)

在這裡深入了解 C++：

* [C + +:一般用途的語言和程式庫快速入門](https://www.microsoftvirtualacademy.com/training-courses/c-a-general-purpose-language-and-library-jump-start)
...
* [建立"Hello，world"應用程式使用 HTML 和 JavaScript](create-a-hello-world-app-js-uwp.md)
...
* [使用 Microsoft Edge WebVR](https://docs.microsoft.com/en-us/microsoft-edge/webvr/)
...
* [轉換您的 UWP 應用程式的 web 應用程式](../porting/hwa-create-windows.md)
...
* [HTML5 與 CSS3 適用於徹底初學者的基本概念](https://www.microsoftvirtualacademy.com/training-courses/html5-css3-fundamentals-development-for-absolute-beginners)
* [Microsoft Virtual Academy](https://go.microsoft.com/fwlink/p/?LinkID=389916)
