...
description: 本教學課程將教導您如何使用 JavaScript 和 HTML 來建立簡單 &\#0034;Hello，world &\#0034; 目標 Windows 10 通用 Windows 平台 (UWP) 應用程式。
ms.date: 03/06/2017
ms.topic: article
...
ms.locfileid: "57620423"
---
# <a name="create-a-hello-world-app-js"></a>建立 "Hello, world" 應用程式 (JS)

本教學課程將教導您如何使用 JavaScript 和 HTML 來建立簡單"Hello，world"為目標的 Windows 10 通用 Windows 平台 (UWP) 應用程式。 Microsoft Visual Studio 中的單一專案，您可以建置在任何 Windows 10 裝置執行的應用程式。
...
-   若要完成本教學課程中，您需要 Windows 10 和 Visual Studio 2017。 [開始設定](get-set-up.md)。
...
恭喜，您已建立適用於 Windows 10 和 UWP 的 JavaScript 應用程式 ！ 這是非常簡單的範例，但是，您現在可以開始加入您最愛的 JavaScript 程式庫和架構來建立您自己的應用程式。 因為它是 UWP app，您可以將其發佈至 Microsoft Store。 如需如何新增協力廠商架構的範例，請參閱這些專案：

* [為 Microsoft Store，以 JavaScript 和 CreateJS 撰寫遊戲的簡單 2D UWP](get-started-tutorial-game-js2d.md)
* [為 Microsoft Store，以 JavaScript 和 threeJS 撰寫遊戲的 3D UWP](get-started-tutorial-game-js3d.md)
