...
<span id="accessible_name"> </span> <span id="ACCESSIBLE_NAME"> </span>無障礙名稱
-----------------------------------------------------------------------------------
...
<span id="name_from_inner_text"> </span> <span id="NAME_FROM_INNER_TEXT"> </span>來自內部文字的名稱
--------------------------------------------------------------------------------------------------
...
**注意：**受到使用者介面自動化的強制執行，無障礙名稱長度不可以超過 2048 個字元。 如果自動判斷無障礙名稱所使用的字串超過字元上限，則會截斷無障礙名稱超出的部分。

 

<span id="images"> </span> <span id="IMAGES"> </span>影像的無障礙名稱
-----------------------------------------------------------------------------
...
<span id="labels"> </span> <span id="LABELS"> </span>標籤和 LabeledBy
----------------------------------------------------------------------
...
<span id="accessible_description"> </span> <span id="ACCESSIBLE_DESCRIPTION"> </span>無障礙描述 (選用)
-------------------------------------------------------------------------------------------------------------------
...
<span id="Testing_accessibility_early_and_often"> </span> <span id="testing_accessibility_early_and_often"> </span> <span id="TESTING_ACCESSIBILITY_EARLY_AND_OFTEN"> </span>及早並經常測試協助工具
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
<span id="Accessible_names_from_dynamic_data"> </span> <span id="accessible_names_from_dynamic_data"> </span> <span id="ACCESSIBLE_NAMES_FROM_DYNAMIC_DATA"> </span>動態資料的無障礙名稱
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
<span id="Accessible_names_and_localization"> </span> <span id="accessible_names_and_localization"> </span> <span id="ACCESSIBLE_NAMES_AND_LOCALIZATION"> </span>無障礙名稱和當地語系化
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
