...
description: 開發人員可以使用下列清單來識別 Windows 10 組建 17763 中的新增或變更命名空間
keywords: 新功能、 功能、 更新，最新的 Windows 10，api，17763，年 10 月
ms.date: 10/02/2018
ms.topic: article
...
ms.locfileid: "57596323"
---
# <a name="new-apis-in-windows-10-build-17763"></a>在 Windows 10 中新的 Api 建置 17763

新增和更新 API 命名空間已有可用在 Windows 10 組建 17763 的開發人員 (也稱為年 10 月 2018年更新或版本 1809年)。 以下是針對在這個版本中新增或修改之命名空間所提供的文件完整清單。

如需 Api 的資訊加入在先前的公用版本，請參閱[Windows 10 年 4 月更新中的新 Api](windows-10-build-17134-api-diff.md)。
...
#### <a name="clipboardhttpsdocsmicrosoftcomuwpapiwindowsapplicationmodeldatatransferclipboard"></a>[剪貼簿](https://docs.microsoft.com/uwp/api/windows.applicationmodel.datatransfer.clipboard)
...
#### <a name="packagehttpsdocsmicrosoftcomuwpapiwindowsapplicationmodelpackage"></a>[封裝](https://docs.microsoft.com/uwp/api/windows.applicationmodel.package)
...
#### <a name="launcherhttpsdocsmicrosoftcomuwpapiwindowssystemlauncher"></a>[啟動程式](https://docs.microsoft.com/uwp/api/windows.system.launcher)
...
#### <a name="compositorhttpsdocsmicrosoftcomuwpapiwindowsuicompositioncompositor"></a>[複合項](https://docs.microsoft.com/uwp/api/windows.ui.composition.compositor)
...
#### <a name="borderhttpsdocsmicrosoftcomuwpapiwindowsuixamlcontrolsborder"></a>[框線](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.border)
...
#### <a name="comboboxhttpsdocsmicrosoftcomuwpapiwindowsuixamlcontrolscombobox"></a>[下拉式方塊](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.combobox)
...
#### <a name="controlhttpsdocsmicrosoftcomuwpapiwindowsuixamlcontrolscontrol"></a>[控制](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.control)
...
#### <a name="datepickerhttpsdocsmicrosoftcomuwpapiwindowsuixamlcontrolsdatepicker"></a>[日期選擇器](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.datepicker)
...
#### <a name="framehttpsdocsmicrosoftcomuwpapiwindowsuixamlcontrolsframe"></a>[畫面格](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.frame)

Frame.IsNavigationStackEnabled <br> Frame.IsNavigationStackEnabledProperty <br> Frame.NavigateToType

#### <a name="gridhttpsdocsmicrosoftcomuwpapiwindowsuixamlcontrolsgrid"></a>[方格](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.grid)
...
#### <a name="menubarhttpsdocsmicrosoftcomuwpapiwindowsuixamlcontrolsmenubar"></a>[功能表列](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.menubar)

MenuBar <br> MenuBar.Items <br> MenuBar.ItemsProperty <br> 功能表列。 #ctor
...
#### <a name="scrollcontentpresenterhttpsdocsmicrosoftcomuwpapiwindowsuixamlcontrolsscrollcontentpresenter"></a>[展開 ScrollContentPresenter](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.scrollcontentpresenter)
...
#### <a name="textboxhttpsdocsmicrosoftcomuwpapiwindowsuixamlcontrolstextbox"></a>[文字方塊](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.textbox)
...
#### <a name="treeviewhttpsdocsmicrosoftcomuwpapiwindowsuixamlcontrolstreeview"></a>[樹狀檢視](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.treeview)
...
#### <a name="webviewhttpsdocsmicrosoftcomuwpapiwindowsuixamlcontrolswebview"></a>[Web 檢視](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.webview)
...
#### <a name="brushhttpsdocsmicrosoftcomuwpapiwindowsuixamlmediabrush"></a>[筆刷](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.brush)
