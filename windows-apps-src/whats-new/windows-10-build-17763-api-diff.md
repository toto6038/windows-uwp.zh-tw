...
#### [<a name="maptilebitmaprequestedeventargs"></a>Zoomlevel](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.maps.maptilebitmaprequestedeventargs)
...
#### [<a name="maptileurirequestedeventargs"></a>Uri](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.maps.maptileurirequestedeventargs)
...
#### [<a name="border"></a>框線](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.border)
...
#### [<a name="control"></a>控制項](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.control)
...
#### [<a name="frame"></a>框架](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.frame)
...
#### [<a name="menubar"></a>功能表列](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.menubar)

功能表列 <br> MenuBar.Items <br> MenuBar.ItemsProperty <br> 功能表列。 #ctor
...
### [<a name="windowsuixamlhosting"></a>Elementcompositionpreview](https://docs.microsoft.com/uwp/api/windows.ui.xaml.hosting)
