...
#### <a name="clipboard"></a>[剪貼簿](/uwp/api/windows.applicationmodel.datatransfer.clipboard)
...
#### <a name="control"></a>[控制](/uwp/api/windows.ui.xaml.controls.control)
