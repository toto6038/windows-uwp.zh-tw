...
#### <a name="package"></a>[套件](/uwp/api/windows.applicationmodel.package) \(英文\)
...
#### <a name="accelerometer"></a>[加速計](/uwp/api/windows.devices.sensors.accelerometer)
