---
author: QuinnRadich
title: "Windows 10 組建 16190 API 變更"
description: "開發人員可以使用以下清單識別 Windows 10 SDK 預覽版組建 16190 中新增或變更的命名空間"
keywords: "新功能, 更新, 正式發行前小眾測試, 正式發行前小眾測試版, API, 15021"
ms.author: quradic
ms.date: 5/11/2017
ms.topic: article
ms.prod: windows
...
---
# <a name="new-apis-in-the-windows-10-sdk-preview-build-16190"></a>Windows 10 SDK 預覽版 16190 中的新 API

Windows 10 SDK 預覽版組建 16190 中的全新及更新的 API 命名空間已可供 [Windows 測試人員](https://insider.windows.com/)使用。 此版本隨 [Microsoft Build 2017 開發人員會議](https://developer.microsoft.com/windows/projects/events/build/2017?ocid=wdgbld17_intreferral_devcenterhp_null_null_devcenter_hppost&utm_campaign=wdgbld17&utm_medium=internalreferral&utm_source=devcenterhp&utm_content=devcenter_hppost)一同發行。

以下是針對自上次公開發行 Windows 10 [版本 1703](windows-10-version-1703-api-diff.md) 後已新增或已修改命名空間所發佈之發行前版本文件的完整清單。 請注意，發行前版本文件可能內容不完整，隨時會變更。
