...
這是此版本中 Windows 開發人員會感興趣的新功能和改良功能以及指導方針的集合。 如需新增到 Windows SDK 之新命名空間的完整清單，請參閱 [Windows 10 組建 16299 API 變更](windows-10-build-16299-api-diff.md)。 如需 Windows 10 重點功能的詳細資訊，請參閱 [Windows 10 中有哪些酷功能](https://go.microsoft.com/fwlink/?LinkId=823181)。 此外，請參閱 [Windows 開發人員平台功能](https://developer.microsoft.com/windows/platform/features)以取得過去與未來加入 Windows 平台功能的高階概觀。
...
Fluent Design 效果 | 這些新效果屬於 Fluent Design 系統的一部分，採用深度、透視以及移動協助使用者專注於重要的 UI 項目。 </br>* [壓克力材料](../design/style/acrylic.md)是一種建立透明材質的筆刷。 </br>* [視差效果](../design/motion/parallax.md)可為您的應用程式增加立體深度及透視效果。 </br>* [顯示](../design/style/reveal.md)會反白顯示您的應用程式的重要項目。 </br> 如需詳細資訊，請參閱 [Fluent Design 概觀](https://fluent.microsoft.com/)。
...
朋友圈 | 朋友圈可讓使用者直接從應用程式釘選連絡人到他們的工作列。 [了解如何將我的人支援新增至您的應用程式。](../contacts-and-calendar/my-people-support.md) </br></br>* [我的人員共用](../contacts-and-calendar/my-people-sharing.md)可讓使用者共用檔案，透過您的應用程式，直接從工作列。 </br>* [我的使用者通知](../contacts-and-calendar/my-people-support.md)是一種新的使用者可以傳送給他們的已釘選連絡人的快顯通知。
...
功能 | 描述
 :------ | :------
帳戶管理 | 我們現在提供更大的彈性時[Azure AD 租用戶關聯至您的合作夥伴中心帳戶](../publish/associate-azure-ad-with-dev-center.md)新增多個帳戶的使用者。 您可以關聯多個 Azure AD 租用戶與單一的合作夥伴中心帳戶，或建立關聯的單一 Azure AD 租用戶與多個合作夥伴中心帳戶。
...
市集清單 | Store 清單已藉由新功能而獲得增強，用以吸引潛在使用者： </br>* 您應用程式的 Store 清單現在可以包含[預告片](../publish/app-screenshots-and-images.md#trailers)。 </br></br>* 您可以[匯入和匯出 Store 清單](../publish/import-and-export-store-listings.md)來加快更新，尤其是在您的清單有許多語言版本時。
