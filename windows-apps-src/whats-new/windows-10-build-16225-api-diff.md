---
author: QuinnRadich
title: "Windows 10 組建 16225 API 變更"
description: "開發人員可以使用以下清單識別 Windows 10 SDK 預覽版組建 16190 中新增或變更的命名空間"
keywords: "新功能, 更新, 正式發行前小眾測試, 正式發行前小眾測試版, API, 16225"
ms.author: quradic
ms.date: 7/6/2017
ms.topic: article
ms.prod: windows
...
---
# <a name="new-apis-in-the-windows-10-sdk-preview-build-16225"></a>Windows 10 SDK 預覽版 16225 中的新 API

Windows 10 SDK 預覽版組建 16225 中的全新及更新的 API 命名空間已可供 [Windows 測試人員](https://insider.windows.com/)使用。

下面是針對自上次公開發行 Windows 10 [版本 1703](windows-10-version-1703-api-diff.md) 以來所新增或已修改命名空間而發佈之發行前版本文件的完整清單。 **請注意，發行前版本文件可能內容不完整，隨時會變更，或許還會在後續組建中重新命名或移除這些 API。**
