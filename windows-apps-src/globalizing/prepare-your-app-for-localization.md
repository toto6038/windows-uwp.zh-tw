...
## <a name="add-contextual-comments"></a>加入內容相關的註解
...
## <a name="localize-sentences-instead-of-words"></a>當地語系化句子而不是字詞。
...
## <a name="ensure-the-correct-parameter-order"></a>確保正確的參數順序。
...
## <a name="do-not-use-the-same-strings-in-dissimilar-contexts"></a>不要在不同的內容中使用相同字串。
...
## <a name="identify-resources-with-unique-attributes"></a>利用唯一的屬性識別資源。
