...
ms.locfileid: "57613823"
---
# <a name="integrate-your-packaged-desktop-application-with-windows-10"></a>整合 Windows 10 的桌面應用程式封裝

您可以使用擴充功能，整合 Windows 10 中的桌面應用程式封裝，以預先定義的方式。
