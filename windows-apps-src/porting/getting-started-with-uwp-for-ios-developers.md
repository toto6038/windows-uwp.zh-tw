---
description: 請參閱逐步解說文章，以協助 iOS 開發人員開始在 Visual Studio 中建立和發佈 UWP 應用程式。
...
ms.locfileid: "89164322"
---
# <a name="getting-started-with-uwp-for-ios-developers"></a>開始使用適用於 iOS 開發人員的 UWP


如果您是 iOS 開發人員，且正在考慮為 Windows 10 開發程式，這些文件是很好的切入點。 當您開始撰寫應用程式時，他們會介紹您需要知道的一些概念，並說明如何在 Microsoft Store 上發佈工作。
...
為了開始進行這些逐步解說，您需要一部已安裝 Windows 10 與 Microsoft Visual Studio 的電腦。 您可以從 [針對 UWP 應用程式進行程式設計的開發人員下載下載這些應用程式](https://developer.microsoft.com/windows/downloads)。 沒有 Windows 電腦嗎？ 不用擔心，您可以使用您的 Mac：請參閱[在 Mac 上安裝 Windows 和開發工具](setting-up-your-mac-with-windows-10.md)。
...
| [使用者入門：通用控制項](getting-started-common-controls.md) | 以下是一些您會在 app 及其 iOS 對等項目中使用的常用控制項。 |
| [開始使用：瀏覽](getting-started-navigation.md) | 在 Windows 10 app 中管理這類瀏覽的其中一種方式是使用 [Frame](/uwp/api/Windows.UI.Xaml.Controls.Frame) 類別。 下列逐步解說會說明如何嘗試使用這種方式。 |
...
| [開始使用：接下來該怎麼辦？](getting-started-what-next.md) | 利用這個基本資訊，您現在可以開始撰寫更多好玩的通用 Windows 平台 (UWP) 應用程式。 在後續步驟中，請仔細閱讀下列主題，然後啟動 Visual Studio 並開始撰寫一些程式碼！ |
| [Windows app 概念對應](./android-ios-uwp-map.md) | 如何以 iOS 概念思考 Windows (與 Android) 功能 |
