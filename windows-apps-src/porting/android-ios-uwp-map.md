...
<td align="left"><a href="https://developer.microsoft.com/en-us/windows/apps/design"><strong>UWP Windows 應用程式設計</strong></a>示範如何建立在所有 Windows 10 裝置上看起來很棒的應用程式。 您可以找到使用者介面 (UI) 設計基礎知識、回應式設計技術，以及詳細指導方針的完整清單。<br/></td>
</tr>
<tr class="even">
...
<td align="left"><strong><a href="https://docs.microsoft.com/windows/uwp/controls-and-patterns/hub">中樞</a></strong>可讓您向使用者顯示內容的預覽，以供選取以流覽至子頁面。 <strong><a href="https://docs.microsoft.com/windows/uwp/controls-and-patterns/master-details">主要/詳細資料</a></strong>可讓使用者從對應的詳細資料區段旁顯示的專案摘要清單中挑選。<br/><br/><a href="https://docs.microsoft.com/windows/uwp/layout/navigation-basics">導覽</a><br/><br/><a href="https://docs.microsoft.com/windows/uwp/layout/navigate-between-two-pages">在兩個頁面之間流覽</a></td>
</tr>
<tr class="even">
<td align="left"><strong>上一頁按鈕導覽。</strong> <br><br>在應用程式內往回瀏覽。</td>
...
<td align="left">您可以使用<strong><a href="https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.frame.backstack">返回堆疊屬性</a></strong>輕鬆處理軟體或硬體返回按鈕的按壓動作，這可讓您的使用者周遊<strong>瀏覽歷程記錄</strong>。<br/><br/><a href="https://docs.microsoft.com/windows/uwp/layout/navigation-history-and-backwards-navigation">上一頁按鈕導覽</a></td>
</tr>
<tr class="odd" style="background-color: #f2f2f2">
...
<td align="left"><strong><a href="https://visualstudio.microsoft.com/features/universal-windows-platform-vs">Visual Studio</a></strong>和<strong><a href="https://docs.microsoft.com/visualstudio/designers/creating-a-ui-by-using-blend-for-visual-studio?view=vs-2015">Blend for Visual Studio</a></strong>擁有您撰寫程式碼、設計、連接、偵測、分析、優化和測試 UWP 應用程式所需的所有工具。 Visual Studio 也為您提供適用於 Windows 10 裝置的<strong><a href="https://docs.microsoft.com/windows/uwp/debug-test-perf/test-with-the-emulator">模擬器</a></strong>，以便您在各種模擬的裝置上測試 app。<br/><br/><a href="https://developer.microsoft.com/windows/downloads">適用于 UWP 的下載與工具</a></td>
</tr>
<tr class="even">
<td align="left">程式<strong>代碼組織。</strong> <br><br>App 的基本資料夾結構 (通常從初始範本建立)。</td>
...
<tr class="even">
<td align="left"><strong>針對回應式 UI 的視圖優化。</strong> <br><br>透過將檢視最佳化以改善效能。</td>
...
<tr class="even">
<td align="left">可取用<strong>的應用程式內購買。</strong> <br><br>可以購買、使用並再次購買的應用程式內產品。</td>
...
<tbody>
<tr class="odd" style="background-color: #f2f2f2">
<td align="left">調適型<strong>UI：彈性的版面配置。</strong> <br><br>使用彈性的高度和寬度支援不同的螢幕大小。</td>
...
<td align="left">使用<strong>版面配置屬性</strong>和<strong>面板</strong>搭配固定和動態調整大小的組合，可建立流暢版面配置。<br/><br/><a href="https://docs.microsoft.com/windows/uwp/layout/layouts-with-xaml">使用 XAML-版面配置屬性和麵板來定義版面配置</a><br/><br/><a href="https://docs.microsoft.com/windows/uwp/layout/screen-sizes-and-breakpoints-for-responsive-design">回應式設計101</a></td>
</tr>
<tr class="even">
<td align="left">調適型<strong>UI：量身打造的版面配置。</strong> <br><br>使用適用目標不同的個別版面配置來支援不同的螢幕大小。</td>
...
<td align="left">依每個裝置系列定義<strong>不同的 XAML 標記檔案</strong>，可建置量身訂做的版面配置。<br/><br/><a href="https://docs.microsoft.com/windows/uwp/layout/layouts-with-xaml">使用 XAML 量身打造的版面配置來定義版面配置</a></td>
</tr>
<tr class="odd" style="background-color: #f2f2f2">
<td align="left">調適型<strong>UI：回應式版面配置。</strong> <br><br>回應螢幕大小的變更 (例如旋轉螢幕) 或視窗大小的變更。</td>
...
<tbody>
<tr class="odd" style="background-color: #f2f2f2">
<td align="left"><strong>磚和徽章。</strong> <br><br>在主畫面上對使用者顯示更新。</td>
...
<tbody>
<tr class="odd" style="background-color: #f2f2f2">
<td align="left">正在<strong>捕獲媒體。</strong> <br><br>錄製音訊和視覺化內容。</td>
...
<td align="left"><strong>核心位置</strong> <strong>CLLocationManager</strong>類別是用來監視裝置的位置， <strong>startUpdatingLocation</strong>適用于標準位置服務，而<strong>startMonitoringSignificantLocationChanges</strong>用於<strong>重大變更</strong>位置服務。</td>
...
<tbody>
<tr class="odd" style="background-color: #f2f2f2">
<td align="left">叫用<strong>另一個應用程式。</strong> <br><br>啟動另一個 app，以及選擇性地分享資料 (例如，連結、文字、相片、影片及檔案)。</td>
