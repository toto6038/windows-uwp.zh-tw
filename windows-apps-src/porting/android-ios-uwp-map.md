...
<td align="left">您可以使用<strong><a href="https://msdn.microsoft.com/library/windows/apps/dn997788.aspx">索引標籤/樞紐</a></strong>，在內容上方顯示常設的連結/索引標籤清單。  <strong><a href="https://msdn.microsoft.com/library/windows/apps/dn997787.aspx">瀏覽窗格/分割檢視</a></strong>可讓您在內容旁顯示連結的清單。<br/><br/><a href="https://msdn.microsoft.com/windows/uwp/layout/navigation-basics">瀏覽</a><br/><br/><a href="https://msdn.microsoft.com/windows/uwp/layout/navigate-between-two-pages">兩個頁面之間巡覽</a></td>
</tr>
<tr class="odd" style="background-color: #f2f2f2">
...
<td align="left"><strong><a href="https://msdn.microsoft.com/library/windows/apps/dn449149.aspx">集線器</a></strong>可讓您向使用者顯示的內容可以導覽至子頁面中選取的預覽。 <strong><a href="https://msdn.microsoft.com/library/windows/apps/dn997765.aspx">主版/詳細資料</a></strong>讓使用者從項目摘要會顯示對應的詳細資料區段旁邊的清單中挑選。<br/><br/><a href="https://msdn.microsoft.com/windows/uwp/layout/navigation-basics">瀏覽</a><br/><br/><a href="https://msdn.microsoft.com/windows/uwp/layout/navigate-between-two-pages">兩個頁面之間巡覽</a></td>
</tr>
<tr class="even">
...
<td align="left">您可以使用<strong><a href="https://msdn.microsoft.com/library/windows/apps/windows.ui.xaml.controls.frame.backstack.aspx">返回堆疊屬性</a></strong>輕鬆處理軟體或硬體返回按鈕的按壓動作，這可讓您的使用者周遊<strong>瀏覽歷程記錄</strong>。<br/><br/><a href="https://msdn.microsoft.com/library/windows/apps/mt465734.aspx">上一頁按鈕瀏覽</a></td>
</tr>
<tr class="odd" style="background-color: #f2f2f2">
...
<td align="left">您可以使用<strong>影像</strong>和彩色背景來建立啟動顯示畫面。 <a href="https://msdn.microsoft.com/library/windows/apps/mt187309.aspx">啟動顯示畫面的時間可以延長</a>。<br/><br/><a href="https://msdn.microsoft.com/library/windows/apps/mt187306.aspx">加入啟動顯示畫面</a></td>
</tr>
</tbody>
</table>
...
<td align="left"><strong><a href="https://www.visualstudio.com/features/universal-windows-platform-vs.aspx">Visual Studio</a></strong> 並<strong><a href="https://msdn.microsoft.com/library/jj171012.aspx">Blend for Visual Studio</a></strong>具有您要撰寫程式碼、 設計、 連接、 偵錯、 分析、 最佳化和測試 UWP 應用程式的所有工具。 Visual Studio 也為您提供適用於 Windows 10 裝置的<strong><a href="https://msdn.microsoft.com/library/windows/apps/mt188754.aspx">模擬器</a></strong>，以便您在各種模擬的裝置上測試 app。<br/><br/><a href="https://dev.windows.com/downloads">下載與工具，適用於 UWP</a></td>
</tr>
<tr class="even">
...
<td align="left">您的 UWP app 包含 XAML 及名為 Example.xaml 和 Example.xaml.cs 的程式碼檔案、<strong>Assets 資料夾</strong>中的各種影像、開始頁面 (例如 <strong>MainPage.xaml</strong> 和 <strong>MainPage.xaml.cs</strong>) 以及資訊清單。<br/><br/><a href="https://msdn.microsoft.com/library/windows/apps/dn765018.aspx">建立 hello world 應用程式</a></td>
</tr>
</tbody>
</table>
...
<td align="left">使用<strong>版面配置屬性</strong>和<strong>面板</strong>搭配固定和動態調整大小的組合，可建立流暢版面配置。<br/><br/><a href="https://msdn.microsoft.com/library/windows/apps/mt228350.aspx#layout_overview">定義與 XAML-版面配置屬性 」 和 「 面板的版面配置</a><br/><br/><a href="https://msdn.microsoft.com/library/windows/apps/dn958435.aspx">回應式設計 101</a></td>
</tr>
<tr class="even">
...
<td align="left">依每個裝置系列定義<strong>不同的 XAML 標記檔案</strong>，可建置量身訂做的版面配置。<br/><br/><a href="https://msdn.microsoft.com/library/windows/apps/mt228350.aspx#tailored_layouts">定義版面配置，以 XAML-量身訂做的配置</a></td>
</tr>
<tr class="odd" style="background-color: #f2f2f2">
...
<td align="left">您的 app 有可以釘選到開始畫面的<strong>磚</strong>，您用它來顯示您所選的文字、影像，以及包含字符和數字的<strong>徽章</strong>。 您可以從 app 更新磚的內容 (透過推播通知或根據預先定義的排程)。 磚可以具有彈性，根據顯示的位置來變更。<br/><br/><a href="https://msdn.microsoft.com/library/windows/apps/xaml/mt185605.aspx">建立圖格</a><br/><br/><a href="https://msdn.microsoft.com/library/windows/apps/xaml/mt590880.aspx">建立自動調整圖格</a><br/><br/><a href="https://msdn.microsoft.com/library/windows/apps/xaml/mt187193.aspx">選擇通知的傳遞方法</a><br/><br/><a href="https://msdn.microsoft.com/library/windows/apps/xaml/hh465403.aspx">磚與徽章的指導方針</a></td>
</tr>
<tr class="even">
...
<td align="left">使用建立本機通知<strong>UILocalNotification</strong>，並可以排程<b>UILocalNotification.scheduleLocalNotification:<strong>。 |您可以使用快顯通知來排程</strong> <a href="https://msdn.microsoft.com/library/windows/apps/xaml/windows.ui.notifications.scheduledtoastnotification.aspx">ScheduledToastNotification</a><strong>。您可以從您的應用程式使用傳送磚通知</strong> <a href="https://msdn.microsoft.com/library/windows/apps/xaml/windows.ui.notifications.tilenotification.aspx">TileNotification 類別</a><strong>，或排程與磚通知<a href="https://msdn.microsoft.com/library/windows/apps/xaml/windows.ui.notifications.scheduledtilenotification.aspx">ScheduledTileNotification</a>。<br/><br/><a href="https://msdn.microsoft.com/library/windows/apps/xaml/mt631604.aspx">調適型和互動式快顯通知</a><br/><br/><a href="https://msdn.microsoft.com/library/windows/apps/xaml/mt593299.aspx">將本機磚通知傳送</a>| |</strong>傳送推播通知。</b> 從推播通知伺服器傳送，而且可選擇在 App 內處理的通知。</td>
