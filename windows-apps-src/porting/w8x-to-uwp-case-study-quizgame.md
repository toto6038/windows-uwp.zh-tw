...
# <a name="windows-runtime-8x-to-uwp-case-study-quizgame-peer-to-peer-sample-app"></a>Windows Runtime 8.x 至 UWP 的案例研究：QuizGame 對等應用程式範例
...
**注意** 在 Visual Studio 中開啟 QuizGame10 時，如果您看見「需要 Visual Studio 更新」的訊息，則請依照 [TargetPlatformVersion](w8x-to-uwp-troubleshooting.md) 中的步驟執行。
