---
author: normesta
Description: "在傳統型應用程式與 UWP app 之間共用程式碼"
...
![Windows 裝置](images/desktop-to-uwp/windows-devices.png)
...
若要開始使用 UWP，請參閱[通用 Windows 平台簡介](https://docs.microsoft.com/windows/uwp/get-started/universal-application-platform-guide)。
...
有任何問題嗎？ 請在 Stack Overflow 上發問。 我們的團隊會監視這些[標記](http://stackoverflow.com/questions/tagged/project-centennial+or+desktop-bridge)。
