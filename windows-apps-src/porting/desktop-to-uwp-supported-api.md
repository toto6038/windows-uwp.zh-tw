...
| XAML UI | Windows 10、windows 1809，和較早版本不支援裝載的 UWP XAML 內容封裝傳統型應用程式中。 從 Windows 10 版本 1903，您可以使用[XAML 群島](../xaml-platform/xaml-host-controls.md)主機 UWP XAML 內容。  |
...
下列是已封裝應用程式中所支援 UWP API 的完整清單。 您可以檢視[只有在已封裝應用程式中支援的 Api](#new)或是[已封裝應用程式和桌面應用程式中支援的 Api](#both)。
