...
ms.locfileid: "89155552"
---
# <a name="get-xbox-live-game-hub-data"></a>取得 Xbox Live 遊戲中心資料


在 Microsoft Store 分析 API 中使用此方法，取得您的 [支援 Xbox Live 遊戲](/gaming/xbox-live/index.md)的遊戲中心。 這項資訊也可在合作夥伴中心的 [Xbox 分析報表](../publish/xbox-analytics-report.md) 中取得。
...
| endDate | date | 要擷取遊戲中心資料之日期範圍的結束日期。 預設值是目前的日期。 |  否  |
...
| gameHubLikeCount     | number |   在指定日期加入遊戲中心頁面的喜歡數目。   |
| gameHubCommentCount          | number |  在指定日期加入您應用程式的遊戲中心頁面的註解數目。  |
| gameHubShareCount           | number | 在指定日期您應用程式的遊戲中心頁面被客戶分享的註解數目。   |
| gameHubFollowerCount          | number | 適用於您的應用程式的 Game 中心頁面全程追隨者數目。   |
