...
translationtype: HT
---
# <a name="monetization-engagement-and-store-services"></a>營利、參與和市集服務
...
| [在您的 App 中顯示廣告](display-ads-in-your-app.md)      |   藉由在您的應用程式中顯示橫幅廣告或插播式廣告來增加營收。 這個功能需要 Microsoft Store Services SDK。   |
