...
description: "Windows SDK、Microsoft Advertising SDK、Microsoft Store Services SDK 及 Windows 市集提供許多功能，可讓您透過應用程式賺更多的錢，並透過吸引您的使用者來獲得更多客戶。"
title: "營利、參與和市集服務"
ms.author: mcleans
ms.date: 07/05/2017
ms.topic: article
...
Windows SDK、Microsoft Advertising SDK、Microsoft Store Services SDK 及 Windows 市集提供功能，可讓您透過應用程式賺更多的錢，並透過吸引您的使用者來獲得更多客戶。 本節中的主題說明如何在您的應用程式中建置這些功能。
