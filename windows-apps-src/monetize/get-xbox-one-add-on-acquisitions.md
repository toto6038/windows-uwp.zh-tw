...
| 年齡            | 字串  | <p>下列其中一個字串，這些字串表示進行下載的使用者的年齡層：</p> <ul><li>「 小於 13 」</li><li>「 13 至 17 日 」</li><li>「 18 24"</li><li>「 25 34"</li><li>"35 44"</li><li>「 44 55 」</li><li>「 大於 55 」</li><li>「 未知 」</li></ul>                                                                                                 |
| acquisitionType     | 字串  | <p>其中一個下列字串，可指出收購類型：</p> <ul><li>「 免費 」</li><li>「 試用 」</li><li>「 已付費 」</li><li>「 促銷的程式碼 」</li><li>「 Iap"</li><li>「 訂用帳戶 Iap"</li><li>「 私用對象 」</li><li>"Pre Order"</li><li>「 Xbox Game Pass"（或者 「 遊戲傳遞 」 如果 2018 年 3 月 23 日之前查詢資料）</li><li>「 磁碟 」</li><li>「 預付的程式碼 」</li><li>「 計費前 Order"</li><li>「 取消前順序 」</li><li>「 失敗前順序 」</li></ul>                                                                                                    |
