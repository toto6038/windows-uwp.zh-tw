...
description: "在 Windows 市集購買 API 中使用此方法，變更使用者訂閱的帳單狀態。"
title: "變更使用者訂閱的帳單狀態"
ms.author: mcleans
ms.date: 04/11/2017
ms.topic: article
ms.prod: windows
ms.technology: uwp
keywords: "Windows 10, uwp, Windows 市集購買 API, 訂閱"
...
在 Windows 市集購買 API 中使用此方法，變更特定使用者訂閱附加元件的帳單狀態。 您可以取消、延長、退款或停用訂閱的自動續約。
...
* Windows 市集識別碼金鑰，表示使用者的身分識別，他有您想要變更之訂閱的權利。
...
| 欄位      | 類型   | 描述   | 必要 |
|----------------|--------|---------------|----------|
| b2bKey         | string | [Windows 市集識別碼金鑰](view-and-grant-products-from-a-service.md#step-4)，代表您要變更其訂閱的使用者身分識別。     | 是      |
...
以下範例示範如何使用此方法，將訂閱期間延長 5 天。 使用值 [Windows 市集識別碼金鑰](view-and-grant-products-from-a-service.md#step-4) (代表您要變更其訂閱的使用者身分識別) 取代 *b2bKey*。
...
| productId | string | [產品](in-app-purchases-and-trials.md#products-skus-and-availabilities)的[市集識別碼](in-app-purchases-and-trials.md#store-ids)，代表 Windows 市集型錄中訂閱附加元件。 例如，產品的市集識別碼是 9NBLGGH42CFD。     |
| skuId | string |  [SKU](in-app-purchases-and-trials.md#products-skus-and-availabilities) 的[市集識別碼](in-app-purchases-and-trials.md#store-ids)，代表 Windows 市集型錄中訂閱附加元件。 例如，SKU 的市集識別碼是 0010。    |
