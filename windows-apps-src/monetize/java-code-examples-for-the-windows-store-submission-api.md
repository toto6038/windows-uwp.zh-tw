...
# 適用於 Windows 市集提交 API 的 Java 程式碼範例
...
* [取得 Azure AD 存取權杖](java-code-examples-for-the-windows-store-submission-api.md#token)。
* [建立附加元件](java-code-examples-for-the-windows-store-submission-api.md#create-add-on)。
* [建立套件正式發行前小眾測試版](java-code-examples-for-the-windows-store-submission-api.md#create-package-flight)。
* [建立和認可 App 提交](java-code-examples-for-the-windows-store-submission-api.md#create-app-submission)。
* [建立和認可附加元件提交](java-code-examples-for-the-windows-store-submission-api.md#create-add-on-submission)。
* [建立和認可套件正式發行前小眾測試版提交](java-code-examples-for-the-windows-store-submission-api.md#create-flight-submission)。
