...
完成這個動作之後，您對 WindowsStoreProxy.xml 進行的編輯就會依照結構描述。 如需詳細資訊，請參閱[如何：選取要使用的 XML 結構描述](https://go.microsoft.com/fwlink/p/?LinkId=403014)。
