...
description: "在 Windows 市集分析 API 中使用此方法，以針對特定日期範圍與其他選擇性篩選器，取得彙總硬體錯誤報告資料。 這個方法僅供 OEM 使用。"
...
在 Windows 市集分析 API 中使用此方法，以針對特定日期範圍與其他選擇性篩選器，取得 OEM 硬體錯誤的彙總報告資料。 您可以使用[取得 OEM 硬體錯誤的詳細資料](get-details-for-an-oem-hardware-error.md)方法，擷取其他錯誤資訊。
