...
* [更新 App 提交](csharp-code-examples-for-the-windows-store-submission-api.md#update-app-submission)。
* [建立和認可附加元件提交](csharp-code-examples-for-the-windows-store-submission-api.md#create-and-commit-add-on-submission)。
* [更新附加元件提交](csharp-code-examples-for-the-windows-store-submission-api.md#update-add-on-submission)。
* [更新套件正式發行前小眾測試版提交](csharp-code-examples-for-the-windows-store-submission-api.md#update-flight-submission)。
...
下列範例實作的命令列程式會呼叫本文中的其他範例方法，示範使用 Windows 市集提交 API 的不同方式。
...
本節提供本文中 Windows 市集提交 API 範例所使用的協助程式類別。

<span id="clientconfiguration" />
### ClientConfiguration 協助程式類別

下列範例定義的 ```ClientConfiguration``` 類別用來將資料傳遞至使用 Windows 市集提交 API 的每個其他範例方法。
...
下列範例定義的 ```IngestionClient``` 類別提供與 Windows 市集提交 API 相關之某些重要工作的協助程式方法。
...
下列範例示範如何[更新 App 提交](manage-app-submissions.md)。 這個範例使用上面所描述的 [ClientConfiguration](csharp-code-examples-for-the-windows-store-submission-api.md#clientconfiguration) 和 [IngestionClient](csharp-code-examples-for-the-windows-store-submission-api.md#ingestionclient) 協助程式類別。
...
下列範例示範如何[建立和認可新的附加元件提交](manage-add-on-submissions.md) (附加元件也稱為應用程式內產品或 IAP)。 這個範例使用上面所描述的 [ClientConfiguration](csharp-code-examples-for-the-windows-store-submission-api.md#clientconfiguration) 和 [IngestionClient](csharp-code-examples-for-the-windows-store-submission-api.md#ingestionclient) 協助程式類別。
...
下列範例示範如何[附加元件提交](manage-add-on-submissions.md) (附加元件也稱為應用程式內產品或 IAP)。 這個範例使用上面所描述的 [ClientConfiguration](csharp-code-examples-for-the-windows-store-submission-api.md#clientconfiguration) 和 [IngestionClient](csharp-code-examples-for-the-windows-store-submission-api.md#ingestionclient) 協助程式類別。
...
下列範例示範如何[更新新套件正式發行前小眾測試版提交](manage-flight-submissions.md)。 這個範例使用上面所描述的 [ClientConfiguration](csharp-code-examples-for-the-windows-store-submission-api.md#clientconfiguration) 和 [IngestionClient](csharp-code-examples-for-the-windows-store-submission-api.md#ingestionclient) 協助程式類別。
