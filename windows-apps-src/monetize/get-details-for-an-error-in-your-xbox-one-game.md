...
| deviceModel           | 字串  | 其中一個下列字串，指定發生錯誤時，遊戲已執行的 Xbox One 主控台。<p/><ul><li><strong>Microsoft-Xbox One</strong></li><li><strong>Microsoft-Xbox One S</strong></li><li><strong>Microsoft-Xbox One X</strong></li></ul>  |
