...
# 在開發人員中心儀表板中建立專案與定義遠端變數

若要開始進行實驗，請在開發人員中心儀表板中定義適用於您 app 的實驗[專案](run-app-experiments-with-a-b-testing.md#terms)，並定義您的 app 可以存取的遠端變數。
...
>**注意**&nbsp;&nbsp;當專案中的實驗處於作用中時，您無法編輯、新增或移除遠端變數。 此限制可針對作用中的實驗協助保護控制群組資料的完整性。
