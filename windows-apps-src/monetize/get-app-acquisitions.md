...
| orderName           | 字串 | 訂單的名稱。  |
| storeClient         | 字串 | 下列其中一個字串，指定完成下載的 Microsoft Store 版本：<ul><li>**Windows Phone Store (client)**</li><li>**Microsoft Store (用戶端)** (或** Microsoft Store (用戶端)** 如果在 2018 年 3 月 23 之前查詢資料)</li><li>**Microsoft Store (網站)** (或** Microsoft Store (網站)** 如果在 2018 年 3 月 23 之前查詢資料)</li><li>**組織購買的量**</li><li>**其他**</li></ul>                                                                                            |
...
| gender              | 字串 | 下列其中一個字串，指定完成下載之使用者的性別：<ul><li><strong>m</strong></li><li><strong>f</strong></li><li><strong>Unknown</strong></li></ul>    |
...
| acquisitionType     | 字串 | 其中一個下列字串，可指出下載類型：<ul><li><strong>免費</strong></li><li><strong>試用</strong></li><li><strong>付費</strong></li><li><strong>促銷代碼</strong></li><li><strong>Iap</strong></li></ul>   |
