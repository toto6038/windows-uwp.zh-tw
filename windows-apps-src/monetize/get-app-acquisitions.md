...
<td align="left">字串</td>
<td align="left">您想要擷取下載數資料的 app 產品識別碼。 產品識別碼內嵌於 app 的刊登連結，該連結可於開發人員中心儀表板的 [App identity page](https://msdn.microsoft.com/library/windows/apps/mt148561) 上取得。 舉例來說，產品識別碼可以是 9WZDNCRFJ3Q8。</td>
<td align="left">是</td>
</tr>
<tr class="even">
...
| applicationId       | 字串 | 您正在擷取下載數資料的 app 產品識別碼。                                                                                                                                                                 |
