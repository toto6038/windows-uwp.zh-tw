...
| deviceType                | 字串  | 其中一個下列字串，指定使用狀況發生所在的裝置的類型：<ul><li>**PC**</li><li>**Phone**</li><li>**Console**</li><li>**平板電腦**</li><li>**IoT**</li><li>**伺服器**</li><li>**Holographic**</li><li>**不明**</li></ul>                                                                                                                           |
...
| averageDailyActiveUsers   | double  | 每天使用的應用程式的客戶平均數量。                             |
