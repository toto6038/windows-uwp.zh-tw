...
| deviceType                | 字串  | 下列字串的其中一個指定使用狀況的發生位置的裝置的類型：<ul><li>**PC**</li><li>**Phone**</li><li>**Console**</li><li>**平板電腦**</li><li>**IoT**</li><li>**Server**</li><li>**全像攝影版**</li><li>**未知**</li></ul>                                                                                                                           |
