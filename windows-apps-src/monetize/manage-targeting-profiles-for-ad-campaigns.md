...
如需有關目標設定檔和廣告行銷活動、播送行及廣告素材之間關聯性的詳細資訊，請參閱[使用 Windows 市集服務執行廣告行銷活動](run-ad-campaigns-using-windows-store-services.md#call-the-windows-store-promotions-api)。
