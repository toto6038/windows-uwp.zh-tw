...
ms.locfileid: "7280740"
---
# <a name="get-xbox-live-multiplayer-data"></a>取得 Xbox Live 多人遊戲資料


在 Microsoft Store 分析 API 中使用此方法，可以在每日或每月取得[已啟用 Xbox Live 遊戲](../xbox-live/index.md) 的多人遊戲資料。 這項資訊也會在合作夥伴中心中的[Xbox 分析報告](../publish/xbox-analytics-report.md)中提供的。
