...
在 Microsoft Store 分析 API 中使用此方法，可以在每日或每月取得[已啟用 Xbox Live 遊戲](../xbox-live/index.md) 的多人遊戲資料。 這項資訊也會提供[Xbox 分析報告](../publish/xbox-analytics-report.md)在合作夥伴中心。
...
| dailyActiveUsers     | 數字 |  在指定日期，該遊戲中使用中的多人遊戲使用者總數。  |
| dailyActiveDevices     | 數字 |  在指定日期，該遊戲中玩過多人遊戲工作階段的使用中裝置總數。  |
| dailyNewUsers     | 數字 |  在指定日期，該遊戲中新的多人遊戲使用者總數。  |
| monthlyActiveUsers     | 數字 |  指定日期發生月份的使用中的多人遊戲使用者總數。  |
| monthlyActiveDevices     | 數字 | 在指定日期發生的月份內，該遊戲中玩過多人遊戲工作階段的使用中裝置總數。   |
| monthlyNewUsers     | 數字 |  在指定日期發生的月份，該遊戲中新的多人遊戲使用者總數。  |
...
| monthlyActiveUsers     | 數字 | 在指定月份內，使用中的多人遊戲使用者總數。   |
| monthlyActiveDevices     | 數字 | 在指定月份內，該遊戲中玩過多人遊戲工作階段的使用中裝置總數。   |
| monthlyNewUsers     | 數字 |  在指定月份內，該遊戲中新的多人遊戲使用者總數。  |
| averageDailyActiveUsers     | 數字 |  在指定月份內，該遊戲中使用中的多人遊戲使用者的平均數量。  |
| averageDailyActiveDevices     | 數字 |  在指定月份內，該遊戲中玩過多人遊戲工作階段的使用中裝置平均數量。  |
