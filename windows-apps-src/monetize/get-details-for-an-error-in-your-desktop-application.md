...
| startDate | 日期 | 要擷取詳細錯誤資料之日期範圍的開始日期。 預設為目前日期的前 30 天。<p/><p/>**請注意：**&nbsp;&nbsp;此方法只能擷取一個在過去 30 天內發生之錯誤的詳細資料。 |  否  |
