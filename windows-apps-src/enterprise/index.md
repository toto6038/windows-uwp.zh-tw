...
請參閱[Windows UI 文件庫 （預覽版本）](https://docs.microsoft.com/en-us/uwp/toolkits/winui/)。
...
| [彈性 XAML UI 程式碼範例](http://go.microsoft.com/fwlink/p/?LinkId=619992) | 這個程式碼範例示範所有可能版面配置選項和您的應用程式，不論裝置類型的控制項，並可讓您能夠與顯示如何達成您正在尋找的任何版面配置面板互動。 除了顯示每個控制項如何回應不同的板型規格之外，app 本身也具有回應，並顯示達成彈性 UI 的各種方法。 |
...
| [將應用程式發佈到 Microsoft 網上商店](https://dev.windows.com/publish) | 整合的 Microsoft 網上商店可讓您發佈與管理所有您的應用程式，適用於所有 Windows 裝置。 透過每個市場價格、發佈和可見性控制項，以及其他選項來自訂您 app 的可用性。 |
