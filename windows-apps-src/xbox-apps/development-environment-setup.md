...
1. 安裝 Visual Studio 2017，Visual Studio 2015 Update 3 或 Visual Studio 的最新版本。 如需詳細資訊及如何安裝，請參閱[適用於 Windows 10 的下載項目與工具](https://dev.windows.com/downloads)。 我們建議您，讓您可以為開發人員和安全性接收最新的更新時，才使用最新版本的 Visual Studio。
...
- [下載與工具，適用於 Windows 10](https://dev.windows.com/downloads)  
