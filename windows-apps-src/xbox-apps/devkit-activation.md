...
> **重要**&nbsp;&nbsp;當您在 Xbox One 上啟用開發人員模式時，便代表選擇加入取得開發人員預覽版本的 Xbox 系統更新，其中包含實驗性和早期的發行前版本軟體。 這代表某些熱門的遊戲和 App 將不會如預期般運作，而您可能偶爾會遇到當機和資料遺失。 如果您離開開發人員預覽，您的主機將會恢復出廠預設值，您必須重新安裝所有遊戲、App 及內容。 
...
8.  輸入在「啟用開發人員模式」App 中顯示的啟用代碼。   
     ...
     > **注意**&nbsp;&nbsp;您的帳戶擁有有限的啟用次數。 啟用開發人員模式之後，開發人員中心將會指出與您帳戶相關連的啟用次數已使用一次。 
    
    ![啟用步驟 8](images/activation-step-8.png)    
    
9.  按一下 [**同意並啟用**]。 這會導致頁面重新整理，您將會看見您的裝置被填入表格當中。  
