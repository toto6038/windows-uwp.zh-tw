...
### <a name="do-turn-off-mouse-mode"></a>*執行動作：* 關閉 滑鼠模式

Xbox 使用者愛上它們控制站。 控制器輸入最佳化[停用滑鼠模式](how-to-disable-mouse-mode.md)並啟用方向式巡覽 (也稱為[XY 專注瀏覽和互動](../design/input/gamepad-and-remote-interactions.md#xy-focus-navigation-and-interaction))。 請留意的焦點設陷與無法存取 UI。

### <a name="do-draw-a-focus-rectangle-that-is-appropriate-for-a-10-foot-experience"></a>*執行動作：* 繪製焦點矩形所適合的 10 英呎體驗
...
### <a name="consider-use-tv-safe-colors"></a>*請考慮：* 使用安全電視的色彩

電視無法像電腦監視器一樣處理極端的色調。 請避免在您的 App 中使用高濃度色彩，這樣使用者才不會看到奇怪的條狀效果或褪色的影像。 此外請注意，由於電視之間的差異，在*您的*電視上看起來很棒的色彩，在使用者的電視上看起來可能會非常不同。 讀取[色彩](../design/devices/designing-for-tv.md#colors)若要了解如何讓任何人更美觀的應用程式 ！

### <a name="remember-you-can-disable-scaling"></a>*請記住：* 您可以停用 縮放比例
...
**Xbox 上的應用程式開發**事件是在 Xbox 上建置應用程式的新手開發人員的絕佳起點。
