...
| 文章 | 描述 |
| --- | --- |
| [次要磚指導方針](tiles-and-notifications-secondary-tiles-guidance.md) | 了解您使用次要磚的時機和位置。 |
| [釘選次要磚](tiles-and-notifications-secondary-tiles-pinning.md) | 了解如何釘選次要磚。 |
| [從傳統型應用程式釘選](tiles-and-notifications-secondary-tiles-desktop-pinning.md) | Windows 傳統型應用程式因為傳統型橋接器之故而可以釘選次要磚！ |
...
若要了解您使用次要磚的時機與位置，及其他的使用指導方針，請參閱[次要磚指導方針](tiles-and-notifications-secondary-tiles-guidance.md)


## <a name="pinning-secondary-tiles"></a>釘選次要磚
若要了解如何釘選次要磚，請參閱[釘選次要磚](tiles-and-notifications-secondary-tiles-pinning.md)。


## <a name="desktop-applications-and-secondary-tiles"></a>傳統型應用程式和次要磚
若要了解如何透過傳統型橋接器從您的傳統型應用程式使用次要磚，請參閱[從傳統型應用程式釘選次要磚](tiles-and-notifications-secondary-tiles-desktop-pinning.md)。