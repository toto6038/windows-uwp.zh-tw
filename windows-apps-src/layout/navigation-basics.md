...
## <a name="build-the-right-navigation-structure"></a>建立適當的瀏覽結構
...
<tr class="even">
<td style="vertical-align: top">頁面已組織成樹狀結構。 每個子頁面都只有一個父頁面，但父頁面可以有一或多個子頁面。 若要進入子頁面，您必須經過父頁面。 </td>
<td style="vertical-align: top"> 頁面以並列的方式存在。 您可以依任何順序從一個頁面瀏覽到另一個。 </td>
</tr>
</tbody>
</table>
...
<div class="side-by-side-content">
  <div class="side-by-side-content-left">我們建議使用階層關係的時機
<ul>
...
<p>當群組中的頁面數超過 7 個時，使用者可能會難以了解頁面的獨特性，或難以了解他們目前在群組中的位置。 如果您認為這對您的應用程式不構成問題，那請將頁面以對等方式排列。 否則，請考慮使用階層結構將頁面分成兩組，或分成多個較小的群組。 (中樞控制項可以協助您將群組頁面分類。)</p></li>
  ...
  <div class="side-by-side-content-right">我們建議使用對等關係的時機
<ul>
<li>頁面可以用任何順序瀏覽。</li>
...
## <a name="use-the-right-navigation-elements"></a>使用正確的瀏覽元素


瀏覽元素可以提供兩種服務：它們能協助使用者取得想要的內容，而且某些元素可以讓使用者知道他們在應用程式的哪個部分。 不過，它們也會佔用應用程式用於內容或命令元素的空間，因此，使用適合您應用程式結構的瀏覽元素非常重要。

### <a name="peer-to-peer-navigation-elements"></a>對等瀏覽元素

對等瀏覽元素讓您能夠在相同子樹系的同層級頁面之間瀏覽。
...
<tbody>
<tr class="odd">
<td style="vertical-align:top;">[索引標籤和樞紐](../controls-and-patterns/tabs-pivot.md)
<p><img src="images/nav/nav-tabs-sm-300.png" alt="Tab-based navigation" /></p></td>
<td style="vertical-align:top;">顯示相同層級中持續不變的頁面連結清單。
<p>使用索引標籤/樞紐的時機：</p>
<ul>
<li><p>有 2 到 5 個頁面。</p>
...
<tr class="even">
<td style="vertical-align:top;">[瀏覽窗格](../controls-and-patterns/nav-pane.md)
<p><img src="images/nav/nav-navpane-4page-thumb.png" alt="A navigation pane" /></p></td>
<td style="vertical-align:top;">顯示連結到最上層頁面的連結清單。
<p>使用瀏覽窗格的時機：</p>
<ul>
...
### <a name="hierarchical-navigation-elements"></a>階層瀏覽元素
...
<tbody>
<tr class="odd">
<td style="vertical-align:top;">[中樞](../controls-and-patterns/hub.md)
...
<tr class="even">
<td style="vertical-align:top;">[主要/詳細資料](../controls-and-patterns/master-details.md)
...
### <a name="historical-navigation-elements"></a>歷程瀏覽元素
...
### <a name="content-level-navigation-elements"></a>內容層級的瀏覽元素
...
<tbody>
<tr class="odd">
<td style="vertical-align:top;">超連結和按鈕</td>
<td style="vertical-align:top;">內嵌於內容的瀏覽元素會顯示在頁面的內容中。 不同於其他瀏覽元素在頁面群組或子樹系間皆須保持一致，內嵌於內容的瀏覽元素會隨頁面不同而改變。</td>
</tr>
</tbody>
</table>
...
### <a name="combining-navigation-elements"></a>結合瀏覽元素
