...
通用 Windows 平台 (UWP) 應用程式預設可以存取特定的檔案系統位置。 App 也可以透過檔案選擇器或宣告功能，以存取其他位置。
...
### <a name="application-data-locations"></a>應用程式資料的位置
...
## <a name="locations-that-uwp-apps-can-access"></a>UWP 應用程式可存取的位置
