...
目標為 Xbox One 的遊戲產品必須透過 [Xbox Live Creators](https://go.microsoft.com/fwlink/?linkid=844722) 或 [ID@Xbox](http://go.microsoft.com/fwlink/?LinkId=821742) 方案使用 Xbox Live 服務。
...
從 2018 年 4 月 17 日開始，如果新發佈的產品需要驗證才能存取主要功能，則必須使用安全的專用第三方驗證提供者，或採用公司帳戶類型進行發佈。 請注意，如果應用程式會要求財務帳戶資訊，則所有這些應用程式都必須使用公司帳戶，如原則 10.8.3 中所述。
