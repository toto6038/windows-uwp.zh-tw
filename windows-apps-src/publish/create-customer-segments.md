...
ms.locfileid: "57613203"
---
# <a name="create-customer-segments"></a>建立客戶區隔

有時候，您可能想要將一部分的客戶群做為特定對象來進行促銷和互動。 您可以完成這[合作夥伴中心](https://partner.microsoft.com/dashboard)藉由建立一種[客戶群組](create-customer-groups.md)稱為*區段*，其中包含符合人口統計的 Windows 10 客戶或您選擇的營收準則。
...
5.  在 **\[定義包含條件\]** 區段中，指定區隔的篩選條件。
    ...
    您可以選擇各式各樣的篩選準則，包括**併購**，**擷取來源**，**人口統計**，**分級**，**流失預測**，**儲存購買**，**儲存併購**，以及**花在存放區**。
