...
<tr><td align="left">    <b>廣告流量分配</b>                        </td><td align="left">  可檢視帳戶中所有產品的<a href="https://msdn.microsoft.com/library/windows/apps/xaml/mt149935.aspx">廣告流量分配設定</a>。    </td><td align="left">  可檢視和變更帳戶中所有產品的<a href="https://msdn.microsoft.com/library/windows/apps/xaml/mt149935.aspx">廣告流量分配設定</a>。        </td></tr>
...
<tr><td align="left">    <b>客戶群組</b>                     </td><td align="left">  可檢視 <b>\[客戶\]</b> 區段中的<a href="create-customer-groups.md">客戶群組</a> (區隔和正式發行前小眾測試版群組)。      </td><td align="left">  可建立、編輯和檢視 <b>\[客戶\]</b> 區段中的<a href="create-customer-groups.md">客戶群組</a> (區隔和正式發行前小眾測試版群組)。       </td></tr>
...
<table>
    ...
    <tbody>
    <tr><td align="left">    <b>下載數</b>     </td><td>    可檢視產品的<a href="acquisitions-report.md">下載數</a>和<a href="add-on-acquisitions-report.md">附加元件下載數</a>報告。        </td><td>    不適用    </td><td>    不適用 (父項產品的設定包含附加元件下載數報告)        </td><td>    不適用                         </td></tr>
    ...
    <tr><td align="left">    <b>Xbox 分析</b> </td><td>    可檢視產品的 Xbox 分析報告。 (注意︰這份報告尚未提供。)    </td><td>    N/A   </td><td>    不適用       </td><td>    不適用          </td></tr>
...
<table>
    ...
    <tr><td align="left">    <b>連絡客戶</b>  </td><td>    只要一併授與<b>客戶回函</b>權限，即可檢視<a href="respond-to-customer-feedback.md">對客戶回函的回應</a>和<a href="respond-to-customer-reviews.md">對客戶評論的回應</a>。 也可檢視已為產品建立的<a href="send-push-notifications-to-your-apps-customers.md">特定對象的通知</a>。    </td><td>    只要一併授與<b>客戶回函</b>權限，即可<a href="respond-to-customer-feedback.md">回應客戶回函</a>和<a href="respond-to-customer-reviews.md">回應客戶評論</a>。 也可為產品<a href="send-push-notifications-to-your-apps-customers.md">建立和傳送特定對象的通知</a>。                   </td><td>    不適用         </td><td>    不適用                          </td></tr>
...
<table>
    ...
    <tr><td align="left">    <b>年齡分級</b>    </td><td>    可檢視產品提交的<a href="age-ratings.md">年齡分級</a>頁面。       </td><td>    可檢視和編輯產品提交的<a href="age-ratings.md">年齡分級</a>頁面。    </td><td>    <i> 可檢視附加元件提交的 \[年齡分級\] 頁面。          </td><td>    </i> 可檢視和編輯附加元件提交的 \[年齡分級\] 頁面。       </td></tr>
    <tr><td align="left">    <b>套件</b>        </td><td>    可檢視產品提交的<a href="upload-app-packages.md">套件</a>頁面。  </td><td>    可檢視和編輯產品提交的<a href="upload-app-packages.md">套件</a>頁面，包括上傳套件。     </td><td>    <i> 可檢視附加元件提交的裝置系列銷售對象和套件 (如果適用)。   </td><td>    </i> 可檢視和編輯附加元件提交的裝置系列銷售對象，包括上傳套件 (如果適用)。             </td></tr>
    ...
    <tr><td align="left">    <b>名稱保留值</b>   </td><td>    可檢視產品的<a href="manage-app-names.md">管理 app 名稱</a>頁面。</td><td>    可檢視和編輯產品的<a href="manage-app-names.md">管理 app 名稱</a>頁面，包括保留其他名稱及刪除保留名稱。 </td><td>   <i> 可檢視附加元件的保留名稱。    </td><td>   </i> 可檢視和編輯附加元件的保留名稱。          </td></tr>
    </tbody>
    </table>
