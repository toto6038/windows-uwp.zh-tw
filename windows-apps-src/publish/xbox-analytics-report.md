...
> [!IMPORTANT]
> 如果您要發佈適用於 Xbox 的遊戲或使用 Xbox Live 服務的遊戲，您就要查看這份報告。 若要這樣做，您必須前往[概念核准程序](../gaming/concept-approval.md)，其中包含[Microsoft 合作夥伴](../xbox-live/developer-program-overview.md#microsoft-partners)所發佈的遊戲和遊樂場透過送出到[ID@Xbox程式](../xbox-live/developer-program-overview.md#id)。 在此報告目前看不到 [遊樂場透過[Xbox Live 建立者程式](../xbox-live/get-started-with-creators/get-started-with-xbox-live-creators.md)發佈。
