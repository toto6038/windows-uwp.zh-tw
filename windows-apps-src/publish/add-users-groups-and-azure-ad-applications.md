...
ms.locfileid: "2789515"
---
# <a name="add-users-groups-and-azure-ad-applications-to-your-dev-center-account"></a>新增使用者、群組和 Azure AD 應用程式至開發人員中心帳戶

Windows 開發人員中心 （在 [**帳戶設定**) 下的 [**使用者**] 區段可讓您將使用者新增至您的開發人員中心帳戶使用 Azure Active Directory。 為每位使用者指派角色（或一組自訂權限），定義帳戶的存取權。 您也可以新增[使用者群組](#groups)和 [Azure AD 應用程式](#azure-ad-applications)，為其授與您開發人員中心帳戶的存取權。
...
1.  選取 （鄰近的右上角的儀表板） 的齒輪圖示，然後選取 [**帳戶設定]**。 在 [**設定**] 功能表中選取 [**使用者**]。
2.  從 **\[使用者\]** 頁面選取 **\[新增使用者\]**。 
...
-   **新增現有的使用者**： 選擇 [已經存在於您的組織目錄並授與它們存取您的開發人員中心帳戶使用上述方法的使用者。
-   **建立新的使用者**： 建立全新的使用者帳戶新增至同時您的組織目錄及開發人員中心帳戶
...
1.  （在 [**帳戶設定**) 下的 [**使用者**] 頁面中選取 [**新增使用者**]，然後選擇 [**建立新的使用者**。
...
1.  （在 [**帳戶設定**) 下的 [**使用者**] 頁面中選取 [**新增使用者**]，然後選擇 [**邀請電子郵件的使用者**。
...
1.  （在 [**帳戶設定**) 下的 [**使用者**] 頁面中選取您想要編輯的使用者帳戶的名稱。
2.  選取 [在頁面底部的 [**重設密碼**] 按鈕。
...
1.  1.  選取 （鄰近的右上角的儀表板） 的齒輪圖示，然後選取 [**帳戶設定]**。 在 [**設定**] 功能表中選取 [**使用者**]。
...
1.  （在 [**帳戶設定**) 下的 [**使用者**] 頁面中選取 [**新增 Azure AD 應用程式**]。
2.  在 [下一步] 頁面上，選取**新的 Azure AD 應用程式**。
...
1.  從 （在 [**帳戶設定**) 下的 [**使用者**] 頁面選取使用者、 群組或您想要編輯的 Azure AD 應用程式帳戶的名稱。
2.  進行所需的變更。 可以編輯的項目如下：
...
（在 [**帳戶設定**) 下的 [**使用者**] 頁面上選取 [**上次活動**底下顯示的使用者想要檢閱其瀏覽歷程記錄] 連結。 您將可以檢視使用者在最近 30 天中瀏覽之所有頁面的 URL。

<span id="remove" />

## <a name="remove-users-groups-and-azure-ad-applications"></a>移除使用者、群組及 Azure AD 應用程式

若要移除您的開發人員中心帳戶的使用者、 群組或 Azure AD 應用程式，請選取 [依其在 [**使用者**] 頁面的名稱會出現 [**移除**] 連結。 在確認您想要移除它之後，該使用者、群組，或 Azure AD 應用程式將無法再存取您的開發人員中心帳戶 (除非您稍後再次新增它)。
