...
> [!NOTE]
> 為符合支付資格，您的收益必須達到適用的[付款門檻](payment-thresholds-methods-and-timeframes.md)。 如果收益少於付款門檻，將會維持在 **\[保留\]** 類別中，直到達到門檻為止。 如需 App 收益付款門檻的相關詳細資料，請參閱 [App 開發人員合約](https://msdn.microsoft.com/library/windows/apps/hh694058)。 廣告收益的付款門檻是 50 美元 (或等值的當地貨幣)。 
>
