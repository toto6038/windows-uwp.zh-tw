...
如果您使用 Microsoft Advertising 來獲利，到 2016 年 4 月 1 日為止，您也可以在 \[支出摘要\] 中看到廣告收益的付款資訊。 我們將說明這些收益針對在多個 app 中已使用的廣告單位是盈餘 (或「取消對應」)，或是無法對應至特定 app 的 app。 如需更多有關廣告付款原則的詳細資訊，請參閱 [pubCenter 付款原則](http://go.microsoft.com/fwlink/p/?LinkID=624469)。
