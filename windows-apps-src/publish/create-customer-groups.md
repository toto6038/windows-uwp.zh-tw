...
ms.locfileid: "2796362"
---
# <a name="create-customer-groups"></a>建立客戶群組

您可以建立*客戶群組*包含您的應用程式客戶的子集。 這些群組可用於目標客戶升級、 測試及其他用途。

若要檢視及建立客戶群組，展開 [ [Windows 開發人員中心](https://partner.microsoft.com/dashboard)] 的左的導覽功能表中的 [ **Engage**然後選取 [**客戶群組**。
