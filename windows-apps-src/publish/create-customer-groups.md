...
您可以建立*客戶群組*，包括您的應用程式的客戶的子集。 促銷活動、 測試和其他用途時，可以使用這些群組的目標客戶。

若要檢視及建立客戶群組，依序展開**接洽**左側的導覽功能表中的[合作夥伴中心](https://partner.microsoft.com/dashboard)，然後選取**客戶群組**。

目前支援兩種類型的客戶群組︰

- **區段。** 這些是動態建立的 Windows 10 客戶群組，他們符合您選擇的人口統計或收入條件。 區隔通常用於[推播通知](send-push-notifications-to-your-apps-customers.md)或[針對性優惠](use-targeted-offers-to-maximize-engagement-and-conversions.md)。 如需詳細資訊，請參閱[建立客戶區隔](create-customer-segments.md)。
