...
title: Microsoft 存放區行銷應用程式的指導方針
...
ms.locfileid: "2819829"
---
# <a name="microsoft-store-marketing-guidelines-for-apps"></a>Microsoft 存放區行銷應用程式的指導方針

了解如何提升您的應用程式和 Microsoft 存放區中的內容。 這些指導方針涵蓋如何使用您可以取得的資源，以及使用印刷品、電視、社交媒體與數位廣告促銷您 app 的建議。

## <a name="store-badges"></a>市集徽章

我們已建立可協助您以 Microsoft 存放區中您的應用程式資訊清單光碟機更多的客戶的特殊促銷徽章。 這些徽章提供 44 種語言的版本。 請記住，當您使用這些圖片時，您必須遵守特定要求；可以在 PDF 檔案中找到這些要求、使用方式範例以及指導方針。

[![下載] 按鈕](images/downloadbutton.png)](http://go.microsoft.com/fwlink/p/?LinkId=529769)**Microsoft 存放區名牌指導方針 （PDF、 英文版）**
...
若要促銷您的 app，您可能會想要顯示該 app 在 Windows 裝置上執行時的外觀。 我們有各種不同的裝置機格圖片讓您選取，包括手機、平板電腦、膝上型電腦和個人電腦。 最佳作法及如何使用這些影像的技術規格可位於[Microsoft 存放區行銷指導方針](http://go.microsoft.com/fwlink/p/?LinkId=529769)。
...
*Microsoft 記號*表示*Microsoft 名牌*[名牌產生器](http://go.microsoft.com/fwlink/p/?LinkID=534236)] 頁面上所述。 若要使用這些徽章，您必須：

-   Microsoft 存放區中有您的應用程式或其他的內容或是[Microsoft 分支機構計畫](http://go.microsoft.com/fwlink/p/?LinkId=624463)的一部分。
...
-   如果您未並登錄 Windows 開發人員中心，Microsoft 會授與您全世界、 專屬、 而且無法轉讓、 免授權使用徽章察覺 Microsoft 存放區名牌準則中所述。 Microsoft 得變更這些指導方針，若有變更，Microsoft 將使用合理的方式將您導向到張貼這些規格的任何新 URL。 Microsoft 保留此處未明確授與的所有權利。

-   請遵循[Microsoft 存放區名牌準則](http://go.microsoft.com/fwlink/p/?LinkId=529769)中所述的標誌流量規格。
