...
ms.locfileid: "5766821"
---
# <a name="publish-windows-apps-and-games"></a>發佈 Windows 應用程式與遊戲  
 
您可以使用[Windows 開發人員中心儀表板](https://partner.microsoft.com/dashboard)將您的應用程式和遊戲發佈至 Microsoft Store。 <a href="//developer.microsoft.com/store/register">立即註冊！</a>
<br>
            ...
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        ...
                        <li><a href="//docs.microsoft.com/legal/windows/agreements/store-policies">Microsoft Store 原則</a></li>   
                    </ul>
                    </div>
                </div>
            </div>
