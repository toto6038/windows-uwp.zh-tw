...
ms.locfileid: "105099779"
---
# <a name="put-apps-and-add-ons-on-sale"></a>促銷應用程式和附加元件

您可以在限定時間內降價銷售您的 App 或附加元件，以便在 Microsoft Store 進行促銷。 您可以選擇以較低價格區間或百分比計算的折扣提供產品。 您可以選擇是否要為每個人提供銷售，或將其提供給擁有其中一項其他產品的客戶專用。
...
> [!IMPORTANT]
> 銷售定價只會對您 Windows 10 裝置 (包括 Xbox One) 的客戶顯示。 您只提供給其中一個其他產品的擁有者的銷售，只會向客戶顯示 Windows 10 1607 版或更新版本。
> 
...
1.  在進行中應用程式或附加元件提交的 [ **定價與可用性** ] 頁面上，移至 [ **銷售定價** ] 區段。
