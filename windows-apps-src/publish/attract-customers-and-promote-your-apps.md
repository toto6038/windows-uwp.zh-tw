...
ms.locfileid: "2830780"
---
# <a name="attract-customers-and-promote-your-apps"></a>吸引客戶以及促銷您的應用程式

一旦您的應用程式是在 Microsoft 存放區中，該是時候來取得該儘可能在相同數目的客戶前方。 我們提供了許多功能，協助您促銷您的產品和拓展您的客戶基底，包括廣告活動、促銷代碼、銷售定價，以及更多。
...
-   [Microsoft 存放區行銷應用程式的指導方針](app-marketing-guidelines.md)
