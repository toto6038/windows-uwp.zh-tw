...
1.  在[合作夥伴中心](https://partner.microsoft.com/dashboard)，移至 [**帳戶設定**藉由選取右上角的圖示。
...
1.  在[合作夥伴中心](https://partner.microsoft.com/dashboard)，按一下右上角的**帳戶設定**圖示。
