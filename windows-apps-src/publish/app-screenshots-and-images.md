---
author: jnHs
Description: "您的應用程式需要包括各種標誌、螢幕擷取畫面和影像。"
title: "應用程式螢幕擷取畫面與影像"
...
# <a name="app-screenshots-and-images"></a>應用程式螢幕擷取畫面與影像


您的應用程式需要包括各種標誌、螢幕擷取畫面和影像。 有些是必要的，有些則是選擇性的。 請注意，您的影像是展現應用程式的主要方式之一。 設計良好的影像對於讓客戶注意到您的 App 非常有幫助。
...
> **注意**：根據客戶的作業系統和其他因素而定，在市集中、在客戶的開始畫面上，以及在應用程式本身使用影像的方式可能有所差異。


## <a name="images-provided-during-the-submission-process"></a>在提交程序期間提供的影像
...
| 影像                                                       | 像素大小                           | 使用方式                                                                                                                                                                           | 何時包含                                                                                                                                            |
|-------------------------------------------------------------|--------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [桌面螢幕擷取畫面](#screenshots)                         | 1366 x 768 或更高                 | 在電腦裝置上檢視時顯示於 app 的市集清單中。                                                                                                          | 建議針對所有 app 使用，特別是如果您的 app 想要在電腦裝置上使用。 至少需要一張螢幕擷取畫面 (適用於任何裝置系列) 。 |
...
## <a name="promotional-artwork"></a>促銷用圖稿

Windows 市集編輯團隊會使用不同的影像，在市集中展示 app。 提交促銷用圖稿，讓 Windows 市集編輯團隊能夠考量在促銷配置中使用您的 app。

> **重要：**提供應用程式的促銷影像並不保證會展示您的應用程式，但若未提供，則代表不會將您的應用程式納入所有促銷商機中。 (如需詳細資訊，請參閱[讓您的 App 更容易宣傳](make-your-app-easier-to-promote.md))。
...
### <a name="for-windows-10-2400-x-1200"></a>針對 Windows 10：2400 x 1200
...
### <a name="for-windows-phone-81-and-earlier-1000-x-800-358-x-358"></a>針對 Windows Phone 8.1 和較舊版本：1000 x 800、358 x 358
...
> **提示：**此外，請務必提供 300 x 300 的 [應用程式磚圖示影像](#app-tile-icon)，以確定您的應用程式不會以空白圖示出現在市集中。

### <a name="for-windows-81-and-earlier-414-x-180"></a>針對 Windows 8.1 和較舊版本：414 x 180
