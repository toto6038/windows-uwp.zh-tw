...
此處提供一些您需要用來確認收到應用程式、附加元件及 Microsoft Advertising 營收之付款的重要資訊。

> **重要**  在您可以接收來自 Windows 市集中之應用程式銷售的金額之前，您必須[設定支付帳戶並填寫所需的納稅申報表](setting-up-your-payout-account-and-tax-forms.md)。
