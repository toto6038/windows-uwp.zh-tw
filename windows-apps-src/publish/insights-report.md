...
- **整體影響**： 值增加或減少整個客戶群的銷售量整個的百分比。 這可協助您了解如何廣泛的特定變更影響時可能會尤其是比較百分比資訊中所示**Top 參與者。**
...
- **動作**：
   - 選取**顯示 14 天趨勢**檢視圖表顯示如何為的衡量標準變更整個 14 天一直到深入了解日期。
   - 選取 [意見反應，並讓我們了解我們已提供的深入解析資訊看起來準確的 [**告訴我們這是否正確無誤**。 這個意見反應將會協助我們會持續改善我們在這裡提供的資料。 
