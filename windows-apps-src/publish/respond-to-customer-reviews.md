...
若要檢視您的應用程式評論並提供回應，請在[合作夥伴中心](https://partner.microsoft.com/dashboard)中尋找應用程式。 在左方的導覽功能表中，展開 [**分析]** ，然後按一下顯示的 [[評論] 報告](reviews-report.md)的**評論**。 選取**要檢閱回應**提供您的回應。
