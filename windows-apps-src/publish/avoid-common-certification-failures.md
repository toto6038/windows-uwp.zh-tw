...
> [!NOTE]
> 請務必檢閱[Microsoft 存放區原則](https://docs.microsoft.com/legal/windows/agreements/store-policies)以確保您的應用程式符合所有提列的需求。
...
-   您的應用程式需要時包含[隱私權原則](create-app-store-listings.md#privacy-policy)。例如，如果您的應用程式以任何方式存取任何類型的個人資訊或若法律要求時。 為了協助決定您的應用程式是否需要將具有隱私權原則，請檢閱[應用程式開發人員合約](https://docs.microsoft.com/legal/windows/agreements/app-developer-agreement)和[Microsoft 存放區原則](https://docs.microsoft.com/legal/windows/agreements/store-policies)。
