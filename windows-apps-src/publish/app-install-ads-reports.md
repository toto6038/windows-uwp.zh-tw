...
-   在您 app 頁面左邊的瀏覽功能表上，按一下 [分析]**** &gt; [應用程式安裝廣告]****。
-   在您 app 頁面左邊的瀏覽功能表上，按一下 [營利]**** &gt; [促銷您的應用程式]****，然後按一下行銷活動的 [報告]**** 連結。
...
透過開發人員中心的 [行銷您的應用程式]**** 執行安裝廣告活動，可為嘗試替應用程式打廣告的開發人員提供必要的曝光。 廣告曝光會向最可能對應用程式感興趣的使用者顯示廣告，使用者就可能會按一下廣告並從市集安裝應用程式。 到今天為止，我們很難區分使用者安裝應用程式時是因為廣告活動而安裝，或是從其他來源安裝。
...
因此，app 安裝追蹤記錄到的數字可能*低於*因為 [促銷您的 App]**** 活動所產生的安裝次數。 請注意，應用程式的總下載次數可在開發人員中心的 [營收]**** 報告中檢視。

## 帳戶帳單記錄

您可以在此處看到與您的帳戶關聯的所有交易。 針對每個交易，我們會顯示 [交易日期]****、適當的 [行銷活動名稱]****、收費用的 [付款方式]****，以及收費的 [總金額]****。
