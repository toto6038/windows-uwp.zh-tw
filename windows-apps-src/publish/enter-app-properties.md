...
請輸入您 app 網頁的 URL。 這個 URL 必須指向您自己網站的頁面，而不是市集中您 app 的網站清單。 這個欄位是選用項目，但建議使用。
...
您選取 [**遊戲**] 做為產品類別時，此區段才會出現。 您可在此指定遊戲支援的功能。 您在這一節中提供的資訊將會顯示在產品的存放區清單。
...
- **在 Windows 上的客戶 8.x 和更早版本或 Windows Phone 8.x 和更早版本：**
