---
title: Microsoft Store 原則版本 7.12
description: Microsoft Store 原則 7.12 版的封存版本
ms.date: 04/15/2021
ms.topic: article
keywords: Store 原則合約封存
...
ms.locfileid: "107521326"
---
# <a name="microsoft-store-policies-712"></a>Microsoft Store 原則 (7.12)

**文件版本：7.12**

**生效日期：2021 年 3 月 4 日 - 2021 年 5 月 14 日**

> [!WARNING]
> 此文件有較新的版本。 如需詳細資訊，請參閱 [Microsoft Store 原則](../store-policies.md)。

> [!NOTE]
>**2021 年 3 月 4 日原則更新通知**
>
>Microsoft Store 將會在本月更新其 Store 原則，預計生效日期為 2021 年 4 月底。  金鑰原則變更，包括：
>
>- 更新至原則 10.8.6：電腦遊戲訂閱產品將可使用 Microsoft 的應用程式內購買 API 或安全的第三方計費服務，在透過訂閱服務提供的遊戲中進行遊戲內購買。 此外，包含在這類訂閱服務中的遊戲可傳遞給 Store 以外的訂閱者。
>- 更新至原則 11.12，以釐清與使用者產生內容相關的原則需求。
>
>如有要求，Microsoft 將會根據此通知，針對受到更新影響的任何原則授與例外 (如果適用產品符合上述更新)。

>[!NOTE]
>**2020 年 12 月 16 日原則更新通知**
>
>針對以透過 Xbox Live 創作者計畫所開發主機為目標的遊戲產品，已不再適用與 XBL 服務整合的需求。 特定原則 (原則 10.13.1) 將會更新，以在下一次更新「商店原則」文件時反映這項變更，但從這項通知起生效，將不再針對「XBL 創作者計畫」強制執行此原則。
