...
公司帳戶的費用稍微高一些，主要是因為我們採取一些額外步驟來確保您已獲得授權代表您的公司設定帳戶。 每個 「[市集原則](https://docs.microsoft.com/legal/windows/agreements/store-policies#1014-account-type)，應用程式具備某些功能，例如存取金融帳戶資訊或需要存取主要功能 （而不使用安全專用的第三方驗證提供者）、 驗證只可以發行的公司帳戶。
