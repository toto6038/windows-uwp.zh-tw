...
ms.locfileid: "84945961"
---
# <a name="app-submissions"></a>App 提交


藉[由保留名稱來建立應用程式](create-your-app-by-reserving-a-name.md)之後，您就可以開始著手進行它的發佈。 第一個步驟是建立**提交**。
...
| **此版本的新功能**   | 選用                                 | [版本資訊](create-app-store-listings.md#whats-new-in-this-version)       |
...
| **補充欄位**  | 選用                                    | [補充欄位](create-app-store-listings.md#supplemental-fields) 
...
| **受限制的功能**     | 如果您的產品宣告任何[受限制的功能](../packaging/app-capability-declarations.md#restricted-capabilities)，則為必要    | [受限制的功能](manage-submission-options.md#publishing-hold-options)       
