...
ms.prod: windows
ms.technology: uwp
keywords: "windows 10, uwp, 商務用市集, 教育用市集, 組織, 大量授權"
...
> [!NOTE]
> 在某些市場中，針對相同的價格區間，商務用 Microsoft 網上商店或教育用 Microsoft 網上商店中顯示的應用程式價格可能會不同於 Windows 市集中顯示零售客戶價格。 組織購買的收益支付與消費者購買您 app 的運作方式相同。 如需詳細資訊，請參閱[獲得報酬](getting-paid-apps.md)和[應用程式開發人員合約](https://msdn.microsoft.com/library/windows/apps/hh694058)。 如需可提供商務用 Microsoft 網上商店和教育用 Microsoft 網上商店的市場清單，請參閱[商務用 Microsoft 網上商店和教育用 Microsoft 網上商店概觀](https://technet.microsoft.com/itpro/windows/manage/windows-store-for-business-overview#supported-markets)。
