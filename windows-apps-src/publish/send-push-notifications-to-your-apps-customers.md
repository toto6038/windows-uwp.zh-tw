...
考慮您的通知內容時，請牢記︰
- 通知中的內容必須符合Microsoft Store[內容原則](https://msdn.microsoft.com/library/windows/apps/dn764944.aspx#content_policies)。
...
4. 在下一個頁面上，使用下拉式功能表選擇您想要產生通知的**\[單一應用程式\]** 或**\[多個應用程式\]**。 選取一個或多個 App (這必須經過設定，才能使用 Microsoft Store Services SDK 接收通知)。
