...
ms.locfileid: "2822860"
---
# <a name="gradual-package-rollout"></a>漸進式套件推出

當您將更新發佈至提交時，您可以選擇逐漸導入的更新套件至您的應用程式客戶的百分比表示上 （包括 Xbox） 的 Windows 10。 這可讓您監視特定套件的意見反應和分析資料，以確保您在更廣泛地推出更新之前，就已經信心滿滿。 您隨時可以增加百分比 (或停止更新)，而不必建立新的提交。 
