---
description: 當您發佈提交的更新時，您可以選擇以漸進方式，將更新套件推出給 Windows 10 上一部分的 App 客戶。
title: 漸進式套件推出
ms.date: 10/31/2018
ms.topic: article
...
ms.locfileid: "93034761"
---
# <a name="gradual-package-rollout"></a>漸進式套件推出

當您將更新發佈至提交時，可以選擇在 Windows 10 (（包括 Xbox) ）上，以漸進的形式將更新的套件推出到應用程式的客戶百分比。 這可讓您監視特定套件的意見反應和分析資料，以確保您在更廣泛地推出更新之前，就已經信心滿滿。 您隨時可以增加百分比 (或停止更新)，而不必建立新的提交。 
