...
ms.locfileid: "57645123"
---
# <a name="gradual-package-rollout"></a>漸進式套件推出

當您發行更新以送出時，您可以選擇逐步推出更新的封裝至您的應用程式的客戶百分比 （包括 Xbox） 的 Windows 10 上。 這可讓您監視特定套件的意見反應和分析資料，以確保您在更廣泛地推出更新之前，就已經信心滿滿。 您隨時可以增加百分比 (或停止更新)，而不必建立新的提交。 
