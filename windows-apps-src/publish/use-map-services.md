---
author: jnHs
Description: "若要在適用於 Windows Phone 8.1 和較舊版本的 app 中使用地圖服務，您需要在 app 程式碼中包含地圖服務應用程式識別碼和權杖。 您可以在開發人員中心儀表板取得此權杖。"
title: "使用地圖服務"
...
若要在適用於 Windows Phone 8.1 和較舊版本的 app 中使用地圖服務，您需要在 app 程式碼中包含地圖服務 app 識別碼和權杖。 您可以流覽至應用程式 **\[服務\]** 區段中的 **\[地圖\]** 頁面，在開發人員中心儀表板取得這個權杖。
...
> **注意** 目前您不需要完成提交 app 的作業。 在您要求權杖和識別碼之後，這項資訊會儲存在此頁面。 您可以隨時返回此頁面以檢視這項資訊。
