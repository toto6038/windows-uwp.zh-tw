---
author: jnHs
Description: "一份出色的應用程式介紹可以讓您的 App 在 Windows 市集中更為突出，並協助鼓勵客戶下載。"
title: "撰寫一份出色的應用程式介紹"
...
一份出色的應用程式介紹可以讓您的 App 在 Windows 市集中更為突出，並協助鼓勵客戶下載。 [您提交 app 時輸入的描述](create-app-store-listings.md#description)會顯示在您的 app 市集清單。 前幾行文字可能也會顯示在搜尋結果和市集中列出的演算法清單中。
...
-   **讓消費者很容易便能了解您 App 的功能。** 吸引客戶注意之後，隨後說明額外的好處、在在應用程式內購買的商機以及客戶想要知道關於您 app 的其他詳細資訊。 請確定您已遵照 app 發行所在市場之法律規定，提供任何必要的揭露訊息或資訊。
-   **使用清單和精簡的段落。** 潛在客戶很可能只會快速瀏覽您的 app 描述。 使用簡短的段落和清單將內容分段，可以讓使用者更容易閱讀。
    > **注意** 加入 [app 功能](create-app-store-listings.md#app-features)清單也可以快速展示 app 的功能。 這個清單要顯示在 app 描述的正下方。
