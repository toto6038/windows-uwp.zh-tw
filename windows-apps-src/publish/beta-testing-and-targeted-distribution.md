...
**\[私人對象\]** 選項可用於以任何作業系統版本為目標的應用程式，但您的測試人員必須執行 Windows 10 (版本 1607) 或更高版本 (包括 Xbox One)，且必須以您提供之電子郵件地址相關聯的 Microsoft 帳戶登入。
...
此選項提供另一種方式，讓您限制將應用程式只散佈給特定群組的測試人員，而不先發佈廣泛提供使用的提交。 不過，與私人對象選項不同的是，如果某人有直接連結，他們可以看得到您應用程式的清單。 如果機密性對您的提交很重要，我們建議改為發佈至私人對象。
