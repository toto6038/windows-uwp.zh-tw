...
-   **在所有相關市場以所有相關語言列出您的應用程式**
    ...
    將您的 app 提交至所有相關[市場](./define-market-selection.md)，有助於推廣您的 app。 當然您會想確定您的 app 是恰當的，並且符合您所選市場的所有當地方針。 盡可能將應用程式內容和 Store 清單資訊當地語系化成越多[語言](supported-languages.md)也有幫助。
