...
如果您的應用程式內容包含套件目標為 Windows 8.x，請務必注意數個市場會被視為單一 「 世界其他地方 」 市場的客戶在 Windows 上使用 microsoft Store 8.x，即使它們會顯示為 Windows 開發人員中心中的個別市場儀表板 (而不是較舊版本的市集儀表板，其中有已將所有這些市場的其中一個 「 世界其他地方 」 市場選項)。
