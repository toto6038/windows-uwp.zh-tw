...
[合作夥伴中心](https://partner.microsoft.com/dashboard)支援三個選項提供意見反應應用程式的客戶回應。 不論您選擇哪一個選項，請記住每則回應有 1000 個字元的限制。
...
- **調查**:您所知的問題，就會到其中。
- **Pracuje**:您正在修正問題，或新增要求的功能。
- **完成**:您已發行的更新來修正問題，或新增要求的功能。
