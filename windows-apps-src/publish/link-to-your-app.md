...
> [!NOTE]
> 如需資訊和使用 Microsoft Store 徽章的相關的需求，請參閱[應用程式行銷指導方針](app-marketing-guidelines.md)。
...
如需有關使用 Microsoft Store 通訊協定的詳細資訊，請參閱[Microsoft 應用程式啟動](../launch-resume/launch-store-app.md)。
