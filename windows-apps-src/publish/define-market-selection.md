...
如果您先前發佈的應用程式包含以 Windows 8.x 為目標的套件，請務必注意，在 Windows 8.x 上使用存放區的客戶會將許多市場視為單一「Rest」市場，即使它們顯示為個別的市場也一樣。在合作夥伴中心。
...
> [!NOTE]
> ，以取得可註冊開發人員帳戶的國家和地區清單，請參閱[帳戶類型、位置和費用](account-types-locations-and-fees.md)。
