---
Description: 在合作夥伴中心，或透過其他方法，請針對您的 Windows 應用程式，取得詳細的分析。
title: 分析應用程式效能
ms.assetid: 3A3C6F10-0DB1-416D-B632-CD388EA66759
ms.date: 10/31/2018
ms.topic: article
keywords: windows 10、 uwp、 分析、 報告、 儀表板、 應用程式、 資料、 度量
...
ms.locfileid: "57625443"
---
# <a name="analyze-app-performance"></a>分析應用程式效能

您可以在您的應用程式中檢視詳細的分析[合作夥伴中心](https://partner.microsoft.com/dashboard)。 統計資料和圖表讓您能夠了解 App 的受歡迎程度範圍 — 可從您已接觸到多少位客戶，到他們使用您 App 的方式以及他們給該 App 的評價。 您也可以找到應用程式健康情況、廣告使用量等的計量。

您可以檢視分析報告在合作夥伴中心內的權限或[下載所需的報表](download-analytic-reports.md)來分析您的離線資料。 我們也提供數種方式，以便[存取您的分析資料，外部合作夥伴中心](#outside)。
...
-   [Xbox 分析報表](xbox-analytics-report.md)
-   [Insights 報告](insights-report.md)
...
除了在合作夥伴中心內檢視報表，您可以存取應用程式分析，以其他方式。
...
使用[適用於 Power BI 的 Windows 開發人員中心內容套件](https://powerbi.microsoft.com/documentation/powerbi-content-pack-windows-dev-center/)探索並監視 Power BI 中的合作夥伴中心分析資料。 Power BI 是一項雲端型業務分析服務，可提供您業務資料的單一檢視。
...
* [了解如何使用 Power BI 的 Windows 開發人員中心內容套件連接到您的分析資料](https://powerbi.microsoft.com/documentation/powerbi-content-pack-windows-dev-center/)

> [!NOTE]
> 若要連接到 Power BI 的 Windows 開發人員中心內容套件，我們建議您指定從 Azure AD 目錄與您的合作夥伴中心帳戶相關聯的認證。 如果您使用您的 Microsoft 帳戶認證，您在 Power BI 中的分析資料不會自動重新整理，且您將需要登入 Power BI，才能重新整理資料。 如果您的組織已經使用 Office 365 或其他 Microsoft 所提供的商務服務，您就已經具備 Azure AD。 否則，您可以[免費取得它](https://go.microsoft.com/fwlink/p/?LinkId=703757)。 如需有關設定關聯的詳細資訊，請參閱[產生關聯 Azure Active Directory 與您的合作夥伴中心帳戶](associate-azure-ad-with-dev-center.md)。
