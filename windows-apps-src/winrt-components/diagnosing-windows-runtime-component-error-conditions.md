...
| WME1092 | 方法 '\{0}' 有一個名稱為 '\{1}' 的參數，該參數與預設傳回值名稱相同。 請考慮使用不同的參數名稱，或使用 System.Runtime.InteropServices.WindowsRuntime.ReturnValueNameAttribute 明確指定傳回值的名稱。 |
