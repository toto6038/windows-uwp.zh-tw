...
| [使用 C++/WinRT 來使用 COM 元件](consume-com.md) | 本主題使用完整的 Direct2D 程式碼範例，示範如何使用 C + + /winrt 來使用 COM 類別和介面。 |
...
| [強式和弱式參考資料，在 C + + /winrt](weak-references.md) | Windows 執行階段是計算參考次數系統;請務必讓您了解的重要性和區別，這類系統在強式與弱式參考。 |
