...
當您想要將基礎原始指標傳遞至期待一個 **IUnknown** 指標的函式，請使用 [**IUnknown::get_unknown**](/uwp/cpp-ref-for-winrt/windows-foundation-iunknown#getunknown-function) 函式，下一個範例做為示範。
