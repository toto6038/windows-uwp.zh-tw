...
#### [遊戲台和遙控器](input-and-devices/gamepad-and-remote-interactions.md)
#### [手寫筆互動與 Windows Ink](input-and-devices/pen-and-stylus-interactions.md)
##### [辨識筆墨筆觸](input-and-devices/convert-ink-to-text.md)
##### [儲存和擷取筆墨筆觸](input-and-devices/save-and-load-ink.md)
...
#### [建立並註冊會在個別處理序中執行的背景工作](launch-resume/create-and-register-a-background-task.md)
#### [建立並註冊會在單一處理序中執行的背景工作](launch-resume/create-and-register-a-singleprocess-background-task.md)
#### [將多個處理序的背景工作轉換成單一處理序的背景工作](launch-resume/convert-multiple-process-background-task.md)
...
### [與遠端 App 服務通訊](launch-resume/communicate-with-a-remote-app-service.md)
### [轉換 App 服務，以便與其主機 App 在相同處理序中執行](launch-resume/convert-app-service-single-process.md)
...
#### [簽署已轉換的傳統型應用程式](porting/desktop-to-uwp-signing.md)
