...
#### [建立及註冊跨處理序的背景工作](launch-resume/create-and-register-an-outofproc-background-task.md)
...
### [記錄開發人員中心的自訂事件](monetize/log-custom-events-for-dev-center.md)
...
## [將 App 移植到 Windows10](porting/index.md)
...
### [App 如何在市集中顯示給 Windows10 客戶](publish/how-your-app-appears-in-the-store-for-windows-10-customers.md)
...
### [傳送目標式推播通知給您的 App 客戶](publish/send-push-notifications-to-your-apps-customers.md)
