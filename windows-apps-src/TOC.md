...
#### [建立並註冊背景工作](launch-resume/create-and-register-a-background-task.md)
...
### [Microsoft Advertising 付款處理程序](publish/microsoft-advertising-payment-process.md)
...
#### [歷程記錄](https://msdn.microsoft.com/en-us/library/windows/apps/dn764945.aspx)
### [App 品質](https://msdn.microsoft.com/en-us/library/windows/apps/mt652261.aspx)
