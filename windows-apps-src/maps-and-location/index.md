...
| [執行地理編碼和反向地理編碼](geocoding.md) | 藉由呼叫 [**Windows.Services.Maps**](https://msdn.microsoft.com/library/windows/apps/dn636979) 命名空間中 [**MapLocationFinder**](https://msdn.microsoft.com/library/windows/apps/dn627550) 類別的方法，即可將地址轉換成地理位置 (地理編碼)，以及將地理位置轉換成地址(反向地理編碼)。 |
