...
| 屬性                     | Type    | 描述                                                                                                           |
|------------------------------|---------|-----------------------------------------------------------------------------------------------------------------------|
| version                      | String  | 目標式樣式表版本。 用於適用性。 「1.0」為預設值「1.*」為其他次要功能更新。 |

<a id="settings" />

### <a name="settings-properties"></a>設定屬性

| 屬性                     | Type    | 1703 | 1709 | 1803 | 1809 | 1903 | 描述 |
|------------------------------|---------|------|------|------|------|------|-------------|
...
| shadedReliefDarkColor        | 色彩   |  ✔   |  ✔   |  ✔   |  ✔   |  ✔   | 暈渲地貌的暗面色彩。  Alpha 色板代表最大的 Alpha 值。 |
| shadedReliefLightColor       | 色彩   |  ✔   |  ✔   |  ✔   |  ✔   |  ✔   | 暈渲地貌的亮面色彩。  Alpha 色板代表最大的 Alpha 值。 |
...
| 圖形-背景             | 字串  |      |      |      |      |  ✔   | 做為圖示背景使用的圖形--取代該處存在的任何圖形。 |
| 圖形-圖示                   | 字串  |      |      |      |      |  ✔   | 做為圖示前景圖像的圖形--取代該處存在的任何圖形。 |
