...
在地圖上顯示您的裝置位置時，請考慮顯示圖形，並根據位置資料的正確性設定縮放比例。 如需詳細資訊，請參閱[定位感知 app 的指導方針](https://msdn.microsoft.com/library/windows/apps/hh465148)
...
請處理下列 [**MapControl**](https://msdn.microsoft.com/library/windows/apps/dn637004). [地圖指南](https://msdn.microsoft.com/library/windows/apps/dn596102) 的事件，以處理使用者或 app 變更地圖設定時所發生的變更 [CenterChanged](https://msdn.microsoft.com/library/windows/apps/dn596102)
...
-   [**相關主題**](https://msdn.microsoft.com/library/windows/apps/dn637069)

## Bing 地圖服務開發人員中心

* [UWP 地圖範例](https://www.bingmapsportal.com/)
* [取得目前的位置](http://go.microsoft.com/fwlink/p/?LinkId=619977)
* [定位感知 app 的設計指導方針](get-location.md)
* [地圖的設計指導方針](https://msdn.microsoft.com/library/windows/apps/hh465148)
* [Build 2015 影片：跨手機、平板電腦和電腦運用 Windows app 中的地圖與位置功能](https://msdn.microsoft.com/library/windows/apps/dn596102)
* [UWP 車流量 app 範例](https://channel9.msdn.com/Events/Build/2015/2-757)
