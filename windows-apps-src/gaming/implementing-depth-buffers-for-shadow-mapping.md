...
Windows 8 已將深度比較功能新增到功能層級 9\_1 與 9\_3。 現在，您可以將轉譯程式碼與陰影磁碟區移轉至 DirectX 11，而 Direct3D 11 轉譯器將降級以相容於功能層級 9 的裝置。 此逐步解說示範任何 Direct3D 11 應用程式或遊戲如何使用深度測試來實作傳統的陰影體。 程式碼包含下列程序：
...
完成此逐步解說後，您應該就會熟悉如何在與功能層級 9\_1 與更高版本相容的 Direct3D 11 中，實作基本的相容陰影磁碟區技術。
