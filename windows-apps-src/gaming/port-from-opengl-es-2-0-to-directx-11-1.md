...
> **附註**  移植您的 OpenGL ES 2.0 專案的中繼步驟是使用 Microsoft Store 的角度。 ANGLE 可讓您透過將 OpenGL ES API 呼叫轉譯為 DirectX 11 API 呼叫，在 Windows 上執行 OpenGL ES 內容。 如需關於 ANGLE 的詳細資訊，請移至[適用於 Microsoft Store 的 ANGLE Wiki](https://go.microsoft.com/fwlink/p/?linkid=618387)。
...
<tr class="odd">
<td align="left"><p><a href="opengl-es-2-0-to-directx-11-1-reference.md">為 Direct3D 11.1 參考的 OpenGL ES 2.0</a></p></td>
