...
<table>
    ...
    <tr>
        ...
        <td>
            <ul>
                <li><a href="https://customers.microsoft.com/story/tencent-telecommunications-azure-service-fabric-windows-server-en">Tencent 遊戲及 Microsoft 建置了雲端遊戲解決方案</a>
                <li><a href="https://channel9.msdn.com/Shows/Cloud+Cover/Episode-228-Building-Games-with-Service-Fabric#time=38m33s">使用 Service Fabric 建置遊戲：Tencent 的實作 （影片） 的相關詳細資料</a>
            </ul>
        </td>
    </tr>
    <tr>
        <td><a href="https://www.halowaypoint.com/">343 產業</a></td>
        <td><b>Halo 5:Guardians</b>實作<a href="https://www.halowaypoint.com/spartan-companies">Halo:Spartan 公司</a>作為其社交遊戲平台，使用 Azure Cosmos DB （透過 DocumentDB API)，其中已選取，其速度和彈性，因為其自動編製索引的功能。</td>
        <td>
            <ul>
        ...
        <td>
            <ul>
                <li><a href="https://azure.microsoft.com/blog/how-halo-5-guardians-implemented-social-gameplay-using-azure-documentdb/">使用 Azure Cosmos DB （透過 DocumentDB API) 來實作社交遊戲</a>
            </ul>
        </td>
    </tr>
    <tr>
        <td><a href="https://web.ageofascent.com/">Illyriad 遊戲</a></td>
        <td>Illyriad Games 建立了 <b>Age of Ascent</b>，一款大型多人線上 (MMO) 史詩 3D 太空遊戲，可在具有現代化瀏覽器的裝置上進行。 因此這款遊戲可在電腦、膝上型電腦、手機和其他行動裝置上進行，而不需要外掛程式。ASP.NET Core、 HTML5、 WebGL 和 Azure，則會使用遊戲。</td>
        <td>
            <ul>
        ...
        <td>
            <ul>
                <li><a href="https://channel9.msdn.com/Shows/Cloud+Cover/Episode-228-Building-Games-with-Service-Fabric#time=06m52s">使用 Service Fabric 建置遊戲：存留期的 Ascent MMO 遊戲 （影片）</a>
                <li><a href="https://channel9.msdn.com/Events/Build/2016/KEY02#time=57m20s">使用 Azure Service Fabric （影片） 的微服務為管理遊戲的元件</a> 
                <li><a href="/Blogs/Azure/Age-of-Ascent-from-Illyriad-Powered-by-Azure-Service-Fabric-and-ASPNET">Age of Ascent 開發人員 （影片） 與訪談</a>
            </ul>
        </td>
    </tr>
    <tr>
        <td><a href="https://www.nextgames.com/">Next Games</a></td>
        <td>Next Games 是建立者<b>The Walking Dead:無人之境 》</b>根據 AMC 原始數列的視訊遊戲。 The Walking Dead 遊戲使用 Azure 做為後端。 它有 1,000,000 下載在上市首週就和第一週內，#1 iPhone 與 iPad 免費應用程式在美國，變成遊戲應用程式市集，#1 在 12 個國家/地區的免費應用程式和 #1 13 個國家/地區中的免費遊戲。
        </td>
        <td>
            <ul>
        ...
        <td>
            <ul>
                <li><a href="https://azure.microsoft.com/blog/how-we-built-it-next-games-global-online-gaming-platform-on-azure/">如何建置它：在 Azure （「 視訊部落格） 上的下一步 遊戲全域的線上遊戲平台</a>
                <li><a href="https://azure.microsoft.com/blog/the-walking-dead-no-mans-land-game-soars-to-1-with-azure-documentdb/">陰屍路更快速的開發週期和更吸引人的遊戲使用 Azure Cosmos DB （透過 DocumentDB API)</a>
            </ul>
        </td>
    </tr>
    <tr>
...
* [Io-interactive 和 Azure:建立遊戲功能，例如難以捉摸的目標時，才可以使用雲端](https://channel9.msdn.com/Series/Hitman)
* [Azure 為部、 遊戲 Troopers 和 InnoSpark 神秘推手](https://news.microsoft.com/features/game-developers-use-microsoft-azure-as-secret-sauce-for-scale-and-growth-2/)
* [使用 Azure 的 Bizspark 計劃的遊戲新創公司](https://blogs.technet.microsoft.com/bizspark_featured_startups/2015/09/25/azure-open-for-gaming-startups/)
...
* [開發人員計劃](e2e.md#developer-programs)
...
* build 2016:[CodeLabs&mdash;使用 Microsoft Azure App Service 和 Microsoft SQL Azure 的後端，以儲存在 Unity 的遊戲的分數](https://github.com/Microsoft-Build-2016/CodeLabs-GameDev-6-Azure)
* 組建 2017年中：[利用 Microsoft Azure 的體驗提供世界級的遊戲：標題，例如 Halo、 Io-interactive，和 Walking Dead （影片）](https://channel9.msdn.com/Events/Build/2017/P4062)
* 可重複使用的建置組塊、 專案、 服務和設計來支援使用 Azure 在 GitHub 上的一般遊戲工作負載的最佳作法的集合：[在 Azure 上的遊戲的建置組塊](https://github.com/MicrosoftDX/nether)
* [在 Azure （影片） 上的遊戲製作服務](https://channel9.msdn.com/Series/Gaming-Services-on-Azure)
