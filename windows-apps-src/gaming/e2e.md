...
<table>
    ...
    <tr>
        ...
        <td><a href="https://developer.microsoft.com/windows/apps">Windows 10 應用程式使用方法指南</a></td>
    </tr>
    <tr>
        <td>UWP 遊戲使用方法指南</td>
    ...
    <tr>
        <td>DirectX 參考與概觀</td>
        <td><a href="/windows/desktop/directx">DirectX 圖形與遊戲</a></td>
    </tr>
    <tr>
        <td>用於遊戲的 Azure</td>
    ...
    <tr>
        ...
        <td><a href="/windows/uwp/xbox-apps/index">在 Xbox One 上建置 UWP App</a></td>
    </tr>
    <tr>
    ...
    <tr>
        <td>Xbox Live 文件</td>
        <td><a href="/gaming/xbox-live/">Xbox Live 開發人員指南</a></td>
    </tr>
    <tr>
...
[在合作夥伴中心中註冊開發人員帳戶](https://developer.microsoft.com/store/register) 是發佈 Windows 遊戲的第一步。 開發人員帳戶可讓您保留您遊戲的名稱，以及將適用於所有 Windows 裝置的免費或付費遊戲提交到 Microsoft Store。 您可以使用開發人員帳戶來管理您的遊戲與遊戲內產品、取得詳細的分析，以及啟用可為您的全球玩家創造絕佳體驗的服務。

Microsoft 也提供數個可協助您開發及發行 Windows 遊戲的開發人員計畫。 在註冊合作夥伴中心帳戶之前，建議您先查看是否有任何最適合您的帳戶。 如需詳細資訊，請移至[開發人員計畫](#developer-programs)

### <a name="developer-programs"></a>開發人員計畫

Microsoft 提供數個可協助您開發及發行 Windows 遊戲的開發人員計畫。 如果您想要為 Xbox One 開發遊戲，並將 Xbox Live 功能整合到遊戲中，請考慮加入開發人員計畫。 若要在 Microsoft Store 發佈遊戲，您也必須在 [合作夥伴中心](https://partner.microsoft.com/dashboard) 中建立開發人員帳戶。

#### <a name="xbox-live-creators-program"></a>Xbox Live 建立者的程式

Xbox Live 創作者計畫允許任何人將 Xbox Live 整合至其遊戲中，並發佈到 Xbox One 和 Windows 10。 簡化的認證處理程序，而且在標準 [Microsoft Store 原則](/legal/windows/agreements/store-policies) 以外不需要核准概念。

您可以只使用零售硬體在創作者計畫中部署、設計和發佈您的遊戲，不需要專用的開發套件。 若要開始使用，請在您的 Xbox 在One 上下載[啟用開發人員模式 App](../xbox-apps/devkit-activation.md)。

如果您想要存取更多 Xbox Live 功能、專屬的行銷和開發支援，以及主要 Xbox One 存放區中的有機會，請套用至該 [ID@Xbox](https://www.xbox.com/Developers/id) 方案。
...
ID@Xbox 計畫可協助合格的遊戲開發人員在 Windows 和 Xbox One 上自行發行遊戲。 如果您想要為 Xbox One 開發遊戲，或是在您的 Windows 10 遊戲中新增 Xbox Live 功能 (例如玩家分數、成就及排行榜)，請向 ID@Xbox 註冊。 成為 ID@Xbox 開發人員以取得所需的工具與支援，讓您可以充分發揮您的創意並獲得最大的成功。 建議您先套用至， ID@Xbox 然後再于合作夥伴中心中註冊開發人員帳戶。
...
<table>
    ...
    <tr>
        ...
        <td><a href="https://www.xbox.com/Developers/id">適用於 Xbox One 的獨立開發人員計畫</a></td>
    </tr>
    <tr>
        <td>ID@Xbox 消費者網站</td>
...
<table>
    ...
    <tr>
        ...
        <td><a href="/samples/browse/?term=games">Microsoft Store 遊戲範例</a></td>
    </tr>
    <tr>
...
開發人員論壇是一個很棒的地方，可詢問及回答遊戲開發問題，並與遊戲開發人員交流。 論壇也是極佳的資源，可供尋找開發人員過去已面對並解決之困難問題的現有解答。
...
<table>
    ...
    <tr>
        <td>發佈應用程式與遊戲開發人員論壇</td>
        <td><a href="https://social.msdn.microsoft.com/Forums/en/home?forum=windowsstore%2Cwpsubmit%2Caiaads%2Caiasdk%2Caiamgr">發佈和廣告應用程式</a></td>
    </tr>
    <tr>
        <td>UWP app 開發人員論壇</td>
        <td><a href="/answers/topics/uwp.html">開發通用 Windows 平台 App</a></td>
    </tr>
    <tr>
        <td>傳統型應用程式開發人員論壇</td>
        <td><a href="https://social.msdn.microsoft.com/Forums/en/home?forum=windowsgeneraldevelopmentissues">Windows 傳統型應用程式論壇</a></td>
    </tr>
    <tr>
        <td>DirectX Microsoft Store 遊戲 (已封存的論壇文章)</td>
        <td><a href="https://social.msdn.microsoft.com/Forums/en/home?forum=wingameswithdirectx">使用 DirectX 建置 Microsoft Store 遊戲 (已封存)</a></td>
    </tr>
    <tr>
        <td>Windows 10 受管理的合作夥伴開發人員論壇</td>
        <td><a href="https://forums.xboxlive.com/users/login.html">XBOX 開發人員論壇：Windows 10</a></td>
    </tr>
    <tr>
        <td>Xbox Live 論壇</td>
        <td><a href="https://social.msdn.microsoft.com/Forums/en/home?forum=xboxlivedev">Xbox Live 開發論壇</a></td>
    </tr>
    <tr>
        <td>PlayFab 論壇</td>
...
<table>
    ...
    <tr>
        ...
        <td><a href="https://blogs.windows.com/buildingapps/">建置適用於 Windows 的應用程式</a></td>
    </tr>
    <tr>
        <td>Windows 10 部落格 (部落格文章)</td>
        <td><a href="https://blogs.windows.com/blog/tag/windows-10/">Windows 10 文章</a></td>
    </tr>
    <tr>
    ...
    <tr>
        <td>PIX 小組部落格</td>
        <td><a href="https://devblogs.microsoft.com/pix/">在 Windows 與 Xbox 上調整與偵錯 DirectX 12 的效能</a></td>
    </tr>
    <tr>
        <td>通用 Windows 應用程式部署團隊部落格</td>
        <td><a href="/windows/msix/">建置及部署 UWP 應用程式團隊部落格</a></td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        <td>UWP 遊戲技術綜覽</td>
        <td><a href="game-development-platform-guide.md">適用於UWP app的遊戲技術</a></td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        ...
        <td><a href="https://channel9.msdn.com/Events/GDC/GDC-2015/Developing-Games-for-Windows-10">開發適用於 Windows 10 的遊戲</a></td>
    </tr>
    <tr>
        <td>Windows 10 遊戲體驗 (影片)</td>
        <td><a href="https://channel9.msdn.com/Events/GDC/GDC-2015/Gaming-Consumer-Experience-on-Windows-10">Windows 10 上的遊戲消費者體驗</a></td>
    </tr>
    <tr>
        <td>遊戲在整個 Microsoft 生態系統的發展 (影片)</td>
        <td><a href="https://channel9.msdn.com/Events/GDC/GDC-2015/The-Future-of-Gaming-Across-the-Microsoft-Ecosystem">遊戲在 Microsoft 生態圈的未來</a></td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        <td>設計無障礙遊戲</td>
        <td><a href="/windows/uwp/gaming/accessibility-for-games">遊戲的協助工具</a></td>
    </tr>
    <tr>
        <td>使用雲端建置遊戲</td>
        <td><a href="/windows/uwp/gaming/cloud-for-games">遊戲的雲端</a></td>
    </tr>
    <tr>
        <td>利用遊戲獲利</td>
        <td><a href="/windows/uwp/gaming/monetization-for-games">遊戲的獲利</a></td>
    </tr>
</table>

### <a name="choosing-your-graphics-technology-and-programming-language"></a>選擇您的圖形技術與程式設計語言

有數種程式設計語言與圖形技術可在 Windows 10 遊戲中使用。 您所採取的路徑取決於您所開發的遊戲類型、您的開發 studio 體驗和喜好設定，以及遊戲的特定功能需求。 您將會使用 C#、C++ 或 JavaScript？ DirectX、XAML 或 HTML5？
...
如果您想要使用 Direct3D 11 的熟悉圖形管線，您仍然可以從新增至 Direct3D 11.3 的新轉譯和優化功能中獲益。 而且，如果您是在 Win32 中具有根的已試用桌面 Windows API 開發人員，您仍然可以在 Windows 10 中使用該選項。
...
<table>
    ...
    <tr>
        ...
        <td><a href="/windows/desktop/direct3d12/direct3d-12-graphics">Direct3D 12 圖形</a></td>
    </tr>
    <tr>
...
XAML 是一種容易使用的宣告式 UI 語言，擁有便利的功能，例如動畫、腳本、資料繫結、可調整的向量式圖形、動態調整大小及場景圖形。 XAML 非常適用於遊戲 UI、功能表、精靈及 2D 圖形。 為了簡化 UI 版面配置，XAML 與設計及開發工具相容，例如 Expression Blend 與 Microsoft Visual Studio。 XAML 通常搭配 c # 使用，但如果這是您慣用的語言，或您的遊戲有高 CPU 需求，則 c + + 也是不錯的選擇。
...
<table>
    ...
    <tr>
        <td>XAML UI 與控制項</td>
        <td><a href="/windows/uwp/design/basics/">控制項、版面配置及文字</a></td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        ...
        <td><a href="https://developer.mozilla.org/docs/Web">HTML 與 DOM 參考</a></td>
    </tr>
    <tr>
        <td>HTML5 W3C 建議</td>
...
C++/CX 是一種高效能、低額外負荷的語言，可提供結合速度、相容性及平台存取的強大效能。 C++/CX 可讓您很容易地使用 Windows 10 中所有優越的遊戲功能，包括 DirectX 與 Xbox Live。 您也可以重複使用現有的 C++ 程式碼與程式庫。 C + +/CX 會建立快速、原生程式碼，而不會造成垃圾收集的負擔，因此您的遊戲可以有絕佳的效能和低耗電量，進而導致電池壽命變長。 請將 C++/CX 與 DirectX 或 XAML 搭配使用，或建立將兩者結合使用的遊戲。
...
<table>
    ...
    <tr>
        <td>C++/CX 參考與概觀</td>
        <td><a href="/cpp/cppcx/visual-c-language-reference-c-cx">Visual C++ 語言參考 (C++/CX)</a></td>
    </tr>
    <tr>
...
Windows JavaScript 應用程式可以透過簡單且直覺化的方式 (以物件導向之 JavaScript 類別的方法與屬性) 存取 Universal Windows Platform 的強大功能。 如果您是從 網頁程式開發環境、已經熟悉 JavaScript，或是想要使用 HTML5、CSS、WinJS 或 JavaScript 程式庫，則 JavaScript 是您遊戲的理想選擇。 如果您的目標是 DirectX 或 XAML，請改為選擇 c # 或 c + +/CX。
...
<table>
    ...
    <tr>
        ...
        <td><a href="/scripting/javascript/javascript-language-reference">JavaScript 參考</a></td>
    </tr>
</table>

#### <a name="use-windows-runtime-components-to-combine-languages"></a>使用 Windows 執行階段元件來結合語言

有了通用 Windows 平臺，您可以輕鬆地結合以不同語言撰寫的元件。 以 c + +、c # 或 Visual Basic 建立 Windows 執行階段元件，然後從 JavaScript、c #、c + + 或 Visual Basic 呼叫這些元件。 這是以您選擇的語言為遊戲的某些部分撰寫程式碼的絕佳方式。 元件也可讓您使用僅適用于特定語言的外部程式庫，並使用您已撰寫的舊版程式碼。
...
<table>
    ...
    <tr>
        ...
        <td><a href="/windows/uwp/winrt-components/creating-windows-runtime-components-in-cpp">Windows 執行階段元件與 C++/CX</a></td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        ...
        <td><a href="/windows/desktop/direct3d12/what-is-directx-12-">什麼是 Direct3D 12？</a></td>
    </tr>
    <tr>
        <td>Direct3D 11 概觀</td>
        <td><a href="/windows/desktop/direct3d11/atoc-dx-graphics-direct3d-11">Direct3D 11 圖形</a></td>
    </tr>
    <tr>
...
<table>
    ...
    <tr>
        <td>UWP 橋接</td>
        <td><a href="https://developer.microsoft.com/windows/bridges">將您的程式碼轉移到 Windows</a></td>
    </tr>
    <tr>
        <td>適用於 iOS 的 Windows 橋接器</td>
        <td><a href="https://developer.microsoft.com/windows/bridges/ios">將您的 iOS 應用程式轉移到 Windows</a></td>
    </tr>
    <tr>
...
<table>
    ...
    <tr>
        ...
        <td><a href="https://docs.unity3d.com/Manual/Windows.html">Unity 手冊 / Windows</a></td>
    </tr>
    <tr>
...
Havok 的工具和技術模組套件，可協助遊戲創作者觸及新的互動和深度層級。 Havok 能夠實現極逼真的物理效果、互動式模擬及令人驚豔的場景。 2015.1 版和更新版本正式在 x86、64 位元和 ARM 的 Visual Studio 2015 中支援 UWP。
...
<table>
    ...
    <tr>
        <td>Havok 工具套件</td>
        <td><a href="https://www.havok.com/products/">Havok 產品概觀</a></td>
    </tr>
    <tr>
        <td>Havok 支援論壇</td>
        <td><a href="https://www.havok.com/">Havok</a></td>
...
<table>
    ...
    <tr>
        <td>MonoGame 文件</td>
        <td><a href="https://www.monogame.net/documentation/">MonoGame 文件 (最新)</a></td>
    </tr>
    <tr>
...
<table>
    ...
    <tr>
        ...
        <td><a href="/windows/uwp/porting/w8x-to-uwp-root">從 Windows 執行階段8.x 移至 UWP</a></td>
    </tr>
    <tr>
        <td>將 Windows 8 應用程式移植到通用 Windows 平台 app (影片)</td>
        <td><a href="https://channel9.msdn.com/Series/A-Developers-Guide-to-Windows-10/21">將 8.1 應用程式移植到 Windows 10</a></td>
    </tr>
    <tr>
        <td>將 iOS app 移植到通用 Windows 平台 app</td>
        <td><a href="/windows/uwp/porting/ios-to-uwp-root">從 iOS 移到 UWP</a></td>
    </tr>
    <tr>
        <td>將 Silverlight 應用程式移植到通用 Windows 平台 app</td>
        <td><a href="/windows/uwp/porting/wpsl-to-uwp-root">從 Windows Phone Silverlight 移至 UWP</a></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><a href="/windows/desktop/direct3d12/porting-from-direct3d-11-to-direct3d-12">從 Direct3D 11 移植到 Direct3D 12</a></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><a href="/uwp/win32-and-com/win32-and-com-for-uwp-apps">通用 Windows 平台 (UWP) app 中 Windows API 的替代方法</a></td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        ...
        <td><a href="/windows/uwp/get-started/whats-a-uwp">何謂通用 Windows 平台應用程式？</a></td>
    </tr>
    <tr>
        <td>UWP 概觀</td>
        <td><a href="/windows/uwp/get-started/universal-application-platform-guide">UWP 應用程式指南</a></td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        <td>開始 UWP 開發設定</td>
        <td><a href="/windows/uwp/get-started/get-set-up">開始設定</a></td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        ...
        <td><a href="https://channel9.msdn.com/Series/Windows-10-development-for-absolute-beginners">初學者的 Windows 10 開發入門</a></td>
    </tr>
    <tr>
        <td>發佈使用 XAML 的 Windows 10 初學者系列 (部落格文章)</td>
        <td><a href="https://blogs.windows.com/buildingapps/2015/09/30/windows-10-development-for-absolute-beginners/">初學者的 Windows 10 開發入門</a></td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        <td>UWP 的網路程式設計概觀</td>
        <td><a href="/windows/uwp/networking/index">網路和 Web 服務</a></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><a href="/windows/uwp/threading-async/asynchronous-programming-universal-windows-platform-apps">非同步程式設計</a></td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        ...
        <td><a href="/cpp/porting/how-to-use-existing-cpp-code-in-a-universal-windows-platform-app">做法：在 UWP 應用程式中使用現有的 C++ 程式碼</a></td>
    </tr>
    <tr>
        <td>適用于 Win32 和 COM Api 的 Windows 執行階段 Api</td>
        <td><a href="/uwp/win32-and-com/win32-and-com-for-uwp-apps">適用於 UWP 應用程式的 Win32 與 COM API</a></td>
    </tr>
    <tr>
        <td>UWP 中不支援的 CRT 功能</td>
        <td><a href="/cpp/cppcx/crt-functions-not-supported-in-universal-windows-platform-apps">通用 Windows 平台應用程式不支援 CRT 函式</a></td>
    </tr>
    <tr>
        <td>Windows API 的替代方法</td>
        <td><a href="/uwp/win32-and-com/alternatives-to-windows-apis-uwp">通用 Windows 平台 (UWP) app 中 Windows API 的替代方法</a></td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        <td>處理應用程式週期轉換</td>
        <td><a href="/windows/uwp/launch-resume/app-lifecycle">應用程式生命週期</a></td>
    </tr>
    <tr>
        <td>使用 Microsoft Visual Studio 觸發 App 轉換</td>
        <td><a href="/visualstudio/debugger/how-to-trigger-suspend-resume-and-background-events-for-windows-store-apps-in-visual-studio">如何在 Visual Studio 中觸發 UWP app 的暫停、繼續及背景事件</a></td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        ...
        <td><a href="https://developer.microsoft.com/windows/apps/design">設計 UWP app</a></td>
    </tr>
    <tr>
        <td>針對 app 週期狀態進行設計</td>
        <td><a href="/windows/uwp/launch-resume/index">啟動、暫停和繼續的 UX 指導方針</a></td>
    </tr>
    <tr>
        <td>針對 Xbox One 與電視螢幕設計您的 UWP 應用程式</td>
        <td><a href="/windows/uwp/design/devices/designing-for-tv">針對 Xbox 和電視進行設計</a></td>
    </tr>
    <tr>
        <td>以多種裝置尺寸規格為目標 (影片)</td>
        <td><a href="https://channel9.msdn.com/Events/GDC/GDC-2015/Designing-Games-for-a-Windows-Core-World">針對 Windows Core 世界設計遊戲</a></td>
    </tr>
</table>
...
UI 對應是以流程圖方式呈現的遊戲導覽及功能表版面配置。 UI 對應可協助所有相關專案關係人瞭解遊戲的介面和導覽路徑，而且可能會在開發週期初期公開潛在的障礙和失效的結束。
...
<table>
    ...
    <tr>
        <td>XAudio2 API</td>
        <td><a href="/windows/desktop/xaudio2/xaudio2-apis-portal">XAudio2 的程式設計指南與 API 參考</a></td>
    </tr>
    <tr>
        <td>建立跨平台音訊處理物件</td>
        <td><a href="/windows/desktop/xaudio2/xapo-overview">XAPO 概觀</a></td>
    </tr>
    <tr>
        <td>音訊概念簡介</td>
    ...
    <tr>
        ...
        <td><a href="/windows/desktop/CoreAudio/spatial-sound">空間音效</a></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><a href="https://channel9.msdn.com/Events/GDC/GDC-2017/GDC2017-002">適用於 Xbox 和 Windows 的空間音訊功能簡介</a></td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        ...
        <td><a href="https://channel9.msdn.com/Events/GDC/GDC-2015/Better-Power-Better-Performance-Your-Game-on-DirectX12">功能更強、效能更佳：DirectX 12 的遊戲</a></td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        <td>設定程式設計環境</td>
        <td><a href="/windows/desktop/direct3d12/directx-12-programming-environment-set-up">Direct3D 12 程式設計環境設定</a></td>
    </tr>
    <tr>
        <td>如何建立基本元件</td>
        <td><a href="/windows/desktop/direct3d12/creating-a-basic-direct3d-12-component">建立基本的 Direct3D 12 元件</a></td>
    </tr>
    <tr>
        <td>Direct3D 12 中的變更</td>
        <td><a href="/windows/desktop/direct3d12/important-changes-from-directx-11-to-directx-12">從 Direct3D 11 移轉到 Direct3D 12 的重要變更</a></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><a href="/windows/desktop/direct3d12/resource-binding">Direct3D 12 中的資源繫結</a></td>
    </tr>
    <tr>
        <td>管理記憶體</td>
        <td><a href="/windows/desktop/direct3d12/memory-management">Direct3D 12 中的記憶體管理</a></td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        <td>開發磚與徽章</td>
        <td><a href="/windows/uwp/controls-and-patterns/tiles-badges-notifications">磚、徽章及通知</a></td>
    </tr>
    <tr>
        <td>說明動態磚與通知的範例</td>
    ...
    <tr>
        <td>彈性磚範本 (部落格文章)</td>
        <td><a href="/archive/blogs/tiles_and_toasts/adaptive-tile-templates-schema-and-documentation">彈性磚範本 - 結構描述和文件</a></td>
    </tr>
    <tr>
        <td>設計磚與徽章</td>
        <td><a href="/windows/uwp/controls-and-patterns/tiles-and-notifications-creating-tiles">磚與徽章的指導方針</a></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><a href="https://marketplace.visualstudio.com/items?itemName=shenchauhan.UWPTileGenerator">此工具可使用單一影像建立所有必要的磚</a></td>
    </tr>
    <tr>
...
應用程式內產品) 的附加元件 (是播放程式可在遊戲中購買的補充專案。 附加元件可以是遊戲層級、專案，或您的玩家可能會喜歡的任何其他專案。 適當地使用時，附加元件可以提供收益，同時提升遊戲體驗。 您可以透過合作夥伴中心定義和發佈遊戲的附加元件，並在遊戲的程式碼中啟用應用程式內購買。
...
<table>
    ...
    <tr>
        <td>持久附加元件</td>
        <td><a href="/windows/uwp/monetize/enable-in-app-product-purchases">啟用應用程式內產品購買</a></td>
    </tr>
    <tr>
        <td>取用附加元件</td>
        <td><a href="/windows/uwp/monetize/enable-consumable-in-app-product-purchases">啟用取用應用程式內產品購買</a></td>
    </tr>
    <tr>
        <td>附加元件詳細資料和提交</td>
        <td><a href="/windows/uwp/publish/iap-submissions">附加元件提交</a></td>
    </tr>
    <tr>
        <td>監視您遊戲的附加銷售和人口統計</td>
        <td><a href="/windows/uwp/publish/iap-acquisitions-report">附加元件下載數報告</a></td>
    </tr>
</table>
...
Windows Performance Toolkit (WPT) 是一組效能監視工具，可產生深入的 Windows 作業系統與應用程式效能分析結果。 對於監視記憶體使用狀況及改進遊戲效能而言，此工具特別有用。 Windows Performance Toolkit 包含在 Windows 10 SDK 和 Windows ADK 之中。 此工具組包含兩項獨立工具：Windows Performance Recorder (WPR) 和 Windows Performance Analyzer (WPA)。 ProcDump 命令列公用程式是 [Windows Sysinternals](/sysinternals/) 的一部分，可監視 CPU 尖峰並在遊戲當機時產生傾印檔案。
...
<table>
    ...
    <tr>
        <td>測試您的程式碼效能</td>
        <td><a href="https://azure.microsoft.com/services/devops/test-plans/">雲端式負載測試</a></td>
    </tr>
    <tr>
        <td>使用遊戲裝置資訊取得 Xbox 主機類型</td>
        <td><a href="/previous-versions/windows/desktop/gamingdvcinfo/gaming-device-information-portal">遊戲裝置資訊</a></td>
    </tr>
    <tr>
        <td>透過使用遊戲模式 API 排除硬體資源或安排存取硬體資源的優先順序以改善效能</td>
        <td><a href="/previous-versions/windows/desktop/gamemode/game-mode-portal">遊戲模式</a></td>
    </tr>
    <tr>
...
<table>
    ...
    <tr>
        ...
        <td><a href="https://devblogs.microsoft.com/pix/introducing-pix-on-windows-beta/">在 Windows 上 DirectX 12 的調整與偵錯效能</a></td>
    </tr>
    <tr>
        <td>D3D12 開發的偵錯與驗證工具 (影片)</td>
        <td><a href="https://channel9.msdn.com/Events/GDC/GDC-2017/GDC2017-003">含 PIX 和 GPU 驗證的 D3D12 效能調整和偵錯</a></td>
    </tr>
    <tr>
        <td>將圖形與效能最佳化 (影片)</td>
        <td><a href="https://channel9.msdn.com/Events/GDC/GDC-2015/Advanced-DirectX12-Graphics-and-Performance">進階 DirectX 12 圖形與效能</a></td>
    </tr>
    <tr>
        <td>DirectX 圖形偵錯 (影片)</td>
        <td><a href="https://channel9.msdn.com/Events/GDC/GDC-2015/Solve-the-Tough-Graphics-Problems-with-your-Game-Using-DirectX-Tools">使用 DirectX 工具解決遊戲難纏的圖形問題</a></td>
    </tr>
    <tr>
        <td>適用於偵錯 DirectX 12 的 Visual Studio 2015 工具 (影片)</td>
        <td><a href="https://channel9.msdn.com/Series/ConnectOn-Demand/212">Visual Studio 2015 中適用於 Windows 10 的 DirectX 工具</a></td>
    </tr>
    <tr>
        <td>Direct3D 12 程式設計指南</td>
        <td><a href="/windows/desktop/direct3d12/direct3d-12-graphics">Direct3D 12 程式設計指南</a></td>
    </tr>
    <tr>
        <td>結合 DirectX 與 XAML</td>
        <td><a href="directx-and-xaml-interop.md">DirectX 與 XAML 互通性</a></td>
...
開發適用于 Windows 平臺的全球遊戲，並瞭解 Microsoft 最重要的產品內建的國際功能。
...
<table>
    ...
    <tr>
        ...
        <td><a href="/windows/uwp/globalizing/globalizing-portal">針對全球使用者進行開發的指導方針</a></td>
    </tr>
    <tr>
        <td>橋接語言、文化及技術</td>
        <td><a href="https://www.microsoft.com/Language/Default.aspx">語言慣例與標準 Microsoft 詞彙的線上資源</a></td>
    </tr>
</table>
...
您將使用 [合作夥伴中心](https://partner.microsoft.com/dashboard) 來發佈及管理您的遊戲套件。
...
<table>
    ...
    <tr>
        <td>合作夥伴中心 advanced 發佈 (GDN) </td>
        <td><a href="https://developer.xboxlive.com/windows/documentation/Pages/home.aspx">合作夥伴中心 advanced 發佈指南</a></td>
    </tr>
    <tr>
        <td>使用 Azure Active Directory (AAD) 將使用者新增至您的合作夥伴中心帳戶</td>
        <td><a href="/windows/uwp/publish/manage-account-users">管理帳戶使用者</a></td>
    </tr>
    <tr>
        <td>為遊戲分級 (部落格文章)</td>
...
<table>
    ...
    <tr>
        ...
        <td><a href="https://channel9.msdn.com/Events/Build/2017/B8093">Nextgen UWP 應用程式發佈：建立可延伸、能夠串流、已元件化的應用程式</a></td>
    </tr>
    <tr>
        <td>分隔與群組內容以啟用串流安裝</td>
        <td><a href="/windows/msix/package/streaming-install">UWP 應用程式串流安裝</a></td>
    </tr>
    <tr>
        <td>建立選擇性套件，例如 DLC 遊戲內容</td>
        <td><a href="/windows/msix/package/optional-packages">選用套件及相關集合的製作</a></td>
    </tr>
    <tr>
        <td>封裝您的 UWP 遊戲</td>
    ...
    <tr>
        ...
        <td><a href="/windows/msix/package/create-app-package-with-makeappx-tool">使用 App 封裝程式工具 MakeAppx.exe 建立套件</a></td>
    </tr>
    <tr>
        <td>使用 SignTool 數位簽署您的檔案</td>
        <td><a href="/windows/desktop/SecCrypto/signtool">使用 SignTool 簽署檔案及驗證檔案中的簽章</a></td>
    </tr>
    <tr>
        <td>上傳及設定您遊戲的版本</td>
        <td><a href="/windows/uwp/publish/upload-app-packages">上傳應用程式套件</a></td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        ...
        <td><a href="/legal/windows/agreements/app-developer-agreement">應用程式開發人員合約</a></td>
    </tr>
    <tr>
        <td>在 Microsoft Store 中發佈應用程式的原則</td>
        <td><a href="/legal/windows/agreements/store-policies">Microsoft Store 原則</a></td>
    </tr>
    <tr>
        <td>如何避免一些常見的應用程式認證問題</td>
        <td><a href="/windows/uwp/publish/avoid-common-certification-failures">避免常見的認證失敗</a></td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        <td>市集資訊清單結構描述</td>
        <td><a href="/uwp/schemas/storemanifest/storemanifestschema2015/schema-root">StoreManifest 結構描述 (Windows 10)</a></td>
    </tr>
</table>
...
### <a name="partner-center-analytics-and-promotion"></a>合作夥伴中心分析和促銷
...
<table>
    ...
    <tr>
        <td>合作夥伴中心分析</td>
        <td><a href="/windows/uwp/publish/analytics">分析應用程式效能</a></td>
    </tr>
    <tr>
    ...
    <tr>
        <td>回應客戶評論</td>
        <td><a href="/windows/uwp/publish/respond-to-customer-reviews">回應客戶評論</a></td>
    </tr>
    <tr>
        <td>推銷您遊戲的方式</td>
        <td><a href="https://developer.microsoft.com/store/promote-your-apps">推銷您的應用程式</a></td>
    </tr>
</table>

### <a name="visual-studio-application-insights"></a>Visual Studio Application Insights

Visual Studio Application Insights 可為您已發行的遊戲提供效能、遙測及使用狀況分析。 Application Insights 可協助您在發行遊戲之後偵測及解決問題、持續監視及改善使用狀況，以及了解玩家與您遊戲的持續互動情況。 Application Insights 的運作方式是將 SDK 加入至您的應用程式，並將遙測資料傳送至 [Azure 入口網站](https://portal.azure.com/)。
...
<table>
    ...
    <tr>
        ...
        <td><a href="/azure/azure-monitor/overview">適用於 Windows Phone 與市集應用程式的 Application Insights</a></td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        ...
        <td><a href="https://publisher.vungle.com/sdk/">取得適用於 Vungle 的 Windows SDK</a></td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        <td>更新及設定您遊戲的版本</td>
        <td><a href="/windows/uwp/publish/package-version-numbering">套件版本編號</a></td>
    </tr>
    <tr>
        <td>遊戲套件管理指導方針</td>
        <td><a href="/windows/uwp/publish/package-version-numbering">應用程式套件管理指導方針</a></td>
    </tr>
</table>

## <a name="adding-xbox-live-to-your-game"></a>將 Xbox Live 新增到您的遊戲

Xbox Live 是連接世界各地數以百萬計的玩家的首要遊戲網路。 開發人員可獲得 Xbox Live 功能的存取權，這些功能可茁壯成長其遊戲物件，包括 Xbox Live 狀態、排行榜、雲端儲存、遊戲中樞、俱樂部、合作物件聊天、遊戲 DVR 等等。

> [!Note]
> 如果您想要開發 Xbox Live 支援的遊戲，則有數個選項可供您使用。 如需各種計畫的相關資訊，請參閱[開發人員計畫概觀](/gaming/xbox-live/developer-program-overview)。
...
<table>
    ...
    <tr>
        <td>Xbox Live 概觀</td>
        <td><a href="/gaming/xbox-live/index.md">Xbox Live 開發人員指南</a></td>
    </tr>
    <tr>
        <td>了解視計畫可使用哪些功能</td>
        <td><a href="/gaming/xbox-live/developer-program-overview.md#feature-table">開發人員計畫概觀：功能表格</a></td>
    </tr>
    <tr>
        <td>開發 Xbox Live 遊戲的實用資源的連結</td>
        <td><a href="/gaming/xbox-live/xbox-live-resources.md">Xbox Live 資源</a></td>
    </tr>
    <tr>
        <td>了解如何從 Xbox Live 服務取得資訊</td>
        <td><a href="/gaming/xbox-live/introduction-to-xbox-live-apis.md">Xbox Live API 簡介</a></td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        <td>概觀</td>
        <td><a href="/gaming/xbox-live/get-started-with-creators/get-started-with-xbox-live-creators.md">開始使用 Xbox Live 創作者計畫</a></td>
    </tr>
    <tr>
        <td>將 Xbox Live 新增到您的遊戲</td>
        <td><a href="/gaming/xbox-live/get-started-with-creators/creators-step-by-step-guide.md">整合 Xbox Live 創作者計畫的逐步解說指南</a></td>
    </tr>
    <tr>
        <td>將 Xbox Live 新增至您使用 Unity 建立的 UWP 遊戲</td>
        <td><a href="/gaming/xbox-live/get-started-with-creators/develop-creators-title-with-unity.md">開始使用 Unity 遊戲引擎開發 Xbox Live 創作者計畫遊戲</a></td>
    </tr>
    <tr>
        <td>設定開發沙箱</td>
        <td><a href="/gaming/xbox-live/get-started-with-creators/xbox-live-sandboxes-creators.md">Xbox Live 沙箱簡介</a></td>
    </tr>
    <tr>
        <td>設定帳戶供測試用</td>
        <td><a href="/gaming/xbox-live/get-started-with-creators/authorize-xbox-live-accounts.md">在您的測試環境授權 Xbox Live 帳戶</a></td>
    </tr>
    <tr>
...
<table>
    ...
    <tr>
        <td>概觀</td>
        <td><a href="/gaming/xbox-live/get-started-with-partner/get-started-with-xbox-live-partner.md">開始使用 Xbox Live 作為受管理的合作夥伴或 ID 開發人員</a></td>
    </tr>
    <tr>
        <td>將 Xbox Live 新增到您的遊戲</td>
        <td><a href="/gaming/xbox-live/get-started-with-partner/partners-step-by-step-guide.md">為受管理合作夥伴與 ID 成員整合 Xbox Live 的逐步解說指南</a></td>
    </tr>
    <tr>
        <td>將 Xbox Live 新增至您使用 Unity 建立的 UWP 遊戲</td>
        <td><a href="/gaming/xbox-live/get-started-with-partner/partner-unity-uwp-il2cpp.md">為 ID 與受管理合作夥伴將 Xbox Live 新增支援至具有 IL2CPP 指令碼後端之 UWP 適用的 Unity</a></td>
    </tr>
    <tr>
        <td>設定開發沙箱</td>
        <td><a href="/gaming/xbox-live/get-started-with-partner/advanced-xbox-live-sandboxes.md">進階 Xbox Live 沙箱</a></td>
    </tr>
    <tr>
        <td>使用 Xbox Live 之遊戲的需求 (GDN)</td>
        <td><a href="https://edadfs.partners.extranet.microsoft.com/adfs/ls/?wa=wsignin1.0&wtrealm=https%3a%2f%2fdeveloper.xboxlive.com&wctx=rm%3d0%26id%3dpassive%26ru%3d%252fen-us%252flive%252fcertification%252frequirements%252fPages%252fTCR.aspx&wct=2019-11-20T19%3a55%3a26Z">Windows 10 上 Xbox Live 的 Xbox 需求</a></td>
    </tr>
    <tr>
        <td>範例</td>
    ...
    <tr>
        ...
        <td><a href="https://channel9.msdn.com/Events/GDC/GDC-2015/Developing-with-Xbox-Live-for-Windows-10">使用適用於 Windows 10 的 Xbox Live 進行開發</a></td>
    </tr>
    <tr>
        <td>跨平台配對 (影片)</td>
        <td><a href="https://channel9.msdn.com/Events/GDC/GDC-2015/Xbox-Live-Multiplayer-Introducing-services-for-cross-platform-matchmaking-and-gameplay">Xbox Live 多人遊戲：跨平台配對和遊戲服務簡介</a></td>
    </tr>
    <tr>
        <td>「神鬼寓言：傳奇」(Fable Legends) 中的跨裝置遊戲 (影片)</td>
        <td><a href="https://channel9.msdn.com/Events/GDC/GDC-2015/Fable-Legends-Cross-device-Gameplay-with-Xbox-Live">「神鬼寓言：傳奇」(Fable Legends)：使用 Xbox Live 進行跨裝置遊戲</a></td>
    </tr>
    <tr>
        <td>Xbox Live 統計資料與成就 (影片)</td>
        <td><a href="https://channel9.msdn.com/Events/GDC/GDC-2015/Best-Practices-for-Leveraging-Cloud-Based-User-Stats-and-Achievements-in-Xbox-Live">利用 Xbox Live 中雲端使用者統計資料與成就的最佳做法</a></td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        <td>遊戲開發影片</td>
        <td><a href="/windows/uwp/gaming/game-development-videos">來自 GDC 和 //build 等重要會議的影片</a></td>
    </tr>
    <tr>
        <td>獨立製作遊戲開發 (影片)</td>
        <td><a href="https://channel9.msdn.com/Events/GDC/GDC-2015/New-Opportunities-for-Independent-Developers">獨立開發人員的新機會</a></td>
    </tr>
    <tr>
        <td>多核心行動裝置的考量 (影片)</td>
        <td><a href="https://channel9.msdn.com/Events/GDC/GDC-2015/Sustained-gaming-performance-in-multi-core-mobile-devices">多核心行動裝置中持續的遊戲效能</a></td>
    </tr>
    <tr>
        <td>開發 Windows 10 傳統型遊戲 (影片)</td>
        <td><a href="https://channel9.msdn.com/Events/GDC/GDC-2015/PC-Games-for-Windows-10">適用於 Windows 10 的電腦遊戲</a></td>
    </tr>
</table>