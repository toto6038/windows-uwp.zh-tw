...
基礎資源必須以與建立來源檢視類型相容的屬性建立。 例如，如果[ **ID3D11RenderTargetView** ](https://msdn.microsoft.com/library/windows/desktop/ff476582)套用至介面，該介面會透過[ **D3D11\_繫結\_轉譯\_目標**](https://msdn.microsoft.com/library/windows/desktop/ff476085)旗標。 介面也必須具有與轉譯相容的 DXGI 介面格式 (請參閱[ **DXGI\_格式**](https://msdn.microsoft.com/library/windows/desktop/bb173059))。
