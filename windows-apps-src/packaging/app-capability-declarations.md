...
| **眼動追蹤儀** | 相容眼動追蹤裝置已連接時，**gazeInput** 功能可讓應用程式偵測使用者在應用程式範圍內注視的位置。 需要具備這個功能，才能使用 [**Windows.Devices.Input.Preview**](/uwp/api/windows.devices.input.preview) 命名空間中的某些 API。 |
