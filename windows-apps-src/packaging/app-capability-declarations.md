...
如果您的應用程式宣告任何受限制的功能，您必須在[應用程式提交程序](../publish/app-submissions.md)提供資訊，才能核准將應用程式發行至 Microsoft Store。 您提供這項資訊在您提交的 [[提交選項](../publish/manage-submission-options.md#restricted-capabilities)] 頁面來解釋您的應用程式如何使用它宣告每個受限制的功能。
