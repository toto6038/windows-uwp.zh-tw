...
> [!WARNING]
> 雖然您提供以下可以是任何字串識別碼名稱，可有效中您所選擇的語言進行程式設計，您通常會想要能夠太在 XAML 中設定您相依性屬性。 為了能夠在 XAML 中設定，您選擇的屬性名稱必須是有效的 XAML 名稱。 如需詳細資訊，請參閱 [XAML 概觀](xaml-overview.md)。
