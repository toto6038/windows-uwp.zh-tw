...
Windows 社群工具組[WindowsXamlHost](https://docs.microsoft.com/windows/communitytoolkit/controls/wpf-winforms/windowsxamlhost)控制項做為使用 UWP 裝載在 WPF 和 Windows Forms 應用程式中的 API 參考範例。 在下列位置，原始碼可供使用：
...
3. 將自訂的 UWP XAML 控制項的原始碼整合到您的主機應用程式方案建置自訂控制項和應用程式中使用下列[指示操作](https://docs.microsoft.com/windows/communitytoolkit/controls/wpf-winforms/windowsxamlhost#add-a-custom-uwp-control)。
