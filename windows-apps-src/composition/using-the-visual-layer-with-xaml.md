...
請參閱[**筆刷**](../graphics/using-brushes.md#xamlcompositionbrushbase)小節，以取得搭配使用筆刷與 XAML UI 的詳細資訊。
...
這是等同於先前 C&#35; 程式碼且使用相同 XAML 結構的[C++/CX](https://docs.microsoft.com/cpp/cppcx/visual-c-language-reference-c-cx)。
