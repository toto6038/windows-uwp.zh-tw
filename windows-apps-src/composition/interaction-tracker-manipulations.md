...
如前所述，InteractionTracker 是具有 4 種狀態的狀態機器，每一種皆可轉換到任何其他四個狀態。 (如需 InteractionTracker 如何在這些狀態之間轉換的詳細資訊，請參閱 [InteractionTracker](https://docs.microsoft.com/uwp/api/windows.ui.composition.interactions.interactiontracker) 類別文件)。
