---
title: 時間動畫
description: 瞭解如何使用 KeyFrameAnimations 類別來建立以時間為基礎的動畫，以引導使用者完成 UI 變更。
ms.date: 12/12/2018
ms.topic: article
...
1. 使用動畫範本，開始新增 KeyFrames 並定義動畫的屬性。
    ...
    - 建議也定義持續時間。
1. 當您準備好要執行此動畫之後，請在 CompositionObject 上呼叫 StartAnimation ( ... ) ，以您想要建立動畫的屬性為目標。 具體來說：
    - `visual.StartAnimation("targetProperty", CompositionAnimation animation);`
    - `visual.StartAnimationGroup(AnimationGroup animationGroup);`
1. 如果您有執行中的動畫，而且想要停止動畫或動畫群組，您可以使用這些 Api：
...
在此範例中，您想要將視覺效果的位移從 <0、0、0> 到 <200、0、0> 超過1秒的動畫。 此外，您想以 10 倍查看這些位置之間的視覺動畫。
...
然後，您可以定義 KeyFrameAnimation 的屬性來描述其持續時間，以及在兩個位置之間建立動畫的行為， (目前和 <200，0，0>) 10 次。
