---
title: 彈簧動畫
description: 瞭解如何使用 NaturalMotionAnimation Api，在您的應用程式中建立彈簧運動體驗。
ms.date: 10/10/2017
ms.topic: article
...
![具有 ](images/animation/offset-spring.gif)
 ![ 三次方貝塞爾動畫之彈簧動畫動作的動作](images/animation/offset-cubic-bezier.gif)
