...
2. 查詢您裝置的 IP 位址。 在 [設定] 底下的裝置上尋找 IP 位址 **> [網路 & 網際網路] > [wi-fi > 硬體**內容]。 您也可以詢問：「嗨 Cortana，我的 IP 位址是什麼？」
...
2. 從裝置入口網站上的 [安全性] 頁面下載此裝置的憑證。-請按一下右上方圖示清單中的 [安全性] 連結，或流覽至： `https://<YOUR_HOLOLENS_IP_ADDRESS>/devicesecurity.htm`
