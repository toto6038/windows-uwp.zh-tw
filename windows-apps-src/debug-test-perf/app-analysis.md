...
#### 在 BitmapIcons 內部使用的影像回復為解碼成原始大小 
...
#### DecodePixelWidth 或 DecodePixelHeight 被設定為大於將在螢幕上顯示的影像大小 
...
## 協助工具：具有相同 Controltype 的 UIA 元素不應該有相同的名稱
