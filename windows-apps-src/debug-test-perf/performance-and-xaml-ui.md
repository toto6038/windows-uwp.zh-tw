...
如果您還沒有這麼做，步驟，我們看到顯著的效能改善的結果是只是您應用程式移植到目標 Windows 10。 數個 XAML 最佳化功能 (例如[{x： 繫結}](https://msdn.microsoft.com/library/windows/apps/Mt204783)) 僅適用於 Windows 10 應用程式。 請參閱[移植到 Windows 10 的應用程式](https://msdn.microsoft.com/library/windows/apps/Mt238321)和 //build/ 工作階段[移至通用 Windows 平台](https://channel9.msdn.com/Events/Build/2015/3-741)。
...
| [ListView 和 GridView UI 最佳化](optimize-gridview-and-listview.md) | 透過 UI 虛擬化、減少元素以及漸進式更新項目，改善 [<strong>GridView</strong>](https://msdn.microsoft.com/library/windows/apps/BR242705) 效能和啟動時間。 |
