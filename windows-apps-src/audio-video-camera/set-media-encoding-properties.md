...
**警告**   [ **VideoDeviceController.GetAvailableMediaStreamProperties** ](https://msdn.microsoft.com/library/windows/apps/br211994)方法會採用的成員[ **MediaStreamType** ](https://msdn.microsoft.com/library/windows/apps/br226640)列舉型別，例如**VideoRecord**或是**相片**，並傳回清單的其中一個[ **ImageEncodingProperties**](https://msdn.microsoft.com/library/windows/apps/hh700993)或是[ **VideoEncodingProperties** ](https://msdn.microsoft.com/library/windows/apps/hh701217)傳達編碼設定，例如擷取的相片或視訊的解析度資料流的物件。 呼叫 **GetAvailableMediaStreamProperties** 的結果可能包括 **ImageEncodingProperties** 或 **VideoEncodingProperties**，而不論指定的是哪一個 **MediaStreamType** 值。 基於這個原因，您應該一律檢查每個傳回值的類型，並將其轉換為適當的類型，然後才嘗試存取任何屬性值。
