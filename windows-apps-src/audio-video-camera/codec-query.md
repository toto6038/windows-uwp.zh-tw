...
您傳入**FindAllAsync**的子類型字串可以是子類型 GUID 的字串表示，而 GUID 是由系統或子類型的 FOURCC 程式碼所定義。 這組支援的媒體子類型 GUID 列在[音訊子類型 GUID](https://docs.microsoft.com/windows/desktop/medfound/audio-subtype-guids) (英文) 和[視訊子類型 GUID](https://docs.microsoft.com/windows/desktop/medfound/video-subtype-guids) (英文) 文章中，但 **[CodecSubtypes](https://docs.microsoft.com/uwp/api/windows.media.core.codecsubtypes)** 類別提供屬性，以傳回每個所支援子類型的 GUID 值。 如需 FOURCC 代碼的詳細資訊，請參閱 [FOURCC 代碼](https://docs.microsoft.com/windows/desktop/DirectShow/fourcc-codes)(英文)。 
