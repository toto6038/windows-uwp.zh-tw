...
UWP 支援有限的可用，無論**目標版本**或專案的**最小版本**的.NET Api 子集。 [此頁面提供更多有關可用的類型](https://msdn.microsoft.com/library/windows/apps/xaml/mt185501(d=robot).aspx)。
