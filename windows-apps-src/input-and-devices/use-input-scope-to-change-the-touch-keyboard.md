...
> **重要事項**&nbsp;&nbsp;[**PasswordBox**](https://msdn.microsoft.com/library/windows/apps/br227519) 上的 [**InputScope**](https://msdn.microsoft.com/library/windows/apps/dn996570) 屬性僅支援 **Password** 和 **NumericPin** 值。 會略過其他任何值。
...
4.  將 [**InputScopeName**](https://msdn.microsoft.com/library/windows/apps/hh702027) 物件的 [**NameValue**](https://msdn.microsoft.com/library/windows/apps/hh702032) 屬性設定為 [**InputScopeNameValue**](https://msdn.microsoft.com/library/windows/apps/hh702028) 列舉的值。

    ```csharp
    scopeName.NameValue = InputScopeNameValue.TelephoneNumber;
    ```

5.  將 [**InputScopeName**](https://msdn.microsoft.com/library/windows/apps/hh702027) 物件新增到 [**InputScope**](https://msdn.microsoft.com/library/windows/apps/hh702025) 物件的 [**Names**](https://msdn.microsoft.com/library/windows/apps/hh702034) 集合。
...
## 適用於 Windows 和 Windows Phone 的觸控式鍵盤索引
...
> **注意**&nbsp;&nbsp;行動裝置上的 SIP 大小越小，就會讓您針對行動應用程式設定正確的輸入範圍特別重要。 如這裡所示，Windows Phone 提供更多樣的專用鍵盤配置。 文字欄位如果在 Windows 市集應用程式中不需要設定輸入範圍，在 Windows Phone 市集應用程式中設定輸入範圍可能會有好處。

> **提示**&nbsp;&nbsp;大部分觸控式鍵盤皆可供您在字母配置與數字和符號配置之間切換。 在 Windows 上，請切換 [&123]**** 鍵。 在 Windows Phone 上，按 [& 123]**** 鍵以變更為數字和符號配置，然後按 [abcd]**** 鍵以變更為字母配置。
...
-   自動大寫：若 **IsSpellCheckEnabled** = **true** 則啟用，若 **IsSpellCheckEnabled** = **false** 則停用
...
包含 [.com]**** 和 [前往鍵]![](images/input-scopes/kbdgokey.png) (前往) 鍵。 按住 [.com]**** 鍵不放以顯示其他選項 ([.org]****、[.net]**** 和地區特定尾碼)。

| Windows                                                    | Windows Phone                                                    |
|------------------------------------------------------------|------------------------------------------------------------------|
| ![Windows URL 觸控式鍵盤](images/input-scopes/kbdpcurl.png)<br>也包含 [**:**]、[**-**] 及 [**/**] 鍵。| ![Windows Phone URL 觸控式鍵盤](images/input-scopes/kbdwpurl.png)<br>按住句點鍵可顯示其他選項 ( - + &quot; / &amp; : , )。 |
...
包含 [@] ****和 [.com] ****鍵。 按住 [.com]**** 鍵不放以顯示其他選項 ([.org]****、[.net]**** 和地區特定尾碼)。
...
| Windows                                                    | Windows Phone                                                    |
|------------------------------------------------------------|------------------------------------------------------------------|
| ![預設 Windows 觸控式鍵盤](images/input-scopes/kbdpcdefault.png)<br>與 **Default** 的配置相同。| ![Windows Phone 名稱或電話號碼觸控式鍵盤](images/input-scopes/kbdwpnameorphonenumber.png)<br>包含 [;]**** 和 [@]**** 鍵。 [&amp;123]**** 鍵已取代為 [123]**** 鍵，會開啟 [電話鍵台] (請參閱 **TelephoneNumber**)。|
