...
![文字資料流圖表範例](images/coretext/stream-2.png)
有兩個選項：\[0, 1\] 和 \[6, 11\]。 編輯控制項只能報告這其中一個項目：\[0, 1\] 或 \[6, 11\]。
...
![文字資料流圖表範例](images/coretext/stream-3.png)
...
![文字資料流圖表範例](images/coretext/stream-5.png)
...
有一或多個 [**TextRequested**](https://msdn.microsoft.com/library/windows/apps/dn958175) 事件將會遵循，您可在其中處理更新文字服務正在使用的文字。
...
![文字資料流圖表範例](images/coretext/stream-6.png)
使用者按下空格鍵，並引發對應的 [**TextUpdating**](https://msdn.microsoft.com/library/windows/apps/dn958176) 事件。 編輯控制項接受文字更新。 這是編輯控制項在完成校正之前短暫的狀態。 插入點是在 \[4, 4\]。

![文字資料流圖表範例](images/coretext/stream-7.png)
在 [**TextUpdating**](https://msdn.microsoft.com/library/windows/apps/dn958176) 事件處理常式外部，編輯控制項會進行下列校正。 這是編輯控制項在完成校正之後的狀態。 插入點是在 \[5, 5\]。

![文字資料流圖表範例](images/coretext/stream-8.png)
在這種情況下，您應該使用這些引數來呼叫 [**NotifyTextChanged**](https://msdn.microsoft.com/library/windows/apps/dn958172)：
