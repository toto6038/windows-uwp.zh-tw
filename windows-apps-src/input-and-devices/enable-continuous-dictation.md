...
我們會在 [**OnNavigatedTo**](https://msdn.microsoft.com/library/windows/apps/br227508) 頁面事件中初始化語音辨識。
...
在這裡，您可以透過呼叫 [**RecognizeAsync**](https://msdn.microsoft.com/library/windows/apps/dn653244) 或 [**RecognizeWithUIAsync**](https://msdn.microsoft.com/library/windows/apps/dn653245) 來擷取單一、簡短的發音或片語 但是，我們想要擷取較長、連續的辨識工作階段。

為了這樣做，我們指定事件接聽程式來於使用者說話時在背景執行，並定義處理常式來建立聽寫字串。
...
## <span id="Provide_ongoing_recognition_feedback"> </span> <span id="provide_ongoing_recognition_feedback"> </span> <span id="PROVIDE_ONGOING_RECOGNITION_FEEDBACK"> </span>提供進行中的辨識意見反應
