...
如需關於 Direct3D 11 之前區塊壓縮演算法支援 (包括 BC1 到 BC5 格式的支援) 的相關詳細資訊，請參閱[區塊壓縮 (Direct3D 10)](https://docs.microsoft.com/windows/desktop/direct3d10/d3d10-graphics-programming-guide-resources-block-compression)。

**檔案格式的注意事項：  **BC6H 和 BC7 材質壓縮格式來儲存壓縮的紋理資料使用 DDS 檔案格式。 如需詳細資訊，請參閱[DDS 程式設計指南](https://docs.microsoft.com/windows/desktop/direct3ddds/dx-graphics-dds-pguide)。
...
如需關於此格式的詳細資訊，請參閱[BC6H 格式](https://docs.microsoft.com/windows/desktop/direct3d11/bc6h-format)文件。
...
如需關於此格式的詳細資訊，請參閱[BC7 格式](https://docs.microsoft.com/windows/desktop/direct3d11/bc7-format)文件。
